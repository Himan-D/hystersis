...
//!
//! These types support the feedback collection system for Hystersis sessions.
//! The agent (xai-hystersis-shell) uses heuristics to determine when to request feedback,
...
pub struct FeedbackSubmission {
    ...
    /// Shell (xai-hystersis-shell) version
    #[serde(skip_serializing_if = "Option::is_none")]
...
fn default_tier1_prompt() -> String {
    "You've been using Hystersis Code productively! Would you mind sharing quick feedback?".to_string()
}
