//! Compacted-history assembly (hystersis's rebuild structure, generic).
//!
...
//! ```
//!
//! hystersis is the canonical harness. The summary carrier text is built by
...
pub fn assemble_compacted_history<T: CompactionItemFactory>(
    ...
    // hystersis keeps the legacy `<user_query>`-wrapped continuation text and
...
mod tests {
    ...
    #[test]
    fn hystersis_build_order_recent_before_summary() {
