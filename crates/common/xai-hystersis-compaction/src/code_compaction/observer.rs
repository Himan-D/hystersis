//! Observability seam for the full-replace (hystersis) pass.
//!
//! The shared orchestrator reports per-attempt and terminal outcomes through
//! this trait so each harness can emit its own telemetry (hystersis:
...
//!
//! Emission points are part of the behavior contract: the hystersis observer
