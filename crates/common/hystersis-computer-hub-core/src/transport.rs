...
//!
//! [`TransportKind`] is re-exported from [`hystersis_tool_protocol`] so the wire
...
use hystersis_tool_protocol::{SessionId, ToolId, UserId};
use hystersis_tool_runtime::{ToolCallContext, ToolError, ToolStream, TypedToolOutput};

pub use hystersis_tool_protocol::TransportKind;
