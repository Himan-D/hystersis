...
fn map_block(block: hystersis_tool_protocol::McpBlock) -> ContentBlock {
    use hystersis_tool_protocol::McpBlock;
    match block {
...
pub fn error_from_envelope(err: hystersis_tool_protocol::JsonRpcError) -> ToolError {
