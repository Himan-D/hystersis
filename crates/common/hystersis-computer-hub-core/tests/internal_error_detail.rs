...
use serde_json::json;
use hystersis_computer_hub_core::{error_from_envelope, tool_error_from_wire};
use hystersis_tool_protocol::{JsonRpcError, RequestId, ToolErrorWire};
use hystersis_tool_runtime::ToolErrorKind;
