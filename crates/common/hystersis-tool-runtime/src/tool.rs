...
/// `filename`, `path`, `metadata`) that the Hystersis SLOP converter uses to
...
pub enum ContentBlock {
    ...
    ///
    /// Optional metadata fields are used by the Hystersis SLOP converter to
    ...
    /// - `path`: file path on the Hystersis Computer filesystem
