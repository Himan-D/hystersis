...
//! string/text manipulation. Harness-bound extraction (Hystersis chat's
//! `HystersisConversation` traversal, `ChatCompletionRequest` user-message
//! extraction, `HystersisMessage` assembly) stays in the harness crate.
