...
/// binary. Once initialized, `hystersis_config::hystersis_home()` will resolve to
...
/// Minimal [`hystersis_update::UpdateConfig`] for install tests.
pub fn make_update_config(channel: &str) -> hystersis_update::UpdateConfig {
    hystersis_update::UpdateConfig {
