...
fn external_stream_end_to_end() {
    ...
    let mut cfg = hystersis_telemetry::external::ExternalOtelConfig::resolve_with(
        |name| match name {
    ...
    cfg.client = hystersis_telemetry::external::config::ExternalClientInfo {
        service_version: "0.0.0-test".into(),
        client_version: "0.0.0-test".into(),
        app_entrypoint: "cli".into(),
    };

    hystersis_telemetry::external::init(Some(cfg));
    assert!(hystersis_telemetry::external::is_active());
    ...
    hystersis_telemetry::log_event(hystersis_telemetry::events::SessionNew {
    ...
    hystersis_telemetry::external::shutdown();
    assert!(
