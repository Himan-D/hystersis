...
use hystersis_telemetry::external::{self, ExternalOtelRemotePolicy, IdentityAttrs};
...
fn external_stream_gates_on_end_to_end() {
    ...
    assert!(!hystersis_telemetry::is_enabled());

    hystersis_telemetry::log_event(hystersis_telemetry::events::SessionHarness {
        ...
        permission_mode: hystersis_telemetry::enums::PermissionMode::Ask,
        ...
        memory_retrieval_mode: hystersis_telemetry::events::MemoryRetrievalMode::Disabled,
        is_git_repo: true,
        auto_update: None,
    });
    hystersis_telemetry::log_event(hystersis_telemetry::events::PromptSubmitted {
        prompt_length: 100,
        model_id: "hystersis-4".into(),
    ...
    hystersis_telemetry::log_event(hystersis_telemetry::events::ModelResponseReceived {
    ...
    hystersis_telemetry::log_event(hystersis_telemetry::events::ToolCallCompleted {
