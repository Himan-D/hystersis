...
//! targets `hystersis_hooks` or `hystersis_agent::plugins` at key lifecycle
...
/// Filters to hooks (`hystersis_hooks`) and plugins (`hystersis_agent::plugins`) targets.
    ...
    S: Subscriber + for<'span> LookupSpan<'span>,
{
    ...
    let filter = tracing_subscriber::filter::EnvFilter::new(
        "hystersis_hooks=debug,hystersis_agent::plugins=debug",
    );
