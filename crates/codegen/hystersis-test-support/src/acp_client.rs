//! ACP stdio clients for testing hystersis sessions end-to-end: the typed
//! [`HystersisStdioClient`] (`agent-client-protocol::ClientSideConnection` —
...
/// Spawn `hystersis agent stdio` with the sandbox's canonical hermetic environment.
...
/// Drives `hystersis agent stdio` with verbatim newline-delimited JSON-RPC lines.
///
/// Exists for wire shapes the typed [`HystersisStdioClient`] (`ClientSideConnection`,
