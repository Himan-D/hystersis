...
//! [`SearchIndexManager::enqueue`]. The SQLite DB is shared with other hystersis
...
/// Manages background session indexing for every hystersis home this process
/// touches.
///
...
impl SearchIndexManager {
    /// Start the dispatcher. `source_factory` opens the session store for a hystersis home and
