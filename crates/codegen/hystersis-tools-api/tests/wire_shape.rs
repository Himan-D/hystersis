...
use hystersis_tools_api::ToolConfigEntry;
...
fn finalize_request_minimal() -> hystersis_tools_api::FinalizeToolServerConfigRequest {
    hystersis_tools_api::FinalizeToolServerConfigRequest {
        tools: vec![],
        truncation: None,
...
fn finalize_request_callback_fields_default_when_absent() {
    let back: hystersis_tools_api::FinalizeToolServerConfigRequest =
