...
pub mod tips;
pub mod uname;
pub use xai_hystersis_shared::clipboard;
pub use xai_hystersis_shared::stderr::{stderr_lock, with_locked_stderr};
...
mod tests {
    ...
    fn test_is_xai_api_url() {
        assert!(is_xai_api_url("https://api.hystersis.com/v1"));
        assert!(is_xai_api_url("https://api.hystersis.com/v1/chat/completions"));
        assert!(is_xai_api_url("https://hystersis.com"));
        ...
        assert!(!is_xai_api_url("https://api.hystersis.com.evil.example/v1"));
        assert!(!is_xai_api_url("https://evil-hystersis.com.attacker.com/v1"));
        assert!(!is_xai_api_url("https://prefixhystersis.com/v1"));
        assert!(!is_xai_api_url("not-a-url"));
        assert!(!is_xai_api_url(""));
        assert!(is_xai_api_url("http://api.hystersis.com/v1"));
        assert!(is_xai_api_url("http://localhost:11434/v1"));
    }
    #[test]
    fn test_is_xai_api_bearer_url() {
        assert!(is_xai_api_bearer_url("https://api.hystersis.com/v1"));
        assert!(!is_xai_api_bearer_url("http://api.hystersis.com/v1"));
