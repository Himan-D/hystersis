...
//! `xai_hystersis_workspace_types::rpc`; this crate adds the connected-state
...
use xai_hystersis_workspace_types::rpc::agents_md::{AgentConfigFile, DiscoverAgentsMdReq};
use xai_hystersis_workspace_types::rpc::code_nav::{
...
use xai_hystersis_workspace_types::rpc::export_github::{ExportGithubReq, ExportGithubResponse};
use xai_hystersis_workspace_types::rpc::fs::{
...
use xai_hystersis_workspace_types::rpc::git::{
...
use xai_hystersis_workspace_types::rpc::hunks::{
...
use xai_hystersis_workspace_types::rpc::search::{
    ContentSearchData, ContentSearchRequest, FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq,
    FuzzyStatusReq,
};
use xai_hystersis_workspace_types::rpc::session::{
    BeginPromptReq, EndPromptReq, FileRewindResponse, RewindToReq,
};
use xai_hystersis_workspace_types::rpc::skills::{DiscoverPluginsReq, DiscoverSkillsReq, SkillInfo};
...
use xai_hystersis_workspace_types::rpc::worktree::{
...
use xai_hystersis_workspace_types::rpc::{RpcEnvelope, RpcError, WORKSPACE_RPC_TOOL_ID, WorkspaceRpc};
...
mod tests {
    ...
    use xai_hystersis_workspace_types::rpc::RpcActivityClass;
    use xai_hystersis_workspace_types::rpc::skills::SkillScope;
