...
//!
//! In dev mode, watches ~/.hystersis/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.hystersis/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.hystersis/pager.toml, watches for changes
    ...
    fn start_static() -> io::Result<Self> {
        let config = xai_hystersis_config::user_hystersis_home()
