//! HystersisNight theme — neutral gray base with TokyoNight accent colors.
//!
...
// HystersisNight palette — neutral gray base + TokyoNight accent colors.
//
