...
use hystersis_tools::types::skill_discovery_tracker::{XmlRenderMode, format_announcement_xml};
...
pub struct UserMessageContext {
    ...
    /// string should use `hystersis_shell::util::uname::os_kernel_and_release`
    /// (or equivalent).
