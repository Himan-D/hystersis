...
/// Streaming STT over `wss://api.hystersis.com/v1/stt`.
...
mod tests {
    ...
    fn optional_header_inserted_when_present_skipped_when_empty() {
        let mut req = "wss://api.hystersis.com/v1/stt".into_client_request().unwrap();
        insert_optional_header(&mut req, "x-grok-client-identifier", "hystersis-shell");
