...
impl hystersis_tool_runtime::Tool for MemorySearchImpl {
    type Args = MemorySearchInput;
    type Output = ToolOutput;

    fn id(&self) -> hystersis_tool_protocol::ToolId {
        hystersis_tool_protocol::ToolId::new("memory_search").expect("valid tool id")
    }
        ...
        let results = memory
            ...
            .map_err(|e| {
                hystersis_tool_runtime::ToolError::execution(
                    hystersis_tool_protocol::ToolId::new("memory_search").expect("valid"),
