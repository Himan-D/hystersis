//! `HystersisBuildConcise` namespace — concise variants of core HystersisBuild tools.
//!
//! These tools share implementation with `hystersis_build` via `pub(crate)` helpers
