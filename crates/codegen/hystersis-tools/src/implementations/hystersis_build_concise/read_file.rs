...
impl crate::types::tool_metadata::ToolMetadata for ReadFileConciseTool {
    ...
    fn tool_namespace(&self) -> ToolNamespace {
        ToolNamespace::HystersisBuildConcise
    }
...
impl hystersis_tool_runtime::Tool for ReadFileConciseTool {
    ...
    async fn run(
        ...
        // HystersisBuildConcise is not version-managed — always pass None.
...
mod tests {
    ...
    use crate::implementations::hystersis_build::read_file::ReadFileTool;
