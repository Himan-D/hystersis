...
impl hystersis_tool_runtime::ToolOutput for MonitorOutput {}
...
pub struct MonitorEventNotification {
    ...
    /// events inside another session's turn. `None` for legacy / non-hystersis
...
///
/// [`EventQueue`]: hystersis_interjection_core::EventQueue
pub type MonitorEventBuffer = hystersis_interjection_core::EventQueue<MonitorEventNotification>;

crate::register_resource!("hystersis_build", "MonitorEventBuffer", MonitorEventBuffer);
