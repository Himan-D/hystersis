...
impl hystersis_tool_runtime::ToolOutput for SchedulerListOutput {}
...
impl hystersis_tool_runtime::Tool for SchedulerListTool {
    type Args = SchedulerListInput;
    type Output = SchedulerListOutput;

    fn id(&self) -> hystersis_tool_protocol::ToolId {
        hystersis_tool_protocol::ToolId::new("scheduler_list").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerListOutput, hystersis_tool_runtime::ToolError> {
        ...
        sender
            ...
            .map_err(|_| {
                hystersis_tool_runtime::ToolError::execution(
                    hystersis_tool_protocol::ToolId::new("scheduler_list").expect("valid"),
