...
impl hystersis_tool_runtime::ToolOutput for SchedulerCreateOutput {}
...
impl hystersis_tool_runtime::Tool for SchedulerCreateTool {
    type Args = SchedulerCreateInput;
    type Output = SchedulerCreateOutput;

    fn id(&self) -> hystersis_tool_protocol::ToolId {
        hystersis_tool_protocol::ToolId::new(SCHEDULER_CREATE_TOOL_NAME).expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerCreateOutput, hystersis_tool_runtime::ToolError> {
...
mod tests {
    use super::*;
    use crate::implementations::hystersis_build::scheduler::actor::SchedulerActor;
