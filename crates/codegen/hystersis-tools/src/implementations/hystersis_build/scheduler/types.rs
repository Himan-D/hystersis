...
pub fn scheduler_tool_error(error: SchedulerError) -> hystersis_tool_runtime::ToolError {
    ...
    hystersis_tool_runtime::ToolError::custom(code, error.to_string())
}
...
crate::register_resource!("hystersis_build", "Scheduler", SchedulerState);
