...
use crate::implementations::hystersis_build::task_output::{
...
use hystersis_tool_types::{MultiTaskOutputResult, TaskOutputOutput, WaitMode, WaitTasksToolInput};
...
impl crate::types::tool_metadata::ToolMetadata for WaitTasksTool {
    ...
    fn description_template(&self) -> &str {
        ...
        static DESC: std::sync::LazyLock<String> = std::sync::LazyLock::new(|| {
            hystersis_tool_types::build_wait_tasks_description(&hystersis_tool_types::WaitTasksToolNaming {
...
/// [`hystersis_tool_types::build_wait_tasks_description`] builder so the CLI and
...
impl hystersis_tool_runtime::Tool for WaitTasksTool {
    type Args = WaitTasksToolInput;
    type Output = TaskOutputOutput;

    fn id(&self) -> hystersis_tool_protocol::ToolId {
        hystersis_tool_protocol::ToolId::new("wait_tasks").expect("valid tool id")
    }
    ...
    async fn run(
        ...
        let timeout = crate::implementations::hystersis_build::task_output::capped_wait_timeout(
            input.timeout_ms,
            crate::implementations::hystersis_build::task_output::max_wait_block(),
        );
...
mod tests {
    ...
    use hystersis_tool_runtime::Tool;
