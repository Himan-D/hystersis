...
use hystersis_tool_types::SubagentCompletedOutput;
...
use crate::implementations::hystersis_build::todo::{TodoItem, TodoState};
...
pub(crate) fn typed_tool_output_preserving_cco(
    ...
    source: &impl hystersis_tool_runtime::ToolOutput,
) -> hystersis_tool_runtime::TypedToolOutput {
    let cco = source.chat_completion_output();
    let value = serde_json::to_value(payload).unwrap_or(serde_json::Value::Null);
    hystersis_tool_runtime::TypedToolOutput::from_value(tool_id, value).with_chat_completion_output(cco)
}
...
/// protocol boundary in `xai-hystersis-shell`.
#[derive(Debug, Clone, Serialize, Deserialize, schemars::JsonSchema)]
...
pub struct BashOutput {
    ...
    /// Set by the hystersis_build `run_terminal_cmd` implementation when the
    /// command was detected as a bare `echo "<msg>"` (or close variant:
    /// echo -n, echo -e, simple printf for literal output, etc.).
    ///
    /// Used for:
    /// - Telemetry / statistics on this pattern for the hystersis_build backend.
...
pub struct WebFetchContent {
    ...
    pub bytes: usize,
    /// Internal path to the complete converted body when HystersisBuild persisted overflow.
    #[serde(skip)]
    #[schemars(skip)]
...
use hystersis_tool_types::KillTaskOutput;
...
impl hystersis_tool_runtime::ToolOutput for BashToolOutput {
    fn chat_completion_output(&self) -> Option<hystersis_tool_runtime::ToolChatCompletionResponse> {
        match self {
            Self::Bash(bash) => hystersis_tool_runtime::ToolOutput::chat_completion_output(bash),
...
pub enum ToolOutput {
    ...
    Monitor(crate::implementations::hystersis_build::monitor::types::MonitorOutput),
    SchedulerCreate(crate::implementations::hystersis_build::scheduler::create::SchedulerCreateOutput),
    SchedulerDelete(crate::implementations::hystersis_build::scheduler::delete::SchedulerDeleteOutput),
    SchedulerList(crate::implementations::hystersis_build::scheduler::list::SchedulerListOutput),
    UpdateGoal(crate::implementations::hystersis_build::update_goal::UpdateGoalOutput),
    Workflow(crate::implementations::hystersis_build::workflow::WorkflowToolOutput),
...
impl hystersis_tool_runtime::ToolOutput for ToolOutput {
    fn chat_completion_output(&self) -> Option<hystersis_tool_runtime::ToolChatCompletionResponse> {
        match self {
            Self::Bash(bash) => hystersis_tool_runtime::ToolOutput::chat_completion_output(bash),
            _ => None,
...
impl hystersis_tool_runtime::ToolOutput for BashOutput {
    fn chat_completion_output(&self) -> Option<hystersis_tool_runtime::ToolChatCompletionResponse> {
        ...
        Some(hystersis_tool_runtime::ToolChatCompletionResponse {
            result: Some(hystersis_tool_runtime::ToolChatCompletion {
                sender: "assistant".into(),
                message_tag: Some("raw_function_result".into()),
                code_execution_result: Some(hystersis_tool_runtime::ToolCodeExecutionResult {
                    stdout,
                    stderr: String::new(),
...
impl hystersis_tool_runtime::ToolOutput for GrepSearchOutput {}
impl hystersis_tool_runtime::ToolOutput for ReadFileOutput {}
impl hystersis_tool_runtime::ToolOutput for ListDirOutput {}
impl hystersis_tool_runtime::ToolOutput for SearchReplaceOutput {}
impl hystersis_tool_runtime::ToolOutput for TodoWriteOutput {}
impl hystersis_tool_runtime::ToolOutput for WebSearchOutput {}
impl hystersis_tool_runtime::ToolOutput for WebFetchOutput {}
impl hystersis_tool_runtime::ToolOutput for SkillOutput {}
impl hystersis_tool_runtime::ToolOutput for ApplyPatchOutput {}
impl hystersis_tool_runtime::ToolOutput for CodexGrepFilesOutput {}
impl hystersis_tool_runtime::ToolOutput for SearchToolOutput {}
impl hystersis_tool_runtime::ToolOutput for EnterPlanModeOutput {}
impl hystersis_tool_runtime::ToolOutput for ExitPlanModeOutput {}
impl hystersis_tool_runtime::ToolOutput for AskUserQuestionOutput {}
impl hystersis_tool_runtime::ToolOutput for MCPOutput {}
#[cfg(test)]
mod tests {
    use super::*;
    use crate::implementations::hystersis_build::todo::{TodoPriority, TodoStatus};
    use serde_json::json;
    use hystersis_tool_types::KillTaskResult;
    use hystersis_tool_types::TaskOutputResult;
    ...
    fn subagent_completed_prompt_format_with_worktree() {
        let output = ToolOutput::SubagentCompleted(SubagentCompletedOutput {
            ...
            turns: 1,
            duration_ms: 2000,
            worktree_path: Some("/tmp/hystersis-worktree/wt-agent".into()),
            persona: None,
        ...
        let rendered = output.to_prompt_format();
        assert!(
            rendered.contains("<worktree_path>/tmp/hystersis-worktree/wt-agent</worktree_path>"),
    ...
    fn assert_cer(
        resp: &hystersis_tool_runtime::ToolChatCompletionResponse,
        stdout: &str,
        exit_code: i32,
        timed_out: bool,
    ) {
    ...
    fn bash_output_chat_completion_carries_exit_and_stdout() {
        let resp = hystersis_tool_runtime::ToolOutput::chat_completion_output(&sample_bash(
            0, b"hello\n", false,
        ))
        .unwrap();
    ...
    fn bash_output_chat_completion_empty_stdout_still_emits() {
        let resp =
            hystersis_tool_runtime::ToolOutput::chat_completion_output(&sample_bash(0, b"", false))
                .unwrap();
    ...
    fn bash_output_chat_completion_truncation_marker_and_extra() {
        ...
        let resp = hystersis_tool_runtime::ToolOutput::chat_completion_output(&bash).unwrap();
        let result = resp.result.as_ref().unwrap();
    ...
    fn bash_tool_output_foreground_delegates_background_skips() {
        let resp = hystersis_tool_runtime::ToolOutput::chat_completion_output(&BashToolOutput::Bash(
            sample_bash(0, b"ok", false),
        ))
        .unwrap();
        assert_cer(&resp, "ok", 0, false);
        assert!(
            hystersis_tool_runtime::ToolOutput::chat_completion_output(
    ...
    fn aggregate_tool_output_bash_delegates_background_skips() {
        let resp = hystersis_tool_runtime::ToolOutput::chat_completion_output(&ToolOutput::Bash(
        ...
        assert!(
            hystersis_tool_runtime::ToolOutput::chat_completion_output(&ToolOutput::Text(
    ...
    fn bash_tool_id() -> hystersis_tool_protocol::ToolId {
        hystersis_tool_protocol::ToolId::new("bash").unwrap()
    }
    #[test]
    fn into_typed_tool_output_preserves_bash_foreground_cco() {
        ...
        let dropped = hystersis_tool_runtime::TypedToolOutput::from_value(typed.tool_id, expected_value);
    ...
    fn into_typed_tool_output_non_bash_cco_is_none() {
        ...
        let typed = run.into_typed_tool_output(hystersis_tool_protocol::ToolId::new("text").unwrap());
