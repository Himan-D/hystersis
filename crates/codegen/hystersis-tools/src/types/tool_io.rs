...
use crate::implementations::hystersis_build::ask_user_question::AskUserQuestionInput;
use crate::implementations::hystersis_build::enter_plan_mode::EnterPlanModeInput;
use crate::implementations::hystersis_build::exit_plan_mode::ExitPlanModeInput;
use crate::implementations::hystersis_build::grep::GrepSearchInput;
use crate::implementations::hystersis_build::image_edit::ImageEditInput;
use crate::implementations::hystersis_build::image_gen::ImageGenInput;
use crate::implementations::hystersis_build::list_dir::ListDirInput;
use crate::implementations::hystersis_build::read_file::ReadFileInput;
use crate::implementations::hystersis_build::search_replace::SearchReplaceInput;
use crate::implementations::hystersis_build::todo::TodoWriteInput;
use crate::implementations::hystersis_build::update_goal::UpdateGoalInput;
use crate::implementations::hystersis_build::video_gen::{ImageToVideoInput, ReferenceToVideoInput};
use crate::implementations::hystersis_build::web_fetch::WebFetchInput;
use crate::implementations::hystersis_build::web_search::WebSearchInput;
...
use hystersis_tool_types::KillTaskToolInput;
use hystersis_tool_types::TaskOutputToolInput;
use hystersis_tool_types::TaskToolInput;
use hystersis_tool_types::WaitTasksToolInput;
...
pub enum ToolInput {
    ...
    HashlineEdit(crate::implementations::hystersis_build_hashline::edit::types::HashlineEditInput),
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::hystersis_build::monitor::types::MonitorInput),
    SchedulerCreate(crate::implementations::hystersis_build::scheduler::create::SchedulerCreateInput),
    SchedulerDelete(crate::implementations::hystersis_build::scheduler::delete::SchedulerDeleteInput),
    SchedulerList(crate::implementations::hystersis_build::scheduler::list::SchedulerListInput),
    UpdateGoal(UpdateGoalInput),
    Workflow(crate::implementations::hystersis_build::workflow::WorkflowToolInput),
