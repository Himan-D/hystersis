...
//! [`hystersis_tools_api::config_validation`] so every consumer (this
...
pub use hystersis_tools_api::config_validation::{ToolConfigEntryError, ToolConfigEntryErrorKind};

/// Convert one wire [`hystersis_tools_api::ToolConfigEntry`] to a runtime
/// [`ToolConfig`].
///
...
pub fn tool_config_from_entry(
    index: usize,
    entry: hystersis_tools_api::ToolConfigEntry,
) -> Result<ToolConfig, ToolConfigEntryError> {
    let hystersis_tools_api::ToolConfigEntry {
        id,
        params_json,
        name_override,
    ...
    let params = hystersis_tools_api::config_validation::parse_params_json(
        index,
        &id,
        params_json.as_deref(),
    )?;
    hystersis_tools_api::config_validation::validate_name_override(
        index,
        &id,
...
pub fn tool_server_config_from_entries(
    entries: Vec<hystersis_tools_api::ToolConfigEntry>,
...
mod tests {
    ...
    fn entry(id: &str) -> hystersis_tools_api::ToolConfigEntry {
        hystersis_tools_api::ToolConfigEntry {
            id: id.to_owned(),
            params_json: None,
            name_override: None,
