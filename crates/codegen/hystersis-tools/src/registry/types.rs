use crate::{
    ...
    implementations::{
        codex, hystersis_build, hystersis_build_concise, hystersis_build_hashline, opencode,
...
/// this crate: instead of `xai-hystersis-tools` referencing an out-of-tree tool
/// pack, the pack calls
...
impl ToolConfig {
    ...
    /// `hystersis_tool_runtime::Tool::id()`. Use this for built-in tools known
    ...
    where
        T: crate::types::tool_metadata::ToolMetadata + hystersis_tool_runtime::Tool + Default,
    {
        Self::from(&T::default())
    }
...
impl<T: crate::types::tool_metadata::ToolMetadata + hystersis_tool_runtime::Tool> From<&T>
    for ToolConfig
{
    fn from(tool: &T) -> Self {
        Self {
            id: format!(
                "{}:{}",
                tool.tool_namespace(),
                hystersis_tool_runtime::Tool::id(tool).as_str()
            ),
            params: None,
            name_override: None,
            params_name_overrides: None,
...
pub struct SubagentSessionResources {
    pub backend: crate::implementations::hystersis_build::task::backend::SubagentBackendResource,
    ...
    pub event_sender: crate::implementations::hystersis_build::task::types::SubagentEventSender,
    pub depth: crate::implementations::hystersis_build::task::types::SubagentDepthCounter,
    pub session_id: crate::implementations::hystersis_build::task::types::SessionIdResource,
}
...
pub struct SessionContext {
    ...
    pub parent_scheduler_handle:
        Option<crate::implementations::hystersis_build::scheduler::types::SchedulerHandle>,
    ...
    ///
    /// Empty means this registry gives the session a handle that reads and writes nothing. `xai-hystersis-agent` reads
    ...
    pub web_fetch_config: crate::implementations::hystersis_build::web_fetch::WebFetchConfig,
    ...
    pub image_gen_config: crate::implementations::hystersis_build::image_gen::ImageGenConfig,
    ...
    pub video_gen_config: crate::implementations::hystersis_build::video_gen::VideoGenConfig,
    ...
    pub app_builder_deployer_config:
        crate::implementations::hystersis_build::app_builder::AppBuilderDeployerConfig,
    ...
    /// Auth provider which returns a hystersis_computer_hub_sdk::AuthCredential. Can be used by
    ...
    pub auth_provider: Option<hystersis_computer_hub_sdk::SharedAuthProvider>,
...
pub async fn drain_value_stream(
    mut stream: hystersis_tool_runtime::ToolStream<hystersis_tool_runtime::TypedToolOutput>,
) -> Result<serde_json::Value, hystersis_tool_runtime::ToolError> {
    use futures::StreamExt;
    while let Some(item) = stream.next().await {
        match item {
            hystersis_tool_runtime::ToolStreamItem::Progress(_) => continue,
            hystersis_tool_runtime::ToolStreamItem::Terminal(result) => {
...
fn stream_no_terminal_error() -> hystersis_tool_runtime::ToolError {
    hystersis_tool_runtime::ToolError::custom(
        "stream_no_terminal",
...
struct DispatchParts {
    ...
    lr_handle: Arc<dyn hystersis_computer_hub_core::ToolHandle>,
    /// Runtime context built for the call (resources, renderer, cwd,
    /// behavior version, inner-dispatch).
    ctx: hystersis_tool_runtime::ToolCallContext,
...
struct ToolEntry {
    ...
    parse_input: Box<
        dyn Fn(serde_json::Value) -> Result<ToolInput, hystersis_tool_runtime::ToolError> + Send + Sync,
    >,
    /// Registers this tool into a `LocalRegistry` using the concrete type.
    /// Captured at `register::<T>()` time when T is known.
    register_in_local: Box<dyn Fn(&hystersis_computer_hub_sdk::LocalRegistry) + Send + Sync>,
}
...
pub struct FinalizedToolset {
    ...
    local_registry: hystersis_computer_hub_sdk::LocalRegistry,
    ...
    workspace_viewer_ctx: Option<hystersis_tool_runtime::WorkspaceViewerContext>,
}
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]
...
pub struct ToolRegistryBuilder {
    ...
    shared_local_registry: Option<hystersis_computer_hub_sdk::LocalRegistry>,
...
impl ToolRegistryBuilder {
            ...
            + 'static,
    {
        ...
        let id = hystersis_tool_runtime::Tool::id(&tool).as_str().to_string();
        let kind = tool.kind();
        ...
        self.tools.insert(
            ...
            ToolEntry {
                ...
                register_in_local: Box::new(|lr: &hystersis_computer_hub_sdk::LocalRegistry| {
    ...
    /// Fully-qualified tool id (`"HystersisBuild:read_file"`) → declared
    ...
    pub fn new() -> Self {
        ...
        b.register_with_params::<hystersis_build::BashTool, hystersis_build::bash::BashParams>();
        b.register_with_params::<hystersis_build::ReadFileTool, hystersis_build::read_file::ReadFileParams>();
        b.register_with_params::<
                hystersis_build::SearchReplaceTool,
                hystersis_build::search_replace::SearchReplaceParams,
            >();
        b.register_with_params::<hystersis_build::ListDirTool, hystersis_build::list_dir::ListDirParams>();
        b.register_with_params::<hystersis_build::GrepTool, hystersis_build::grep::GrepParams>();
        b.register::<hystersis_build::KillTaskTool>();
        b.register::<hystersis_build::KillTerminalCommandTool>();
        b.register::<hystersis_build::TodoWriteTool>();
        b.register::<hystersis_build::UpdateGoalTool>();
        b.register::<hystersis_build::WorkflowTool>();
        b.register::<hystersis_build::TaskOutputTool>();
        b.register::<hystersis_build::GetTerminalCommandOutputTool>();
        b.register::<hystersis_build::WaitTasksTool>();
        b.register::<hystersis_build::TaskTool>();
        b.register::<hystersis_build::WebSearchTool>();
        b.register_with_params::<hystersis_build::WebFetchTool, hystersis_build::web_fetch::WebFetchParams>();
        b.register::<hystersis_build::LspTool>();
        b.register::<hystersis_build::ImageGenTool>();
        b.register::<hystersis_build::ImageEditTool>();
        b.register::<hystersis_build::ImageToVideoTool>();
        b.register::<hystersis_build::ReferenceToVideoTool>();
        b.register::<hystersis_build::EnterPlanModeTool>();
        b.register::<hystersis_build::ExitPlanModeTool>();
        b.register_with_params::<
                hystersis_build::AskUserQuestionTool,
                hystersis_build::ask_user_question::AskUserQuestionParams,
            >();
        b.register::<hystersis_build::MonitorTool>();
        b.register::<hystersis_build::SchedulerCreateTool>();
        b.register::<hystersis_build::SchedulerDeleteTool>();
        b.register::<hystersis_build::SchedulerListTool>();
        ...
        b.register_with_params::<
            ...
            >();
        b.register_with_params::<
                hystersis_build_concise::ReadFileConciseTool,
                hystersis_build::read_file::ReadFileParams,
            >();
        b.register_with_params::<
                hystersis_build_concise::SearchReplaceConciseTool,
                hystersis_build::search_replace::SearchReplaceParams,
            >();
        b.register_with_params::<
                hystersis_build_concise::BashConciseTool,
                hystersis_build::bash::BashParams,
            >();
        b.register_with_params::<
                hystersis_build_hashline::HashlineReadTool,
                hystersis_build_hashline::config::HashlineSchemeParams,
            >();
        b.register_with_params::<
                hystersis_build_hashline::HashlineEditTool,
                hystersis_build_hashline::config::HashlineSchemeParams,
            >();
        b.register_with_params::<
                hystersis_build_hashline::HashlineGrepTool,
                hystersis_build_hashline::config::HashlineSchemeParams,
            >();
    ...
    pub fn with_local_registry(mut self, registry: hystersis_computer_hub_sdk::LocalRegistry) -> Self {
    ...
    pub fn validate_config(&self, config: &ToolServerConfig) -> Vec<RequirementError> {
        ...
        }
        {
            let standard_file_ids: &[&str] = &[
                "HystersisBuild:read_file",
                "HystersisBuild:search_replace",
                "HystersisBuild:grep",
            ];
            let hashline_file_ids: &[&str] = &[
                "HystersisBuildHashline:hashline_read",
                "HystersisBuildHashline:hashline_edit",
                "HystersisBuildHashline:hashline_grep",
            ];
    ...
    pub fn finalize_with_trunc_config(
        ...
        if image_gen_config.has_credentials() {
            match crate::implementations::hystersis_build::image_gen::ImageGenClient::new(
                &image_gen_config,
                ctx.api_key_provider.clone(),
            ) {
                Ok(client) => {
        ...
        if video_gen_config.is_enabled() {
            match crate::implementations::hystersis_build::video_gen::VideoGenClient::new(
                &video_gen_config,
                ctx.api_key_provider.clone(),
            ) {
                Ok(client) => {
        ...
        if let crate::implementations::hystersis_build::web_fetch::WebFetchConfig::Enabled { params } =
            &ctx.web_fetch_config
        {
            match crate::implementations::hystersis_build::web_fetch::WebFetchClient::new(params) {
                Ok(client) => {
                    resources.insert(client);
                }
                Err(e) => {
        ...
        let concise_ns = crate::types::tool::ToolNamespace::HystersisBuildConcise.to_string();
        ...
        resources.register_state::<crate::implementations::hystersis_build::todo::TodoState>();
        ...
        resources
            ...
            >();
        resources
            .register_state::<crate::implementations::hystersis_build::scheduler::types::SchedulerState>(
            );
        ...
        for tool_config in &config.tools {
            ...
            if let Some(desc) = &definition.function.description {
                definition.function.description = Some(truncation_config.interpolate_description(
                    ...
                    hystersis_tool_types::max_wait_block_ms(),
                ));
            }
        ...
        let (scheduler_cmd_rx, scheduler_cancel_token) =
            if let Some(parent_handle) = ctx.parent_scheduler_handle {
                ...
                resources.insert(
                    crate::implementations::hystersis_build::scheduler::types::SchedulerHandle(
                        scheduler_cmd_tx,
                    ),
                );
        ...
        if let (Some(cmd_rx), Some(cancel_token)) = (scheduler_cmd_rx, &scheduler_cancel_token) {
            let actor = crate::implementations::hystersis_build::scheduler::actor::SchedulerActor {
...
///
/// Implements the canonical `hystersis_tool_runtime::ToolDispatch` trait so the
...
#[async_trait::async_trait]
impl hystersis_tool_runtime::ToolDispatch for InnerDispatchForToolset {
    async fn call(
        &self,
        tool_id: hystersis_tool_protocol::ToolId,
        args: serde_json::Value,
        ctx: hystersis_tool_runtime::ToolCallContext,
    ) -> hystersis_tool_runtime::ToolStream<hystersis_tool_runtime::TypedToolOutput> {
        let result = self
            .toolset
            ...
            .and_then(|output| {
                let value = serde_json::to_value(&output).map_err(|e| {
                    hystersis_tool_runtime::ToolError::custom("output_encoding", e.to_string())
                })?;
                Ok(hystersis_tool_runtime::TypedToolOutput::from_value(
                    tool_id.clone(),
                    value,
                ))
            });
        hystersis_tool_runtime::terminal_only(result)
    }
}
impl FinalizedToolset {
    ...
    pub fn empty_for_test() -> Self {
        Self {
            ...
            local_registry: hystersis_computer_hub_sdk::LocalRegistry::new(),
    ...
    pub fn local_registry(&self) -> &hystersis_computer_hub_sdk::LocalRegistry {
        &self.local_registry
    }
    ...
    /// `hystersis.com/*` tool `_meta` contract (tool normalization). Returns `None` for
    ...
    fn tool_not_found_error(tool_name: &str) -> hystersis_tool_runtime::ToolError {
        let tid = hystersis_tool_protocol::ToolId::new(tool_name)
            .unwrap_or_else(|_| hystersis_tool_protocol::ToolId::new("unknown").expect("valid"));
        hystersis_tool_runtime::ToolError::not_found(tid, format!("Tool not found: {tool_name}"))
    }
    pub async fn try_parse(
        &self,
        tool_name: &str,
        tool_params: &serde_json::Value,
    ) -> Result<ToolInput, hystersis_tool_runtime::ToolError> {
    ...
    async fn call_raw(
        ...
        parent_ctx: hystersis_tool_runtime::ToolCallContext,
    ) -> Result<crate::types::output::ToolOutput, hystersis_tool_runtime::ToolError> {
        ...
        let mut ctx = hystersis_tool_runtime::ToolCallContext::new(parent_ctx.call_id.clone());
        ctx.extensions.insert(self.resources.clone());
        ctx.extensions.insert_arc(Arc::clone(&self.renderer));
        if let Some(cancellation) = parent_ctx.get::<hystersis_tool_runtime::Cancellation>() {
        ...
        if let Some(cwd) = parent_ctx.extensions.get::<hystersis_tool_runtime::Cwd>() {
            ctx.extensions.insert((*cwd).clone());
        }
        let tool_id = hystersis_tool_protocol::ToolId::new(&registry_id)
            .unwrap_or_else(|_| hystersis_tool_protocol::ToolId::new("unknown").expect("valid"));
        let lr_handle = self.local_registry.find(&tool_id).ok_or_else(|| {
            hystersis_tool_runtime::ToolError::not_found(
                tool_id,
        ...
        (output_converter)(value)
            .map_err(|e| hystersis_tool_runtime::ToolError::custom("output_decoding", e.to_string()))
    }
    ...
    ) -> Result<ToolRunResult, hystersis_tool_runtime::ToolError> {
    ...
    pub async fn call_with_cancellation(
        ...
        while let Some(item) = stream.next().await {
            match item {
                hystersis_tool_runtime::ToolStreamItem::Progress(_) => continue,
                hystersis_tool_runtime::ToolStreamItem::Terminal(result) => return result,
            }
        }
        Err(stream_no_terminal_error())
    }
    ...
    ///
    /// [`ToolStream`]: hystersis_tool_runtime::ToolStream
    /// [`ToolStreamItem::Progress`]: hystersis_tool_runtime::ToolStreamItem::Progress
    pub fn call_streaming(
        ...
        tool_call_id: &str,
        cwd_override: Option<std::path::PathBuf>,
    ) -> hystersis_tool_runtime::ToolStream<ToolRunResult> {
    ...
    pub fn call_streaming_with_cancellation(
        ...
        Box::pin(async_stream::stream! {
            let parts = match this.prepare_dispatch(
                ...
                Ok(parts) => parts,
                Err(e) => {
                    yield hystersis_tool_runtime::ToolStreamItem::Terminal(Err(e));
                    return;
                }
            };
            let DispatchParts {
            ...
            while let Some(item) = inner.next().await {
                match item {
                    hystersis_tool_runtime::ToolStreamItem::Progress(p) => {
                        yield hystersis_tool_runtime::ToolStreamItem::Progress(p);
                    }
                    hystersis_tool_runtime::ToolStreamItem::Terminal(Err(e)) => {
                        yield hystersis_tool_runtime::ToolStreamItem::Terminal(Err(e));
                        return;
                    }
                    hystersis_tool_runtime::ToolStreamItem::Terminal(Ok(typed)) => {
                        let run_result = this
                            .finalize_output(typed.value, &output_converter, effective_tool_name)
                            .await;
                        yield hystersis_tool_runtime::ToolStreamItem::Terminal(run_result);
                        return;
                    }
                }
            }
            yield hystersis_tool_runtime::ToolStreamItem::Terminal(Err(stream_no_terminal_error()));
        })
    }
    ...
    fn prepare_dispatch(
        ...
        cwd_override: Option<std::path::PathBuf>,
        cancellation: Option<tokio_util::sync::CancellationToken>,
    ) -> Result<DispatchParts, hystersis_tool_runtime::ToolError> {
        let (registry_id, output_converter, reverse_params) = {
            let tools = self.tools.read();
            let entry = tools
                .iter()
        ...
        let rt_call_id = hystersis_tool_protocol::ToolCallId::new(tool_call_id)
            .unwrap_or_else(|_| hystersis_tool_protocol::ToolCallId::new_v7());
        let mut ctx = hystersis_tool_runtime::ToolCallContext::new(rt_call_id);
        ctx.extensions.insert(self.resources.clone());
        ctx.extensions.insert_arc(Arc::clone(&self.renderer));
        ctx.extensions.insert(
            crate::types::resources::InvokingToolParamNames::from_reverse_params(&reverse_params),
        ...
        if let Some(cwd) = cwd_override {
            ctx.extensions.insert(hystersis_tool_runtime::Cwd(cwd));
        }
        if let Some(cancellation) = cancellation {
            ctx.extensions
                .insert(hystersis_tool_runtime::Cancellation(cancellation));
        }
        if let Some(ref version) = contract_version {
            ctx.extensions
                .insert(hystersis_tool_runtime::BehaviorVersion(version.clone()));
        }
    ...
    ///
    /// The tool must implement `hystersis_tool_runtime::Tool + ToolMetadata`.
    ...
    ) -> Result<(), hystersis_tool_runtime::ToolError>
    where
        T: hystersis_tool_runtime::Tool + ToolMetadata + std::fmt::Debug + Send + Sync + 'static,
        T::Output: serde::Serialize,
    {
        let mut tools = self.tools.write();
        if tools.iter().any(|t| t.client_name == name) {
            return Err(hystersis_tool_runtime::ToolError::invalid_arguments(format!(
                "Tool already registered: {name}"
            )));
        }
        let description = tool.description_template().to_string();
        let kind = tool.kind();
        let registry_id = hystersis_tool_runtime::Tool::id(&tool).as_str().to_owned();
    ...
    pub fn unregister_tools_by_prefix(&self, prefix: &str) -> usize {
        ...
        let to_remove: Vec<_> = tools
            ...
            .filter_map(|t| hystersis_tool_protocol::ToolId::new(&t.registry_id).ok())
            .collect();
    ...
    pub fn unregister_tool_by_name(&self, name: &str) -> bool {
        ...
        let tool_id = tools
            ...
            .and_then(|t| hystersis_tool_protocol::ToolId::new(&t.registry_id).ok());
        let before = tools.len();
...
fn explain_requirement_failure(
    ...
    match fq_tool_id.as_str() {
        ...
        "HystersisBuild:get_task_output" => {
            let has_hystersis_build_bash = has_tool_with_bool_param(
                proposed,
                "HystersisBuild",
                "run_terminal_cmd",
                "enabled_background",
            ...
            let has_hystersis_build_concise_bash = has_tool_with_bool_param(
                proposed,
                "HystersisBuildConcise",
                "run_terminal_cmd",
                "enabled_background",
                true,
            );
            let has_opencode_bash = has_tool(proposed, "OpenCode", "bash");
            let has_task = has_tool(proposed, "HystersisBuild", "task");
            let mut notes = vec![];
            if has_tool(proposed, "HystersisBuild", "run_terminal_cmd")
                && !has_hystersis_build_bash
            {
                notes
                    .push(
                        "HystersisBuild:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            if has_tool(proposed, "HystersisBuildConcise", "run_terminal_cmd")
                && !has_hystersis_build_concise_bash
            {
                notes
                    .push(
                        "HystersisBuildConcise:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            let mut message = "get_task_output requires a background-capable bash tool (HystersisBuild:run_terminal_cmd or HystersisBuildConcise:run_terminal_cmd with enabled_background=true), OpenCode:bash, or HystersisBuild:task"
                .to_string();
            let has_provider = has_hystersis_build_bash || has_hystersis_build_concise_bash
            ...
            RequirementError::new(fq_tool_id, message)
                .with_field_path("tools")
                .with_expected(
                    "include a background-capable bash tool, OpenCode:bash, or HystersisBuild:task",
                )
                .with_category("requirements")
        }
        "HystersisBuild:search_replace" if !params
            ...
            RequirementError::new(
                ...
                .with_expected(
                    "set skip_read_before_edit=true or include a Read tool such as HystersisBuild:read_file",
                )
                .with_bad_value(serde_json::Value::Bool(false))
                .with_category("requirements")
        }
        "HystersisBuild:enter_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "enter_plan_mode requires HystersisBuild:exit_plan_mode so plan mode can always be exited",
                )
                .with_field_path("tools")
                .with_expected("include HystersisBuild:exit_plan_mode")
                .with_category("requirements")
        }
        "HystersisBuild:exit_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "exit_plan_mode requires HystersisBuild:enter_plan_mode so plan mode can be entered before exiting",
                )
                .with_field_path("tools")
                .with_expected("include HystersisBuild:enter_plan_mode")
                .with_category("requirements")
        }
        _ => {
...
mod tests {
    ...
    fn test_session_context(tmp: &TempDir) -> SessionContext {
        SessionContext {
            ...
            web_fetch_config:
                crate::implementations::hystersis_build::web_fetch::WebFetchConfig::default(),
            lsp: None,
            image_gen_config:
                crate::implementations::hystersis_build::image_gen::ImageGenConfig::default(),
            video_gen_config:
                crate::implementations::hystersis_build::video_gen::VideoGenConfig::default(),
            app_builder_deployer_config:
                crate::implementations::hystersis_build::app_builder::AppBuilderDeployerConfig::default(),
    ...
    /// appeared before `hystersis_build:search_replace` (`ToolKind::Edit`, input:
    ...
    async fn kind_params_merged_across_multiple_tools_of_same_kind() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "HystersisBuild:search_replace".to_string(),
                    params: Some(
    ...
    async fn search_replace_description_renders_minimum_anchor_guidance() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "HystersisBuild:read_file".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    /// Smoke test: finalize the full HystersisBuild toolset and verify every
    ...
    async fn full_toolset_descriptions_render_cleanly() {
        use crate::implementations::hystersis_build::{
        ...
        let config = ToolServerConfig {
            ...
            .into_iter()
            .map(|id| ToolConfig::from_id(format!("HystersisBuild:{id}")))
    ...
    /// name: `run_terminal_cmd` (hystersis).
    #[tokio::test]
    async fn tool_name_for_kind_resolves_execute() {
        use crate::types::tool::ToolKind;
        let tmp = TempDir::new().unwrap();
        let hystersis = ToolRegistryBuilder::new()
            .finalize(
                ToolServerConfig {
                    tools: vec![
                        ToolConfig::from_id("HystersisBuild:run_terminal_cmd".to_string()),
                        ToolConfig::from_id("HystersisBuild:get_task_output".to_string()),
                        ToolConfig::from_id("HystersisBuild:kill_task".to_string()),
                    ],
                    behavior_preset: None,
                },
                test_session_context(&tmp),
            )
            .expect("hystersis toolset should finalize");
        assert_eq!(
            hystersis.tool_name_for_kind(ToolKind::Execute).as_deref(),
            Some("run_terminal_cmd")
        );
    }
    /// `merge_tool_meta` (the harness emission path) must stamp `hystersis.com/tool` for a
    ...
    fn capabilities_is_read_only_matches_metadata() {
        ...
        let mismatches: Vec<String> = builder
            ...
            .filter_map(|(name, entry)| {
                let lr = hystersis_computer_hub_sdk::LocalRegistry::new();
                (entry.register_in_local)(&lr);
                let id = hystersis_tool_protocol::ToolId::new(&entry.id)
    ...
    fn tool_config_kind_sinks_unknown_to_other() {
        ...
        let known = parse(serde_json::json!({"id": "HystersisBuild:read_file", "kind": "read"}));
        assert_eq!(known.kind, Some(ToolKind::Read));
        let typo = parse(serde_json::json!({"id": "HystersisBuild:read_file", "kind": "raed"}));
        assert_eq!(typo.kind, Some(ToolKind::Other));
        let absent = parse(serde_json::json!({"id": "HystersisBuild:read_file"}));
    ...
    async fn bash_descriptions_track_system_reminders_setting() {
        ...
        let ids = [
            "HystersisBuild:run_terminal_cmd",
            "HystersisBuild:get_task_output",
            "HystersisBuild:kill_task",
        ];
        let tmp = TempDir::new().unwrap();
        let toolset = ToolRegistryBuilder::new()
    ...
    /// Verify HystersisBuildConcise tools can be finalized and produce concise output.
    #[tokio::test]
    async fn test_concise_namespace_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "HystersisBuildConcise:read_file".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "HystersisBuildConcise:search_replace".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "HystersisBuildConcise:run_terminal_cmd".to_string(),
                    params: Some(
                ...
                ToolConfig::for_tool::<hystersis_build::GrepTool>(),
                ToolConfig::for_tool::<hystersis_build::KillTaskTool>(),
                ToolConfig::for_tool::<hystersis_build::TaskOutputTool>(),
                ToolConfig {
                    id: "HystersisBuild:list_dir".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    fn has_tool_id_knows_pinned_tool_config_ids() {
        ...
        for id in [
            ...
            "HystersisBuild:read_file",
            "HystersisBuild:search_replace",
            "HystersisBuild:list_dir",
            "HystersisBuild:grep",
            "HystersisBuild:get_terminal_command_output",
            "HystersisBuild:kill_terminal_command",
        ] {
            assert!(
        ...
        assert!(
            !builder.has_tool_id("HystersisBuild:does_not_exist"),
    ...
    fn known_tool_kinds_maps_pinned_tool_config_ids() {
        ...
        for (id, expected) in [
            ("HystersisBuild:run_terminal_cmd", ToolKind::Execute),
            ("HystersisBuild:read_file", ToolKind::Read),
            ("HystersisBuild:search_replace", ToolKind::Edit),
            ("HystersisBuild:grep", ToolKind::Search),
            ("HystersisBuild:list_dir", ToolKind::List),
        ] {
            assert_eq!(
                kinds.get(id),
                Some(&expected),
        ...
        assert!(
            !kinds.contains_key("HystersisBuild:does_not_exist"),
    ...
    /// (e.g. `"read_file"`). If both `HystersisBuild:read_file` and
    ...
    fn validate_config_reports_param_field_path_and_value() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "HystersisBuild:run_terminal_cmd".to_string(),
                params: Some(
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "HystersisBuild:run_terminal_cmd");
        assert_eq!(
    ...
    fn validate_config_reports_semantic_hashline_param_error() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "HystersisBuildHashline:hashline_read".to_string(),
                params: Some(
                    serde_json::from_value(serde_json::json!({
                        "hash_len": 0
                    }))
    ...
    impl hystersis_tool_runtime::Tool for FakeMcpTool {
        type Args = serde_json::Value;
        type Output = String;
        fn id(&self) -> hystersis_tool_protocol::ToolId {
            hystersis_tool_protocol::ToolId::new("fake_mcp").expect("valid")
        }
        fn description(
            &self,
            _ctx: &::hystersis_tool_runtime::ListToolsContext,
        ) -> hystersis_tool_types::ToolDescription {
            hystersis_tool_types::ToolDescription::new("fake_mcp", &self.description)
        }
        async fn run(
            &self,
            _ctx: hystersis_tool_runtime::ToolCallContext,
            _input: serde_json::Value,
        ) -> Result<String, hystersis_tool_runtime::ToolError> {
            Ok("ok".into())
        }
    }
    #[tokio::test]
    ...
    impl hystersis_tool_runtime::Tool for NonStreamingStub {
        type Args = serde_json::Value;
        type Output = String;
        fn id(&self) -> hystersis_tool_protocol::ToolId {
            hystersis_tool_protocol::ToolId::new("non_streaming_stub").expect("valid")
        }
        fn description(
            &self,
            _ctx: &::hystersis_tool_runtime::ListToolsContext,
        ) -> hystersis_tool_types::ToolDescription {
            hystersis_tool_types::ToolDescription::new("non_streaming_stub", "non-streaming stub")
        }
        async fn run(
            &self,
            _ctx: hystersis_tool_runtime::ToolCallContext,
    ...
    impl hystersis_tool_runtime::Tool for StreamingStub {
        type Args = serde_json::Value;
        type Output = String;
        fn id(&self) -> hystersis_tool_protocol::ToolId {
            hystersis_tool_protocol::ToolId::new("streaming_stub").expect("valid")
        }
        fn description(
            &self,
            _ctx: &::hystersis_tool_runtime::ListToolsContext,
        ) -> hystersis_tool_types::ToolDescription {
            hystersis_tool_types::ToolDescription::new("streaming_stub", "streaming stub")
        }
        async fn run(
            &self,
            _ctx: hystersis_tool_runtime::ToolCallContext,
        ...
        async fn execute(
            ...
            _ctx: hystersis_tool_runtime::ToolCallContext,
            _input: serde_json::Value,
        ) -> hystersis_tool_runtime::ToolStream<String> {
            Box::pin(futures::stream::iter(vec![
                hystersis_tool_runtime::ToolStreamItem::Progress(hystersis_tool_runtime::ToolProgress::Text {
                    text: "progress-1".into(),
                }),
                hystersis_tool_runtime::ToolStreamItem::Terminal(Ok("terminal-value".to_string())),
            ]))
        }
    }
    ...
    async fn call_non_streaming_stub_back_compat() {
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<hystersis_build::ReadFileTool>()],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
        let toolset = Arc::new(builder.finalize(config, ctx).unwrap());
        ...
        while let Some(item) = stream.next().await {
            match item {
                hystersis_tool_runtime::ToolStreamItem::Progress(p) => {
                    ...
                    assert!(matches!(p, hystersis_tool_runtime::ToolProgress::Text { .. }));
                    progress_count += 1;
                }
                hystersis_tool_runtime::ToolStreamItem::Terminal(result) => {
    ...
    impl hystersis_tool_runtime::Tool for NoTerminalStub {
        type Args = serde_json::Value;
        type Output = String;
        fn id(&self) -> hystersis_tool_protocol::ToolId {
            hystersis_tool_protocol::ToolId::new("no_terminal_stub").expect("valid")
        }
        fn description(
            &self,
            _ctx: &::hystersis_tool_runtime::ListToolsContext,
        ) -> hystersis_tool_types::ToolDescription {
            hystersis_tool_types::ToolDescription::new("no_terminal_stub", "no-terminal stub")
        }
        async fn run(
            &self,
            _ctx: hystersis_tool_runtime::ToolCallContext,
    ...
    async fn non_pi_finalized_contract_snapshot_is_unchanged() {
        ...
        let toolset = ToolRegistryBuilder::new()
            .finalize(
                ToolServerConfig {
                    tools: vec![
                        ToolConfig::for_tool::<hystersis_build::TodoWriteTool>(),
...
"##,
    ...
    async fn tool_definitions_builtins_only_hides_mcp_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<hystersis_build::ReadFileTool>(),
                ToolConfig::for_tool::<hystersis_build::GrepTool>(),
            ],
            behavior_preset: None,
        };
    ...
    fn task_tool_rejected_without_get_task_output_and_kill_task() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "HystersisBuild:task".to_string(),
                params: None,
                name_override: None,
                params_name_overrides: None,
                description_override: None,
        ...
        assert!(
            errors.iter().any(|e| e.tool == "HystersisBuild:task"
                && e.message.contains("HystersisBuild:get_task_output")
                && e.message.contains("HystersisBuild:kill_task")),
    ...
    fn task_tool_rejected_with_only_get_task_output() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "HystersisBuild:get_task_output".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        assert!(
            errors
                .iter()
                .any(|e| e.tool == "HystersisBuild:task" && e.message.contains("HystersisBuild:kill_task")),
    ...
    fn task_tool_rejected_with_only_kill_task() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "HystersisBuild:kill_task".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        assert!(
            errors
                .iter()
                .any(|e| e.tool == "HystersisBuild:task"
                    && e.message.contains("HystersisBuild:get_task_output")),
    ...
    /// hystersis agent config (all tools present) and that the new examples
    ...
    async fn background_param_templates_reference_real_schema_keys() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                tool("HystersisBuild:run_terminal_cmd"),
                tool("HystersisBuild:task"),
                tool("HystersisBuild:get_task_output"),
                tool("HystersisBuild:wait_tasks"),
                tool("HystersisBuild:kill_task"),
            ],
            behavior_preset: None,
        };
        let tmp = TempDir::new().unwrap();
    ...
    fn bash_with_enabled_background_reports_missing_task_tools() {
        ...
        assert!(error.message.contains("HystersisBuild:get_task_output"));
        assert!(error.message.contains("HystersisBuild:kill_task"));
        assert!(
            error
                .expected
                .as_deref()
    ...
    fn task_requirement_error_lists_missing_background_tools() {
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "HystersisBuild:task");
        assert!(error.message.contains("HystersisBuild:get_task_output"));
        assert!(error.message.contains("HystersisBuild:kill_task"));
    ...
    fn search_replace_requirement_error_mentions_read_tool() {
        ...
        let error = errors
            .iter()
            .find(|error| error.tool == "HystersisBuild:search_replace")
    ...
    fn ask_user_question_validates_standalone() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "HystersisBuild:ask_user_question".to_string(),
                params: None,
                name_override: None,
                params_name_overrides: None,
                description_override: None,
    ...
    async fn task_description_renders_with_default_agent_config() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "HystersisBuild:grep".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "HystersisBuild:web_search".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        let toolset = builder
            .finalize(config, ctx)
            .expect("finalize should succeed with default hystersis tools");
        let defs = toolset.tool_definitions();
        let task_def = defs
            .iter()
    ...
    fn hashline_tools_registered_in_builder() {
        ...
        assert!(
            builder
                .tools
                .contains_key("HystersisBuildHashline:hashline_read"),
            "hashline_read should be registered"
        );
        assert!(
            builder
                .tools
                .contains_key("HystersisBuildHashline:hashline_edit"),
            "hashline_edit should be registered"
        );
        assert!(
            builder
                .tools
                .contains_key("HystersisBuildHashline:hashline_grep"),
    ...
    async fn hashline_config_finalizes_successfully() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("HystersisBuildHashline:hashline_read"),
                hashline_tool_config("HystersisBuildHashline:hashline_edit"),
                hashline_tool_config("HystersisBuildHashline:hashline_grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn standard_and_hashline_each_finalize_independently() {
        ...
        let standard_config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("HystersisBuild:read_file"),
                hashline_tool_config("HystersisBuild:search_replace"),
                hashline_tool_config("HystersisBuild:grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn empty_struct_schema_has_properties_and_required() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<hystersis_build::EnterPlanModeTool>(),
                ToolConfig::for_tool::<hystersis_build::ExitPlanModeTool>(),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn hashline_toolset_e2e_with_utilities() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "HystersisBuildHashline:hashline_read".to_owned(),
                    params: Some(
                ...
                ToolConfig::for_tool::<hystersis_build_hashline::HashlineEditTool>(),
                ToolConfig::for_tool::<hystersis_build_hashline::HashlineGrepTool>(),
                ToolConfig::for_tool::<hystersis_build::ListDirTool>(),
            ],
            behavior_preset: None,
        };
        let errors = builder.validate_config(&config);
    ...
    fn bash_config_with_background() -> ToolConfig {
        ToolConfig {
            id: "HystersisBuild:run_terminal_cmd".to_owned(),
            params: Some(
                serde_json::json!({ "enabled_background": true })
                    .as_object()
                    .unwrap()
    ...
    async fn hystersis_build_bridge(tmp: &TempDir) -> crate::bridge::ToolBridge {
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<hystersis_build::ListDirTool>(),
                ToolConfig::for_tool::<hystersis_build::ReadFileTool>(),
                ToolConfig::for_tool::<hystersis_build::SearchReplaceTool>(),
    ...
    async fn hub_dispatch_list_dir() {
        ...
        let bridge = hystersis_build_bridge(&tmp).await;
        let result = bridge
            .call(
                "list_dir",
    ...
    async fn hub_dispatch_parity_list_dir() {
        ...
        let hub_bridge = hystersis_build_bridge(&tmp).await;
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<hystersis_build::ListDirTool>()],
            behavior_preset: None,
        };
    ...
    fn generate_schema_strips_root_title_and_description() {
        let schema = generate_schema::<crate::implementations::hystersis_build::bash::BashToolInput>();
        assert!(
    ...
    fn toolset_with_viewer_ctx(
        viewer_ctx: Option<hystersis_tool_runtime::WorkspaceViewerContext>,
    ...
    async fn prepare_dispatch_stamps_workspace_viewer_ctx_when_present() {
        let (toolset, _tmp) =
            toolset_with_viewer_ctx(Some(hystersis_tool_runtime::WorkspaceViewerContext {
        ...
        let wvc = parts
            .ctx
            .extensions
            .get::<hystersis_tool_runtime::WorkspaceViewerContext>()
    ...
    async fn bash_streaming_progress_emitted_via_finalized_toolset_when_gate_on() {
        ...
        let toolset = Arc::new(
            builder
                .finalize_with_trunc_config(
                    ...
                    ctx,
                    crate::types::context::TruncationConfig::default(),
                    Some(hystersis_tool_runtime::WorkspaceViewerContext {
                        stream_tool_progress: true,
                    }),
                )
                .expect("finalize"),
        ...
        while let Some(item) = stream.next().await {
            match item {
                hystersis_tool_runtime::ToolStreamItem::Progress(_) => progress_count += 1,
                hystersis_tool_runtime::ToolStreamItem::Terminal(r) => {
