...
//!
//! The crate-level suite in `xai-hystersis-browser-tools` covers the CDP layer;
...
//!
//! ```bash
//! cargo test -p xai-hystersis-tools --features browser --test browser_tab_chrome_e2e \
