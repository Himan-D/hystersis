...
/// Emit [`hystersis_telemetry::events::ShortcutUsed`] for an allowlisted binding.
///
...
pub fn log_shortcut_used(key: &KeyEvent, action_id: ActionId, context: &str) {
    ...
    hystersis_telemetry::session_ctx::log_event(hystersis_telemetry::events::ShortcutUsed {
