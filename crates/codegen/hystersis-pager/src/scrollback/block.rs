...
use hystersis_pager_diff::DiffHunk;
...
impl RenderBlock {
    ...
    pub fn context_info(
        snapshot: hystersis_shell::session::ContextInfo,
    ...
    pub fn with_hyperlinks<R>(
        &self,
        f: impl FnOnce(&[hystersis_markdown::HyperlinkTarget]) -> R,
    ) -> R {
        match self {
...
mod searchable_text_tests {
    ...
    use hystersis_shell::session::ContextInfo;
