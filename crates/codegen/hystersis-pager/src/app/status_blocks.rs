...
fn format_cost(m: &hystersis_shell::extensions::notification::PromptUsageModel) -> String {
    use hystersis_shell::extensions::notification::ticks_to_usd;
...
mod tests {
    use super::*;
    use hystersis_shell::extensions::notification::{PromptUsage, PromptUsageModel};
