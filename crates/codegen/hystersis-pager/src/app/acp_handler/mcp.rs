...
pub(super) fn push_server_status_enabled() -> bool {
    ...
    *ENABLED.get_or_init(|| {
        hystersis_shell::util::config::resolve_mcp_push_server_status(
...
///    [`hystersis_shell::extensions::mcp::McpToolsChanged`] struct), and
...
/// ([`hystersis_shell::extensions::mcp::McpServerStatusPayload`] +
/// [`hystersis_shell::extensions::mcp::McpServerStatus`]) instead of
...
pub(super) fn handle_mcp_server_status(notif: &acp::ExtNotification, app: &mut AppView) -> bool {
    ...
    use hystersis_shell::extensions::mcp::{McpServerStatus, McpServerStatusPayload, McpToolEntry};
...
pub(super) fn handle_mcp_elicit_complete(notif: &acp::ExtNotification, app: &mut AppView) -> bool {
    let Ok(payload) = serde_json::from_str::<
        hystersis_tools::mcp_elicitation::McpElicitCompletePayload,
