...
pub(crate) fn is_server_initiated_prompt(prompt_id: &str) -> bool {
    hystersis_shell::session::PromptOrigin::from_prompt_id(prompt_id).is_synthetic()
}
...
pub(crate) fn is_scheduler_fired_prompt(prompt_id: &str) -> bool {
    matches!(
        hystersis_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        hystersis_shell::session::PromptOrigin::SchedulerFired
    )
}
...
pub(crate) fn is_wake_prompt(prompt_id: &str) -> bool {
    matches!(
        hystersis_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        hystersis_shell::session::PromptOrigin::TaskCompleted { .. }
            | hystersis_shell::session::PromptOrigin::SubagentCompleted { .. }
            | hystersis_shell::session::PromptOrigin::WorkflowCompleted { .. }
            | hystersis_shell::session::PromptOrigin::NotificationDrain
    )
}
