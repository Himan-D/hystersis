#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    fn exec_vehicle_permission_enqueues_a_persisting_default_scope() {
        ...
        assert!(
            hystersis_workspace::permission::always_allow_scope_persists(
    ...
    fn ask_user_question_routes_to_background_session_not_active_view() {
        ...
        .unwrap();
        let msg = AcpClientMessage::ExtMethod(hystersis_acp_lib::AcpArgs {
    ...
    fn mcp_elicit_opens_elicitation_view_and_parks_response() {
        ...
        .unwrap();
        let msg = AcpClientMessage::ExtMethod(hystersis_acp_lib::AcpArgs {
            request: acp::ExtRequest::new("hystersis.com/mcp/elicit", raw.into()),
            response_tx: tx,
        });
    ...
    fn mcp_elicit_does_not_replace_url_waiting() {
        ...
        .unwrap();
        handle(
            AcpClientMessage::ExtMethod(hystersis_acp_lib::AcpArgs {
                request: acp::ExtRequest::new("hystersis.com/mcp/elicit", raw1.into()),
                response_tx: tx1,
            }),
            &mut app,
        );
        {
            ...
            assert!(ev.send_response(
                hystersis_tools::mcp_elicitation::McpElicitExtResponse::Accept { content: None },
            ));
        ...
        handle(
            AcpClientMessage::ExtMethod(hystersis_acp_lib::AcpArgs {
                request: acp::ExtRequest::new("hystersis.com/mcp/elicit", raw2.into()),
                response_tx: tx2,
            }),
            &mut app,
        );
        ...
        let changed = handle(
            AcpClientMessage::ExtNotification(hystersis_acp_lib::AcpArgs {
                request: acp::ExtNotification::new(
                    "hystersis.com/mcp/elicit_complete",
    ...
    fn close_viewer_preserves_plan_approval_state() {
        ...
        handle(
            AcpClientMessage::ExtMethod(hystersis_acp_lib::AcpArgs {
                request: acp::ExtRequest::new("hystersis.com/exit_plan_mode", raw.into()),
                response_tx: tx,
            }),
            &mut app,
        );
    ...
    fn notify_status(app: &mut crate::app::app_view::AppView, cwd: &str) -> bool {
        ...
        let ext = acp::ExtNotification::new("hystersis.com/session_notification", std::sync::Arc::from(raw));
    ...
    fn a_status_snapshot_repaints_a_row_that_had_already_settled() {
        ...
        app.current_ui.status_line =
            hystersis_status_line::test_support::StatusLineConfigFixture::from_kind(
                hystersis_status_line::StatusLineType::Builtin,
            )
            .with_items(vec![hystersis_status_line::StatusLineItem::Cwd])
            .into_config();
