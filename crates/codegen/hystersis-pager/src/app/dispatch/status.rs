...
fn log_coding_data_consent_selected(
    source: hystersis_telemetry::events::CodingDataConsentSource,
    opted_in: bool,
    previous_opted_in: bool,
) {
    use hystersis_telemetry::events::{CodingDataConsentChoice, CodingDataConsentSelected};
    hystersis_telemetry::session_ctx::log_event(CodingDataConsentSelected {
        source,
...
pub(in crate::app::dispatch) fn dispatch_privacy_banner_opt_in(app: &mut AppView) -> Vec<Effect> {
    ...
    set_coding_data_sharing(
        app,
        true,
        hystersis_telemetry::events::CodingDataConsentSource::PrivacyBanner,
    )
}
