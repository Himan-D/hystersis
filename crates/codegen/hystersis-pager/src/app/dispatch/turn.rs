...
use hystersis_telemetry::events::CancellationScope;
...
fn effective_cancel_subagents_preference(
    ...
    ui: &hystersis_shell::agent::config::UiConfig,
) -> Option<bool> {
...
pub(super) fn dispatch_kill_bg_task(app: &mut AppView, task_id: String) -> Vec<Effect> {
    ...
    vec![Effect::KillBgTask {
        session_id,
        task_id,
        source: hystersis_shell::extensions::task::TaskKillSource::ClientUi,
    }]
}
