...
fn plugins_list_response() -> hystersis_hooks_plugins_types::PluginsListResponse {
    use crate::views::extensions_modal::test_plugin_info;
    hystersis_hooks_plugins_types::PluginsListResponse {
        plugins: vec![
            test_plugin_info(
                "user-tool",
                Some(hystersis_hooks_plugins_types::PluginOrigin::UserHystersis),
            ),
            test_plugin_info(
                "claude-tool",
                Some(hystersis_hooks_plugins_types::PluginOrigin::UserClaude),
            ),
        ],
    }
}
