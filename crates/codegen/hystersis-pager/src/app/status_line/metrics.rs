...
use hystersis_status_line::{ResolvedStatusLine, StatusLineConfig, StatusLineItem, StatusLineType};
...
impl StatusLineMetrics {
    ...
    pub(crate) fn report_config(&self, cfg: &StatusLineConfig) {
        ...
        hystersis_telemetry::session_ctx::log_event(
            hystersis_telemetry::events::StatusLineConfigured {
                kind,
    ...
    fn health_event(&self) -> Option<hystersis_telemetry::events::StatusLineHealth> {
        ...
        Some(hystersis_telemetry::events::StatusLineHealth {
            kind,
