...
pub(super) mod paste_key_tests {
    ...
    -> crate::views::question_view::QuestionViewState {
        let question = hystersis_tools::implementations::hystersis_build::ask_user_question::Question {
            question: "Pick one?".to_string(),
            options: vec![
                hystersis_tools::implementations::hystersis_build::ask_user_question::QuestionOption {
                    label: "A".to_string(),
