...
use hystersis_config::managed_text::{
...
pub enum FixError {
    ...
    Managed(hystersis_config::managed_text::ManagedConfigError),
    TmuxManaged(hystersis_config::managed_text::ManagedConfigError),
    PostconditionFailed,
...
impl From<hystersis_config::managed_text::ManagedConfigError> for FixError {
    fn from(error: hystersis_config::managed_text::ManagedConfigError) -> Self {
        Self::Managed(error)
    }
}
