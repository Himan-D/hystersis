...
use super::registry::{
    DynamicEnumSource, EnumChoice, SettingCategory, SettingKind, SettingMeta, StringValidator, SettingOwner,
};
...
use hystersis_shell::util::config::DISPLAY_REFRESH_DEFAULT_AUTO_CADENCE_ENABLED;
...
const THEME_CHOICES: &[EnumChoice] = &[
    ...
    EnumChoice {
        canonical: "hystersisnight",
        display: "Hystersis Night",
        description: "Neutral dark with magenta accent.",
    },
    EnumChoice {
        canonical: "hystersisday",
        display: "Hystersis Day",
...
const SCREEN_MODE_CHOICES: &[EnumChoice] = &[
    EnumChoice {
        ...
        display: "Fullscreen",
        description: "Open plain hystersis in the standard fullscreen TUI. Default when unset.",
    },
    EnumChoice {
        canonical: "minimal",
        display: "Minimal",
        description: "Open plain hystersis in scrollback-native (minimal) mode.",
    },
];
...
//
// Concrete codes must match `hystersis_voice::STT_LANGUAGES` (official Hystersis STT
// catalog — https://docs.hystersis.com/developers/model-capabilities/audio/speech-to-text).
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        SettingMeta {
            ...
            description: "The base URL for local Ollama instances (e.g. http://localhost:11434).",
            keywords: &["ollama", "local", "offline", "api", "url"],
            restart_required: false,
            hidden_in_minimal: false,
            owner: SettingOwner::Shell,
            kind: SettingKind::String { default: "", validator: StringValidator::Any },
        },
        SettingMeta {
            key: "lm_studio_api_base",
            category: SettingCategory::Models,
            label: "LM Studio API Base",
            description: "The base URL for local LM Studio instances (e.g. http://localhost:1234/v1).",
            keywords: &["lm studio", "local", "offline", "api", "url"],
            restart_required: false,
            hidden_in_minimal: false,
            owner: SettingOwner::Shell,
            kind: SettingKind::String { default: "", validator: StringValidator::Any },
        ...
        SettingMeta {
            ...
            description: "How plain hystersis opens next time: Fullscreen (default when unset) or \
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` resolved to "hystersisnight".
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "hystersisnight".
                default: "hystersisnight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "hystersisday".
                default: "hystersisday",
                choices: CONCRETE_THEME_CHOICES,
                supports_preview: true,
            },
            restart_required: false,
        ...
        SettingMeta {
            ...
            kind: SettingKind::Bool {
                ...
                default: hystersis_shell::util::config::DEFAULT_REMEMBER_TOOL_APPROVALS,
            },
            restart_required: true,
            hidden_in_minimal: false,
        },
        ...
        SettingMeta {
            ...
            keywords: &["openai", "api", "key", "token", "configure"],
            kind: SettingKind::String { default: "", validator: StringValidator::Any },
            restart_required: false,
            hidden_in_minimal: false,
        },
        SettingMeta {
            ...
            keywords: &["anthropic", "api", "key", "token", "configure"],
            kind: SettingKind::String { default: "", validator: StringValidator::Any },
            restart_required: false,
            hidden_in_minimal: false,
        },
        SettingMeta {
            ...
            keywords: &["openrouter", "api", "key", "token", "configure"],
            kind: SettingKind::String { default: "", validator: StringValidator::Any },
            restart_required: false,
            hidden_in_minimal: false,
        },
        SettingMeta {
            key: "trinetra_api_key",
            category: SettingCategory::Models,
            owner: SettingOwner::Shell,
            label: "Trinetra Gateway API Key",
            description: "API Key for Trinetra (Hystersis Gateway) provider. Login via Trinetra to use gateway routing.",
            keywords: &["trinetra", "gateway", "hystersis", "api", "key", "login"],
            kind: SettingKind::String { default: "", validator: StringValidator::Any },
            restart_required: false,
            hidden_in_minimal: false,
        },
        ...
        SettingMeta {
            ...
            keywords: &["model", "default", "agent", "llm", "hystersis", "switch"],
        ...
        // The `HYSTERSIS_PROMPT_SUGGESTIONS` env var overrides at runtime.
        SettingMeta {
        ...
        // follows the process locale when it maps to a Hystersis STT language.
        // Catalog = official STT languages (see hystersis_voice::STT_LANGUAGES).
        SettingMeta {
            key: "voice_stt_language",
            category: SettingCategory::Editor,
            owner: SettingOwner::Shell,
            label: "Voice language",
            description: "Speech-to-text language for voice dictation (Hystersis STT). \
        ...
        SettingMeta {
            ...
            owner: SettingOwner::Shell,
            label: "SSH wrap",
            description: "Show a `/doctor` tip when an SSH session is not using `hystersis wrap`.",
            keywords: &[
                "ssh",
                "wrap",
                "remote",
