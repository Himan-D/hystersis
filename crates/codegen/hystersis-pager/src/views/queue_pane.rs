...
pub enum QueueRowOrigin {
    ...
    /// while running). Edits route to the agent as `hystersis.com/queue/*`.
    Server,
}
...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. HystersisNight's dark band leaking into HystersisDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default HystersisNight, dark) after the user switches —
        // painting a dark band on a light HystersisDay canvas.
...
mod tests {
    ...
    fn yank_selected_multiline_copies_full_text() {
        ...
        use hystersis_ratatui_textarea::ClipboardProvider;
