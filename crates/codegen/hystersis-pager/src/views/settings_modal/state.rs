...
pub(super) fn action_for_string(
    ...
    match key {
        ...
        "openai_api_key" => Some(Action::SetOpenAIApiKey(value)),
        "anthropic_api_key" => Some(Action::SetAnthropicApiKey(value)),

        "ollama_api_base" => Some(Action::SetOllamaApiBase(value)),
        "lm_studio_api_base" => Some(Action::SetLmStudioApiBase(value)),
        "openrouter_api_key" => Some(Action::SetOpenRouterApiKey(value)),
        "trinetra_api_key" => Some(Action::SetTrinetraApiKey(value)),
...
/// Hystersis STT language list (25 codes + client-only `auto` = 26) with headroom.
