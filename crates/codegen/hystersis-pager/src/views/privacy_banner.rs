...
const PRIVACY_BANNER_TITLE: &str = "Help improve Hystersis";
...
pub(crate) const PRIVACY_BANNER_TERMS_URL: &str = "https://hystersis.com/legal/terms-of-service";
pub(crate) const PRIVACY_BANNER_POLICY_URL: &str = "https://hystersis.com/legal/privacy-policy";
