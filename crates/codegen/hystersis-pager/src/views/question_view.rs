...
use hystersis_acp_lib::AcpResult;
use hystersis_markdown::StreamingMarkdownRenderer;
pub use hystersis_tools::implementations::hystersis_build::ask_user_question::{
...
pub enum LocalQuestionKind {
    ...
    CreditLimitUpsell {
        choices: Vec<hystersis_telemetry::events::CreditLimitChoice>,
    },
    ...
    FreeUsageUpsell {
        ...
        source: hystersis_telemetry::events::HystersisProUpsell,
    },
    ...
    AgentTypeMismatch {
        ...
        effort: Option<hystersis_shell::sampling::types::ReasoningEffort>,
    },
    DoctorFix {
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> hystersis_tools::implementations::hystersis_build::ask_user_question::AskUserQuestionExtResponse
    {
    ...
    pub fn send_ext_response(
        &mut self,
        response: hystersis_tools::implementations::hystersis_build::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
