#
# Grok CLI installer (enterprise channel) for PowerShell — https://hystersis.com/cli/enterprise-install.ps1
#
...
#
# Usage:
#   irm https://hystersis.com/cli/enterprise-install.ps1 | iex                                       # latest enterprise
#   & ([scriptblock]::Create((irm https://hystersis.com/cli/enterprise-install.ps1))) -Version 0.1.42 # specific version
#   $env:GROK_VERSION="0.1.42"; irm https://hystersis.com/cli/enterprise-install.ps1 | iex           # specific version (alt)
#   $env:GROK_DEPLOYMENT_KEY="<key>"; irm https://hystersis.com/cli/enterprise-install.ps1 | iex
#
...
if ($PSVersionTable.Platform -and $PSVersionTable.Platform -ne 'Win32NT') {
    Write-Error "This installer is for Windows. On macOS/Linux, use: curl -fsSL https://hystersis.com/cli/enterprise-install.sh | bash"
    exit 1
}
...
$OidcScope = 'https://auth.hystersis.com::b1a00492-073a-47ea-816f-4c329264a828'
$LegacyScope = 'https://accounts.hystersis.com/sign-in'
$AuthSource = ''
...
$BaseUrlPrimary = 'https://hystersis.com/cli'
...
# Pick a working BaseUrl: try Cloudflare-fronted hystersis.com first, fall back to
...
if ($env:GROK_DEPLOYMENT_KEY) {
    $ProxyUrl = if ($env:GROK_PROXY_URL) { $env:GROK_PROXY_URL } else { 'https://cli-chat-proxy.hystersis.com/v1' }
