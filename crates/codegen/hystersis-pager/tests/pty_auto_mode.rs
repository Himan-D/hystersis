...
use hystersis_pager_pty_harness::{PtyHarness, pager_binary};
use hystersis_test_support::TestSandbox;
...
fn prepare_sandbox(sandbox: &mut TestSandbox, gate_on: bool) -> Vec<(String, String)> {
    ...
    // layer below requirements; "1"/"0" parse to on/off (hystersis_config::
