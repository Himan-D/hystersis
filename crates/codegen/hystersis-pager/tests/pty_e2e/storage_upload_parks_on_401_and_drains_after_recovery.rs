...
async fn storage_upload_parks_on_401_and_drains_after_recovery() {
    ...
    // Trace uploads are gated on first-party xAI OAuth (`is_hystersis_auth()`:
    ...
    let overrides = [
        ...
        EnvOp::set("HYSTERSIS_TRACE_UPLOAD", "true"),
        EnvOp::set("HYSTERSIS_TELEMETRY_TRACE_UPLOAD", "true"),
        EnvOp::set("HYSTERSIS_UPLOAD_QUEUE_AUTH_PROBE_SECS", "2"),
    ];
    ...
    //   not fire inside this 3s window; with `HYSTERSIS_UPLOAD_QUEUE_AUTH_PROBE_SECS=2`
