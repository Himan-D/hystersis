...
Hystersis knows its own capabilities and can configure itself. Try:
...
## Teach Hystersis your project: AGENTS.md

Drop an `AGENTS.md` file in your repo root with build commands, conventions,
and gotchas. Hystersis reads it automatically in every session — it's the single
...
## Teach Hystersis your facts: memory
