...
use std::sync::Arc;
use xai_hystersis_tools::bridge::ToolBridge;
use xai_hystersis_tools::computer::types::{AsyncFileSystem, TerminalBackend};
use xai_hystersis_tools::notification::ToolNotificationHandle;
use xai_hystersis_tools::registry::types::SessionContext;
use xai_hystersis_tools::types::tool::ToolKind;
...
fn claude_tool_kind(name: &str) -> Option<ToolKind> {
    xai_hystersis_tools::types::kind_for(name)
}
...
pub struct AgentBuilder {
    ...
    parent_scheduler_handle:
        Option<xai_hystersis_tools::implementations::hystersis_build::scheduler::types::SchedulerHandle>,
    ...
    memory_backend: Option<Arc<dyn xai_hystersis_tools::types::memory_backend::MemoryBackend>>,
    web_search_config: xai_hystersis_tools::implementations::web_search::WebSearchConfig,
    ...
    backend_search: bool,
    web_fetch_config: xai_hystersis_tools::implementations::hystersis_build::web_fetch::WebFetchConfig,
    lsp: Option<std::sync::Arc<dyn xai_hystersis_tools::implementations::lsp::LspBackend>>,
    image_gen_config: xai_hystersis_tools::implementations::hystersis_build::image_gen::ImageGenConfig,
    video_gen_config: xai_hystersis_tools::implementations::hystersis_build::video_gen::VideoGenConfig,
    ...
    compat: xai_hystersis_tools::types::compat::CompatConfig,
    ...
    api_key_provider: Option<xai_hystersis_tools::types::SharedApiKeyProvider>,
    attribution_callback: Option<xai_hystersis_tools::SharedAttributionCallback>,
    ...
    preloaded_skills: Option<Vec<xai_hystersis_tools::implementations::skills::types::SkillInfo>>,
}
/// Ensure plan mode tools (`enter_plan_mode`, `exit_plan_mode`,
/// `ask_user_question`) are present in the tool config.
fn ensure_plan_mode_tools(tool_config: &mut xai_hystersis_tools::registry::types::ToolServerConfig) {
...
fn merge_tool_params(
    tool_config: &mut xai_hystersis_tools::registry::types::ToolServerConfig,
    ids: &[&str],
...
impl AgentBuilder {
    pub fn new(
        ...
        Self {
            ...
            terminal_backend,
            fs_backend: Arc::new(xai_hystersis_tools::computer::local::LocalFs),
            notification_handle,
    ...
    pub fn with_preloaded_skills(
        mut self,
        skills: Vec<xai_hystersis_tools::implementations::skills::types::SkillInfo>,
    ) -> Self {
    ...
    pub fn with_memory_backend(
        mut self,
        backend: Arc<dyn xai_hystersis_tools::types::memory_backend::MemoryBackend>,
    ) -> Self {
    ...
    pub fn with_parent_scheduler_handle(
        mut self,
        handle: xai_hystersis_tools::implementations::hystersis_build::scheduler::types::SchedulerHandle,
    ) -> Self {
    ...
    pub fn with_web_search_config(
        mut self,
        config: xai_hystersis_tools::implementations::web_search::WebSearchConfig,
    ) -> Self {
    ...
    pub fn with_web_fetch_config(
        mut self,
        config: xai_hystersis_tools::implementations::hystersis_build::web_fetch::WebFetchConfig,
    ) -> Self {
    ...
    pub fn with_lsp(
        mut self,
        handle: std::sync::Arc<dyn xai_hystersis_tools::implementations::lsp::LspBackend>,
    ) -> Self {
    ...
    pub fn with_image_gen_config(
        mut self,
        config: xai_hystersis_tools::implementations::hystersis_build::image_gen::ImageGenConfig,
    ) -> Self {
    ...
    pub fn with_video_gen_config(
        mut self,
        config: xai_hystersis_tools::implementations::hystersis_build::video_gen::VideoGenConfig,
    ) -> Self {
    ...
    pub fn with_app_builder_deployer_config(
        mut self,
        config: xai_hystersis_tools::implementations::hystersis_build::app_builder::AppBuilderDeployerConfig,
    ) -> Self {
    ...
    pub fn with_api_key_provider(
        mut self,
        provider: xai_hystersis_tools::types::SharedApiKeyProvider,
    ) -> Self {
    ...
    /// `xai_hystersis_sampler::SamplerConfig::attribution_callback` so
    /// all 401s share the same `AuthManager` reference and land in
    /// the same Axiom dataset.
    pub fn with_attribution_callback(
        mut self,
        callback: xai_hystersis_tools::SharedAttributionCallback,
    ) -> Self {
    ...
    pub async fn build(mut self) -> Result<Agent, AgentBuildError> {
        ...
        if definition.inject_default_tools {
            ...
            if self.lsp.is_some() {
                tool_config
                    .tools
                    .push((&xai_hystersis_tools::implementations::hystersis_build::LspTool).into());
            }
            if self.image_gen_config.image_gen_enabled() {
                tool_config
                    .tools
                    .push((&xai_hystersis_tools::implementations::hystersis_build::ImageGenTool).into());
            }
            if self.image_gen_config.image_edit_enabled() {
                tool_config
                    .tools
                    .push((&xai_hystersis_tools::implementations::hystersis_build::ImageEditTool).into());
            }
            if self.video_gen_config.is_enabled() {
                tool_config
                    .tools
                    .push((&xai_hystersis_tools::implementations::hystersis_build::ImageToVideoTool).into());
                tool_config.tools.push(
                    (&xai_hystersis_tools::implementations::hystersis_build::ReferenceToVideoTool).into(),
                );
            }
            ...
            if self.write_file_enabled && !has_write_tool {
                tool_config
                    .tools
                    .push((&xai_hystersis_tools::implementations::opencode::OpenCodeWriteTool).into());
            }
            ensure_plan_mode_tools(&mut tool_config);
        }
        if self.memory_backend.is_none() {
            let hystersis_build_ns = xai_hystersis_tools::types::tool::ToolNamespace::HystersisBuild.to_string();
            let mem_search_id = format!(
                "{hystersis_build_ns}:{}",
                xai_hystersis_tools::implementations::memory::MEMORY_SEARCH_TOOL_NAME
            );
            let mem_get_id = format!(
                "{hystersis_build_ns}:{}",
                xai_hystersis_tools::implementations::memory::MEMORY_GET_TOOL_NAME
            );
            tool_config
                .tools
        ...
        if self.prompt_audience == crate::prompt::context::PromptAudience::Subagent {
            tool_config
                .tools
                .retain(|tool| tool.kind != Some(xai_hystersis_tools::types::tool::ToolKind::AskUser));
        } else if !self.ask_user_question_enabled {
            let ask_user_id = format!(
                "{}:ask_user_question",
                xai_hystersis_tools::types::tool::ToolNamespace::HystersisBuild,
            );
        ...
        if task_stripped {
            use xai_hystersis_tools::types::tool::ToolNamespace;
        ...
        if let xai_hystersis_tools::implementations::hystersis_build::web_fetch::WebFetchConfig::Enabled {
            ref params,
        ...
        if self.prompt_audience == crate::prompt::context::PromptAudience::Subagent {
            tool_config.tools.retain(|tool| {
                !xai_hystersis_tools::implementations::hystersis_build::is_workflow_tool(tool.kind, &tool.id)
            });
        }
        ...
        if let Some(bytes) = self.mcp_max_output_bytes {
            tool_bridge.toolset().resources.lock().await.insert(
                xai_hystersis_tools::types::resources::TruncationCfg(
                    xai_hystersis_tools::types::context::TruncationConfig {
        ...
        if use_backend_search {
            if web_search_enabled && definition.hosted_tool_allowed("web_search") {
                hosted_tools.push(xai_hystersis_sampling_types::HostedTool::WebSearch { options: None });
            }
            if definition.hosted_tool_allowed("x_search") {
                hosted_tools.push(xai_hystersis_sampling_types::HostedTool::XSearch { options: None });
            }
            xai_hystersis_sampling_types::apply_tool_overrides(
                &mut hosted_tools,
...
fn resolve_shell_for_prompt() -> String {
    ...
    #[cfg(not(unix))]
    {
        xai_hystersis_config::shell::detect_windows_shell()
            .name()
            .to_string()
    }
}
...
mod tests {
    ...
    fn entry(name: &str, desc: &str, source: SubagentSource) -> SubagentEntry {
        SubagentEntry {
            ...
            config_source: xai_hystersis_tools::types::config_source::ConfigSource::Builtin,
        }
    }
    #[test]
    ...
    fn build_task_description_shadowed_builtin_uses_user_desc() {
        let subagents = vec![SubagentEntry {
            ...
            config_source: xai_hystersis_tools::types::config_source::ConfigSource::Project {
    ...
    fn task_model_guidance_resolves_model_param_override() {
        use xai_hystersis_tools::types::template_renderer::TemplateRenderer;
        use xai_hystersis_tools::types::tool::ToolKind;
    ...
    async fn discovery_snapshot_records_gated_and_preloaded_skills() {
        use xai_hystersis_tools::computer::local::LocalTerminalBackend;
        use xai_hystersis_tools::notification::ToolNotificationHandle;
    ...
    async fn custom_child_toolset_cannot_reintroduce_workflow() {
        use xai_hystersis_tools::implementations::hystersis_build::{ReadFileTool, WorkflowTool};
        ...
        definition.tool_config.tools = vec![
            (&ReadFileTool).into(),
            (&WorkflowTool).into(),
            xai_hystersis_tools::registry::types::ToolConfig::from_id("HystersisBuild:workflow"),
        ];
        let names =
    ...
    async fn plan_mode_injected_ask_user_question_receives_params() {
        use xai_hystersis_tools::computer::local::LocalTerminalBackend;
        use xai_hystersis_tools::implementations::hystersis_build::ask_user_question::AskUserQuestionParams;
        use xai_hystersis_tools::notification::ToolNotificationHandle;
        use xai_hystersis_tools::types::resources::Params;
    ...
    async fn spawning_blocked_disables_all_background_bash_modes() {
        use xai_hystersis_tools::computer::local::LocalTerminalBackend;
        use xai_hystersis_tools::implementations::hystersis_build::bash::BashParams;
        use xai_hystersis_tools::notification::ToolNotificationHandle;
        use xai_hystersis_tools::types::resources::Params;
        let mut definition = crate::config::AgentDefinition::default_hystersis_build();
    ...
    async fn requested_enabled_web_tools_survive_allowlist() {
        ...
        use xai_hystersis_tools::implementations::web_search::WebSearchConfig;
        use xai_hystersis_tools::notification::ToolNotificationHandle;
        let mut definition = crate::config::AgentDefinition::default_hystersis_build();
    ...
    async fn build_with_web_search(
        ...
        tool_overrides: Option<xai_hystersis_sampling_types::ToolOverrides>,
    ) -> crate::agent::Agent {
        use xai_hystersis_tools::computer::local::LocalTerminalBackend;
        use xai_hystersis_tools::implementations::web_search::WebSearchConfig;
        use xai_hystersis_tools::notification::ToolNotificationHandle;
    ...
    async fn disallowed_web_search_strips_function_and_hosted_tools() {
        ...
        assert!(
            !hosted
                .iter()
                .any(|t| matches!(t, xai_hystersis_sampling_types::HostedTool::WebSearch { .. })),
            "hosted WebSearch must be removed when web_search is disallowed, got: {hosted:?}"
        );
        assert!(
            hosted
                .iter()
                .any(|t| matches!(t, xai_hystersis_sampling_types::HostedTool::XSearch { .. })),
    ...
    async fn hosted_tools_bake_definition_tool_overrides_into_options() {
        let x_search = xai_hystersis_sampling_types::XSearchOptions {
            date_bound: Some(
                xai_hystersis_sampling_types::SearchDateBound::new(None, Some("2024-03-15".into()))
                    .unwrap(),
            ),
        };
        let agent = build_with_web_search(
            ...
            true,
            &[],
            Some(xai_hystersis_sampling_types::ToolOverrides {
        ...
        assert!(
            agent
                .hosted_tools()
                .contains(&xai_hystersis_sampling_types::HostedTool::XSearch {
