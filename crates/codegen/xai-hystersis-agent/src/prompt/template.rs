...
/// The base prompt template source, exposed for `hystersis prompt --section template`.
...
/// Apply-patch prompt template source, exposed for `hystersis prompt --section apply-patch-template`.
...
mod tests {
    ...
    /// Build a TemplateRenderer with the standard hystersis tool kinds.
