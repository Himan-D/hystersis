...
use hystersis_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub mod leader {
    ...
    use hystersis_test_support::leader::{LeaderFixture, LeaderStdioClient};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `hystersis_sampler::SamplingClient`, which takes a
