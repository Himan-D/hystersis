...
use hystersis_agent::plugins::SharedPluginRegistryHandle;
use hystersis_agent::plugins::discovery::DiscoveryConfig;
use hystersis_agent::plugins::git_install::{InstallSource, install_from_source};
...
fn trusted_local_refresh_surfaces_new_agent_via_discovery() {
    ...
    assert_eq!(
        plugin.scope,
        hystersis_agent::plugins::PluginScope::CliOverride
    );
