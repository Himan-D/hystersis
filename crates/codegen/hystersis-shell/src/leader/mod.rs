...
//!
//! ```ignore
//! use hystersis_shell::leader::{connect_or_spawn, ClientCapabilities, ClientMode};
//!
...
const CLIENT_LEADER_VERSION: &str = hystersis_version::VERSION;
                ...
                Ok(()) => {
                    ...
                    crate::unified_log::warn(
                        ...
                        Some(serde_json::json!({
                            ...
                            "reason": reason,
                            "killer_ver": hystersis_version::VERSION,
                        })),
                    );
                }
                Err(e) => {
...
pub async fn connect_or_spawn(
    ...
    if let Some(profile) = hystersis_sandbox::requested_confinement_profile() {
...
/// `hystersis_update::auto_update::resolve_restart_exe`.
///
...
fn spawn_leader_subprocess(env_urls: &LeaderEnvUrls) -> Result<u32, ConnectionError> {
    ...
    let leader_log = std::env::var("HYSTERSIS_LEADER_LOG")
        ...
        .unwrap_or_else(|_| "hystersis_shell=info,hystersis_acp_lib=warn,hystersis_mcp=warn".into());
