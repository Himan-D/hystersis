...
use clap::Parser;
use hystersis_shell::sampling::conversation::{ConversationItem, conversation_item_to_chat_message};
use hystersis_shell::sampling::types::{ChatRequestMessage, Role};
