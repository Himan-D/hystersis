...
pub use self::types::*;
pub use hystersis_sampler::ApiBackend;
pub use hystersis_sampler::SamplingClient as Client;
...
// `hystersis_sampler::*`. The shell-side `sampling::client::Config`
