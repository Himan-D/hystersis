...
use hystersis_sampler::SamplerConfig;
...
impl WebFetchToolConfig {
    ...
    pub(crate) fn resolve_params(
    ...
    ) -> hystersis_tools::implementations::hystersis_build::web_fetch::WebFetchParams {
        ...
        let allow_local = self
            .allow_local
            .or_else(|| hystersis_config::env_bool("HYSTERSIS_WEB_FETCH_ALLOW_LOCAL"));
...
/// from `hystersis_tools::registry::types::ToolsetConfig` which holds
...
mod tests {
    ...
    fn file_toolset_override_never_grants_edit_to_read_only_toolsets() {
        ...
        for mut def in [
            hystersis_agent::config::AgentDefinition::plan(),
            hystersis_agent::config::AgentDefinition::explore(),
        ] {
