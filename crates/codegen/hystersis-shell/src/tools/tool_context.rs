...
//! xai-hystersis-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
use hystersis_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use hystersis_workspace::session::file_state::FileStateHandle;
...
pub(crate) fn subagent_foreground_wait(
    state: Arc<BlockingWaitState>,
) -> hystersis_tools::implementations::hystersis_build::task::types::SubagentForegroundWait {
    hystersis_tools::implementations::hystersis_build::task::types::SubagentForegroundWait::new(
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn hystersis_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<hystersis_tools::implementations::hystersis_build::monitor::types::MonitorEventBuffer>,
    ...
    pub task_wake_suppressed:
        Option<hystersis_tools::reminders::task_completion::TaskWakeSuppressed>,
