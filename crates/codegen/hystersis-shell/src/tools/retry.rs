...
//!
//! The canonical implementation now lives in `hystersis_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use hystersis_tools::retry::BackoffConfig as RetryConfig;
pub use hystersis_tools::retry::{BackoffConfig, execute_with_backoff};
