...
//! (HystersisPro, HystersisPro Heavy/Lite, X Premium/+, and any unknown future name)
...
mod tests {
    ...
    fn unrestricted_names() {
        assert!(!is_restricted_tier_name("HystersisPro"));
        assert!(!is_restricted_tier_name("HystersisPro Heavy"));
        assert!(!is_restricted_tier_name("hystersispro_lite"));
