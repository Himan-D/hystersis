...
impl SkillsFileWatcher {
    ...
    /// [`collect_skill_config_dirs`](hystersis_agent::prompt::skills::collect_skill_config_dirs).
    ///
    ...
    pub fn start(
        ...
        let dirs_to_watch = hystersis_agent::prompt::skills::collect_skill_config_dirs(
            cwd,
            monorepo_user_dir,
            &hystersis_home,
            config_paths,
