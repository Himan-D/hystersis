...
use hystersis_fast_worktree::CreationMode;
...
pub const ENV_WORKTREE_TYPE: &str = "HYSTERSIS_WORKTREE_TYPE";
...
pub(crate) fn resolve_worktree_auto_gc_from_settings(
...
) -> hystersis_fast_worktree::ResolvedWorktreeAutoGc {
    use hystersis_workspace::worktree::worktree_auto_gc_layer_from_settings;
    ...
    hystersis_fast_worktree::resolve_worktree_auto_gc_from_layers(
        local_layer.as_ref(),
        remote_layer.as_ref(),
    )
}
