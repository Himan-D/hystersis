...
use hystersis_workspace::permission::resolution::McpServerAllowlist;
...
pub(crate) fn reenableable_disabled_stubs(
    ...
    let settings = hystersis_workspace::permission::resolution::managed_settings();
...
mod tests {
    ...
    use hystersis_workspace::permission::resolution::AllowedMcpServer;
    ...
    fn isolated_home() -> (
        tempfile::TempDir,
        hystersis_test_support::EnvGuard,
        hystersis_test_support::EnvGuard,
    ) {
        ...
        let home_guard = hystersis_test_support::EnvGuard::set("HOME", home.path());
        let hystersis_guard = hystersis_test_support::EnvGuard::set("HYSTERSIS_HOME", &hystersis_home);
