...
/// to work.
pub use hystersis_telemetry::enums::PermissionMode;
...
use hystersis_workspace::permission::resolution::yolo_disabled_by_policy;
...
mod tests {
    ...
    fn campaign_cannot_arm_permission_mode_gate() {
        ...
        layers.campaigns.managed = vec![hystersis_config::CampaignEntry {
            id: "c1".into(),
    ...
    // definition in `hystersis_workspace::permission::claude_compat`.

    #[test]
    fn resolve_launch_yolo_policy_pin_neutralizes_requested_bypass() {
        let warning = hystersis_workspace::permission::resolution::YOLO_PIN_REASON_REQUIREMENTS;
