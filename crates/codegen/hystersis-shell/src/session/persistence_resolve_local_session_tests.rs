...
// setting up the on-disk structures under a fake hystersis home.
...
fn exact_match_returns_original_id() {
    ...
    // (We can't call resolve_local_session directly because it uses hystersis_home(),
...
fn no_match_returns_none() {
    ...
    fs::create_dir_all(root.join(crate::util::hystersis_home::encode_cwd_dirname(cwd))).unwrap();
