...
use hystersis_session_search::{IndexableSession, SessionSource};

pub use hystersis_session_search::{
...
pub(crate) async fn evict_session(root_dir: &Path, session_id: &str) {
    hystersis_session_search::evict_session(root_dir, session_id).await;
}
...
pub async fn execute_search(
    ...
    hystersis_session_search::execute_search(index, root_dir, req).await
}
