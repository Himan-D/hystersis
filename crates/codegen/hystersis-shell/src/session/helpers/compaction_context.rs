...
//! shell-specific types (`hystersis_tools::MemoryBackend`, memory context).
//!
//! The core [`CompactionStateContext`] struct and its builder live in
//! `hystersis_chat_state::compaction_utils`. This module adds system-reminder
...
//! [`hystersis_compaction::reminder`] so hystersis-chat and hystersis stay in lockstep.
...
use hystersis_compaction::reminder::{
...
pub fn to_system_reminder_sync(
    ...
    skills: &[hystersis_tools::implementations::skills::types::SkillInfo],
...
pub async fn to_system_reminder(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[hystersis_tools::implementations::skills::types::SkillInfo],
    memory_backend: Option<&dyn hystersis_tools::types::memory_backend::MemoryBackend>,
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
    workflow_listing: Option<&str>,
) -> Option<String> {
...
fn to_system_reminder_inner(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[hystersis_tools::implementations::skills::types::SkillInfo],
    memory_results: &[hystersis_tools::types::memory_backend::MemorySearchResult],
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
    workflow_listing: Option<&str>,
) -> Option<String> {
    ...
    if let Some(listing) =
        hystersis_tools::types::skill_discovery_tracker::format_compaction_skill_listing(skills)
    {
    ...
    if !ctx.connected_mcp_servers.is_empty() {
        use hystersis_tools::implementations::search_tool::format_compaction_server_line;
...
- linear (12 tools)
    ...
    fn system_reminder_places_workflows_below_skills() {
        ...
        let skills = [hystersis_tools::implementations::skills::types::SkillInfo {
            name: "commit".into(),
