...
//! [`hystersis_agent::Agent`] for a given session.
//!
//! INVARIANT: This is the **only** place in the shell crate that calls
//! [`hystersis_agent::AgentBuilder::new`]. Both initial session spawn
...
//! ## Why this exists
//!
//! [`hystersis_agent::Agent`] owns an [`hystersis_tools::bridge::ToolBridge`]
...
//!
//! ## WHEN ADDING A NEW [`hystersis_agent::AgentBuilder`]`::with_*` KNOB
//!
...
use hystersis_agent::config::AgentDefinition;
use hystersis_agent::error::AgentBuildError;
use hystersis_agent::prompt::context::PromptAudience;
use hystersis_agent::prompt::skills::SkillsConfig;
use hystersis_agent::{Agent, AgentBuilder, CompactionPolicy, ReminderPolicy};
...
use hystersis_tools::implementations::hystersis_build::ask_user_question::types::UserQuestionRequest;
...
use hystersis_tools::implementations::hystersis_build::task::types::{SubagentEvent, TaskModelValidator};
...
pub(crate) struct AgentRebuildSpec {
    ...
    pub web_search_domains: Option<hystersis_sampling_types::WebSearchOptions>,
    ...
    pub attribution_callback: Option<hystersis_tools::SharedAttributionCallback>,
    ...
    pub managed_gateway_tool_client:
        Option<hystersis_tools::types::resources::ManagedGatewayToolClient>,
        ...
        agent
            ...
            .update_resources_with(|resources| {
                ...
                if let Some(event_tx) = subagent_event_tx.clone() {
                    use hystersis_tools::implementations::hystersis_build::task::backend::{
                ...
                resources
                    .insert(
                        hystersis_tools::types::resources::RespectGitignore(
                            *respect_gitignore,
                        ),
                    );
                resources
                    .insert(
                        hystersis_tools::types::resources::SchedulerBackgroundLoops(
                            *scheduler_background_loops,
                        ),
                    );
                resources
                    .insert(
                        hystersis_tools::types::resources::PathNotFoundHints(
                            *path_not_found_hints,
                        ),
                    );
                ...
                {
                    use hystersis_tools::implementations::hystersis_build::ask_user_question::UserQuestionSender;
...
pub(crate) fn test_rebuild_spec_default() -> Arc<AgentRebuildSpec> {
    ...
    Arc::new(AgentRebuildSpec {
        ...
        terminal_backend: Arc::new(
            hystersis_tools::computer::local::LocalTerminalBackend::new_local(
                hystersis_tools::computer::local::SearchShadowConfig::default(),
            ),
        ),
        ...
        subagent_depth: 0,
        subagents_max_depth: hystersis_tools::implementations::hystersis_build::task::MAX_SUBAGENT_DEPTH,
        ...
        system_prompt_label: hystersis_agent::DEFAULT_SYSTEM_PROMPT_LABEL.to_string(),
...
mod tests {
    ...
    fn task_description(agent: &Agent) -> String {
        ...
        let task_name = toolset
            .tool_name_for_kind(hystersis_tools::types::tool::ToolKind::Task)
    ...
    async fn config_web_search_domains_beat_agent_frontmatter() {
        use hystersis_sampling_types::{HostedTool, ToolOverrides, WebSearchOptions};
