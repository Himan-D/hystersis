...
impl crate::auth::refresh::TokenRefresher for WakeGapRefresher {
    async fn refresh(
        ...
        crate::auth::refresh::RefreshOutcome::success(HystersisAuth {
...
/// `hystersis.com/session_notification` payloads the client was sent.
...
async fn session_token_actor(
    ...
    let hystersis_updates = drain_gateway(gateway_rx);
