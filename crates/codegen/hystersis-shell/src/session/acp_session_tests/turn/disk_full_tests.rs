...
use hystersis_test_support::{MockInferenceServer, ScriptedResponse};
...
fn drain_gateway(mut rx: tokio::sync::mpsc::UnboundedReceiver<hystersis_acp_lib::AcpClientMessage>) {
...
fn capture_hook_events(
    mut rx: tokio::sync::mpsc::UnboundedReceiver<hystersis_acp_lib::AcpClientMessage>,
...
async fn actor_with_mock_sampler(
    ...
    let sampling_cfg = hystersis_sampler::SamplerConfig {
