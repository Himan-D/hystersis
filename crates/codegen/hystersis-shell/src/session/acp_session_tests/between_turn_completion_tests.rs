use hystersis_tools::implementations::hystersis_build::task::types::SubagentCompletionSummary;
use hystersis_tools::reminders::task_completion::format_between_turn_completions;
