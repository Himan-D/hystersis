...
use hystersis_tools::implementations::hystersis_build::image_gen::ImageGenTool;
use hystersis_tools::media_gen_limits::DEFAULT_MAX_PARALLEL_IMAGE_GEN;
    ...
    local
        .run_until(async {
            ...
            *actor.agent.borrow_mut() = test_agent_with_tools(vec![
            ...
            let calls: Vec<hystersis_sampling_types::ToolCall> = (0..over)
                .map(|i| hystersis_sampling_types::ToolCall {
            ...
            let spam: Vec<hystersis_sampling_types::ToolCall> = (0..DEFAULT_MAX_PARALLEL_IMAGE_GEN
                * 2)
                .map(|i| hystersis_sampling_types::ToolCall {
            ...
            let under: Vec<hystersis_sampling_types::ToolCall> = (0..DEFAULT_MAX_PARALLEL_IMAGE_GEN)
                .map(|i| hystersis_sampling_types::ToolCall {
