...
use hystersis_tty_utils::runtime::MAX_BLOCKING_THREADS;

/// Env marker dispatching the re-exec'd test binary into child logic.
const CHILD_ENV: &str = "HYSTERSIS_SHELL_RUNTIME_CONTAINMENT_CHILD";
const CHILD_ENV_LEGACY: &str = "XAI_HYSTERSIS_SHELL_RUNTIME_CONTAINMENT_CHILD";
const CHILD_ENV_LEGACY2: &str = "XAI_SHELL_RUNTIME_CONTAINMENT_CHILD";
const BLOCKING_POOL_CHILD_ENV: &str = "HYSTERSIS_SHELL_BLOCKING_POOL_CONTAINMENT_CHILD";
const BLOCKING_POOL_CHILD_ENV_LEGACY: &str = "XAI_HYSTERSIS_SHELL_BLOCKING_POOL_CONTAINMENT_CHILD";
const BLOCKING_POOL_CHILD_ENV_LEGACY2: &str = "XAI_SHELL_BLOCKING_POOL_CONTAINMENT_CHILD";
...
fn thread_count() -> Option<u64> {
    hystersis_tty_utils::sample_process_resources().threads
}
...
fn child_entry_capped_blocking_pool() {
    if std::env::var_os(BLOCKING_POOL_CHILD_ENV)
        .or_else(|| std::env::var_os(BLOCKING_POOL_CHILD_ENV_LEGACY))
        .or_else(|| std::env::var_os(BLOCKING_POOL_CHILD_ENV_LEGACY2))
        .is_some()
    {
