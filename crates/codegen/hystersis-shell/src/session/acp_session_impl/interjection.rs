...
pub(crate) use hystersis_interjection_core::{
...
pub(crate) type PendingInterjection = hystersis_interjection_core::PendingInterjection<acp::ImageContent>;
...
/// `hystersis.com/session/interjection` broadcast, so a live echo would duplicate it.
