...
pub(crate) enum SamplerFailureRecovery {
    ...
    RefreshAuthAndResubmit {
        credential: hystersis_sampling_types::SentCredential,
...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<hystersis_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(hystersis_tools::implementations::hystersis_build::update_goal::UpdateGoalInput),
    Channel(hystersis_tools::implementations::hystersis_build::update_goal::UpdateGoalEnvelope),
}
