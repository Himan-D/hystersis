...
impl DrainSource {
    ...
    pub(super) fn into_parts(
        ...
        hystersis_tools::implementations::hystersis_build::update_goal::UpdateGoalInput,
        Option<
            tokio::sync::oneshot::Sender<
                hystersis_tools::implementations::hystersis_build::update_goal::UpdateGoalAck,
            >,
        >,
    ) {
        match self {
...
pub(super) fn try_send_ack(
    ack_tx: Option<
        ...
        >,
    >,
    ack: hystersis_tools::implementations::hystersis_build::update_goal::UpdateGoalAck,
) {
...
pub(crate) fn goal_slash_and_harness_available(goal_enabled: bool, tool_names: &[String]) -> bool {
    use hystersis_tools::implementations::hystersis_build::UPDATE_GOAL_TOOL_NAME;
...
impl SessionActor {
    ...
    pub(super) async fn set_goal_loop_active_resource(&self, active: bool) {
        ...
        self.agent
            ...
            .tool_bridge()
            .update_resource(
                hystersis_tools::implementations::hystersis_build::task::types::GoalLoopActive(active),
            )
            .await;
    }
}
