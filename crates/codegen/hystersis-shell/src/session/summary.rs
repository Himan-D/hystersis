...
/// `_meta.hystersis.com/titleIsManual`. Old clients ignore the unknown key.
...
/// `_meta.hystersis.com/titleIsManual: false`.
...
mod tests {
    ...
    fn reset_returns_generator_to_idle() {
        ...
        let sampling_client =
            OaiCompatClient::new(hystersis_sampler::SamplerConfig::default()).unwrap();
