...
//! window containing a [`hystersis_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`hystersis_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`hystersis_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`hystersis_mcp::servers::ClientStateKind::Empty`]
...
use hystersis_mcp::servers::{McpClientEventKind, McpServerName};
...
pub(crate) trait RestartActions {
    ...
    /// Push an already-built `hystersis.com/mcp/server_status` payload to the
...
/// ACP `hystersis.com/mcp/server_status` notification. Failures are logged and
...
mod tests {
    ...
    fn forward_status_uses_dispatcher_method() {
        assert_eq!(
            ...
            "hystersis.com/mcp/server_status",
