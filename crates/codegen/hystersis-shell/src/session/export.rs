...
const XAI_SESSION_UPDATE_METHOD: &str = "_hystersis.com/session/update";
...
impl ExportedMessage {
    ...
    pub(crate) fn from_hystersis_notification(
        ...
        updates
            ...
            .map(|update| match update {
                ...
                SessionUpdate::Xai(notification) => {
                    ExportedMessage::from_hystersis_notification(notification)
                }
            })
            .collect()
    }
