...
async fn channel_spawner_request_is_harness_internal() {
    use hystersis_tools::implementations::hystersis_build::task::types::{SubagentEvent, SubagentResult};
...
fn verifier_template_renders_per_agent_type_and_falls_back() {
    use hystersis_tools::implementations::hystersis_build::task::types::SubagentTypeSummary;
    let mut tool_names = std::collections::HashMap::new();
    tool_names.insert(
        hystersis_tools::types::tool::ToolKind::Read,
        "cursor_read".to_string(),
    );
    tool_names.insert(
        hystersis_tools::types::tool::ToolKind::ListDir,
        "cursor_ls".to_string(),
    );
    tool_names.insert(
        hystersis_tools::types::tool::ToolKind::Search,
    ...
    let hystersis = RoleToolNames::from_summary(&summary_with(&[
        (hystersis_tools::types::tool::ToolKind::Read, "read_file"),
        (hystersis_tools::types::tool::ToolKind::ListDir, "list_dir"),
        (hystersis_tools::types::tool::ToolKind::Search, "grep"),
    ]))
...
fn cold_and_resume_renders_are_symmetric_for_an_index() {
    let summary = summary_with(&[
        (hystersis_tools::types::tool::ToolKind::Read, "cursor_read"),
        (hystersis_tools::types::tool::ToolKind::ListDir, "cursor_ls"),
        (hystersis_tools::types::tool::ToolKind::Search, "cursor_grep"),
    ]);
