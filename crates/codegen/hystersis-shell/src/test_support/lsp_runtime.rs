...
pub(crate) type GatewayOut = <acp::AgentSide as hystersis_acp_lib::AcpSide>::OutMessage;
...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        hunk_tracker_handle: hystersis_hunk_tracker::HunkTrackerHandle::noop(),
        hunk_tracking_enabled: false,
        fs: Arc::new(hystersis_workspace::file_system::LocalFs::new(
            PathBuf::from("/tmp"),
        )),
        ...
        auth_manager: Arc::new(crate::auth::AuthManager::new(
            std::path::Path::new("/tmp/nonexistent-hystersis-test"),
        ...
        parent_skills: None,
        parent_skills_config: hystersis_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: hystersis_tools::types::compat::CompatConfig::default(),
        task_completion_reservations: None,
        synthetic_trace_tx: None,
        task_output_tool_name: hystersis_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
