//! `hystersis.com/plugins/*` extension handlers.
//!
...
pub(crate) fn loaded_plugin_to_info(plugin: &hystersis_agent::plugins::LoadedPlugin) -> PluginInfo {
    use hystersis_agent::plugins::discovery::PluginScope as AgentScope;
...
fn origin_to_dto(origin: &hystersis_agent::plugins::PluginOrigin) -> PluginOrigin {
    use hystersis_agent::plugins::PluginOrigin as AgentOrigin;
    match origin {
        AgentOrigin::CliOverride => PluginOrigin::CliOverride,
        AgentOrigin::ProjectHystersis => PluginOrigin::ProjectHystersis,
        AgentOrigin::ProjectClaude => PluginOrigin::ProjectClaude,
        AgentOrigin::UserHystersis => PluginOrigin::UserHystersis,
...
pub async fn handle(agent: &MvpAgent, args: &acp::ExtRequest) -> ExtResult {
    match args.method.as_ref() {
        ...
        "hystersis.com/plugins/action" => {
            let req: hystersis_hooks_plugins_types::PluginsActionRequest = super::parse_params(args)?;
            let sid = acp::SessionId::new(req.session_id);
...
mod tests {
    use super::*;
    use hystersis_agent::plugins::PluginOrigin as AgentOrigin;
    use hystersis_agent::plugins::discovery::{PluginId, PluginScope as AgentScope};

    fn make_loaded_plugin(origin: AgentOrigin) -> hystersis_agent::plugins::LoadedPlugin {
        let root = std::path::PathBuf::from("/tmp/test-plugin");
        hystersis_agent::plugins::LoadedPlugin {
