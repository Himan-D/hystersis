//! `hystersis.com/rewind/*` extension handlers.
//!
...
pub async fn handle(agent: &MvpAgent, args: &acp::ExtRequest) -> ExtResult {
    ...
    match args.method.as_ref() {
        "hystersis.com/rewind/execute" => handle_execute(agent, args).await,
        "hystersis.com/rewind/points" => handle_points(agent, args).await,
