...
pub async fn handle(
    ...
    match args.method.as_ref() {
        ...
        // Queries
        // ───────────────────────────────────────────────────────────────
        "hystersis.com/hunk-tracker/get-hunks" => {
        ...
        "hystersis.com/hunk-tracker/get-files" => {
        ...
        "hystersis.com/hunk-tracker/get-all-file-contents" => {
            let req = parse_params::<GetFilesRequest>(args)?;
        ...
        "hystersis.com/hunk-tracker/get-summary" => {
        ...
        // Single Hunk Action
        // ───────────────────────────────────────────────────────────────
        "hystersis.com/hunk-tracker/hunk-action" => {
        ...
        // Bulk Actions
        // ───────────────────────────────────────────────────────────────
        "hystersis.com/hunk-tracker/file-action" => {
        ...
        "hystersis.com/hunk-tracker/turn-action" => {
        ...
        "hystersis.com/hunk-tracker/all-action" => {
