...
use hystersis_agent::prompt::skills::{
...
pub async fn handle(
    ...
    match args.method.as_ref() {
        "hystersis.com/skills/add" => {
            ...
            .await
            {
                hystersis_telemetry::session_ctx::log_event(
                    hystersis_telemetry::events::SkillAdded {
                        added_count: 0,
                        total_skills: 0,
                        success: false,
                    },
            ...
            hystersis_telemetry::session_ctx::log_event(hystersis_telemetry::events::SkillAdded {
        ...
        "hystersis.com/skills/remove" => {
            ...
            {
                hystersis_telemetry::session_ctx::log_event(
                    hystersis_telemetry::events::SkillRemoved { success: false },
                );
            ...
            hystersis_telemetry::session_ctx::log_event(hystersis_telemetry::events::SkillRemoved {
                success: true,
            });
