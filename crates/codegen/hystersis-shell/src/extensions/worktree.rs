//! Handler for hystersis.com/git/worktree/* extension methods.
...
const WORKTREE_EXT_LOG: &str = "hystersis_worktree";
...
impl WorktreeNotificationSender for GatewayWorktreeNotifier {
    async fn send_worktree_status(&self, progress: WorktreeStatus) {
        ...
        let notification = acp::ExtNotification::new("hystersis.com/git/worktree/status", params.into());
...
pub async fn handle(
    ...
    match args.method.as_ref() {
        "hystersis.com/git/worktree/create" => {
        ...
        "hystersis.com/git/worktree/remove" => {
        ...
        "hystersis.com/git/worktree/apply" => {
        ...
        "hystersis.com/git/worktree/create_from_worktree" => {
            let mut req =
            ...
            let result = ops
                .dispatch(
                    &hystersis_workspace::workspace_ops::PrepareWorktreeFromWorktreeReq {
                        inner: req.clone(),
                    },
                    None,
                )
        ...
        "hystersis.com/git/worktree/create_from_worktree_sync" => {
            ...
            let resolved_root = ops
                .dispatch(
                    &hystersis_workspace::workspace_ops::GitResolveRootReq {
            ...
            if let Some(git_root) = resolved_root {
                let vcs_kind = ops
                    .dispatch(
                        &hystersis_workspace::workspace_ops::DetectVcsKindReq {
                            path: git_root.clone(),
                        },
                        None,
                    )
                    .await
                    .unwrap_or(hystersis_workspace::session::git::VcsKind::Git);
                if vcs_kind.is_jj() {
            ...
            let result = ops
                .dispatch(
                    &hystersis_workspace::workspace_ops::CreateWorktreeFromWorktreeSyncReq {
                        inner: req.into_wire(),
                    },
                    None,
                )
        ...
        "hystersis.com/git/worktree/resume_session" => {
            ...
            let agent_id = hystersis_telemetry::id::agent_id();
        ...
        "hystersis.com/git/worktree/list" => {
            let req: hystersis_workspace::workspace_ops::WorktreeListReq =
        ...
        "hystersis.com/git/worktree/show" => {
            let req = serde_json::from_str::<ShowWorktreeRequest>(args.params.get())?;
            let op = hystersis_workspace::workspace_ops::WorktreeShowReq {
        ...
        "hystersis.com/git/worktree/gc" => {
            ...
            let op = hystersis_workspace::workspace_ops::WorktreeGcReq {
                dry_run: req.dry_run,
                max_age_secs,
                force: req.force,
            };
        ...
        "hystersis.com/git/worktree/db/stats" => {
            let result = ops
                .dispatch(
                    &hystersis_workspace::workspace_ops::WorktreeDbStatsReq {},
                    None,
                )
                .await
                .map_err(|e| acp::Error::internal_error().data(e.to_string()))?;
        ...
        "hystersis.com/git/worktree/db/rebuild" => {
            let result = ops
                .dispatch(
                    &hystersis_workspace::workspace_ops::WorktreeDbRebuildReq {},
                    None,
                )
                .await
                .map_err(|e| acp::Error::internal_error().data(e.to_string()))?;
        ...
        "hystersis.com/git/worktree/db/path" => {
            let result = ops
                .dispatch(
                    &hystersis_workspace::workspace_ops::WorktreeDbPathReq {},
                    None,
                )
                .await
                .map_err(|e| acp::Error::internal_error().data(e.to_string()))?;
        ...
        "hystersis.com/git/worktree/detach" => {
            ...
            let result = ops
                .dispatch(
                    &hystersis_workspace::workspace_ops::WorktreeDetachReq {
                        id_or_path: req.id_or_path,
        ...
        "hystersis.com/git/worktree/salvage" => {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct SalvageReq {
                id_or_path: String,
            ...
            let result = ops
                .dispatch(
                    &hystersis_workspace::workspace_ops::WorktreeSalvageReq {
                        id_or_path: req.id_or_path,
                        out: req.out,
                    },
                    None,
        ...
        "hystersis.com/git/worktree/clean-artifacts" => {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct CleanReq {
                id_or_path: String,
            ...
            let result = ops
                .dispatch(
                    &hystersis_workspace::workspace_ops::WorktreeCleanArtifactsReq {
                        id_or_path: req.id_or_path,
                    },
                    None,
                )
...
mod tests {
    ...
    fn db_path_response_serializes() {
        let resp = WorktreeDbPathResponse {
            path: "/home/user/.hystersis/worktrees.db".into(),
        };
        let json = serde_json::to_string(&resp).unwrap();
        assert!(json.contains("\"path\":\"/home/user/.hystersis/worktrees.db\""));
    }
