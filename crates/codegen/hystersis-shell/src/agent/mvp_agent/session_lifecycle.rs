...
impl MvpAgent {
    ...
    pub(crate) fn remove_session(&self, id: &acp::SessionId) {
        let _ = self
            .subagent_event_tx
            .send(hystersis_tools::implementations::hystersis_build::task::types::SubagentEvent::TeardownSession {
        ...
        self.log_resource_usage(hystersis_telemetry::events::ResourceReportTrigger::SessionClose);
    }
