...
mod tests {
    ...
    #[test]
    fn success_response_projects_hystersis_workspace_fields() {
    ...
    fn degraded_response_carries_partial_reason() {
        ...
        assert_eq!(value["_meta"]["hystersis.com/partial"]["workspaces"], true);
        assert_eq!(value["_meta"]["hystersis.com/partial"]["reason"], "no_oauth");
    }
}
