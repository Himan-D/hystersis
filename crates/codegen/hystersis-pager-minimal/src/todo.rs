...
use hystersis_shell::tools::TodoStatus;
    ...
    let mut lines: Vec<Line<'static>> = todos
        ...
        .map(|t| {
            let (glyph, style) = match t.status {
                ...
                TodoStatus::Completed => (hystersis_pager::glyphs::check_mark(), theme.muted()),
                TodoStatus::Cancelled => (
                    hystersis_pager::glyphs::ballot_x(),
...
mod tests {
    ...
    use hystersis_shell::tools::{TodoItem, TodoPriority};
