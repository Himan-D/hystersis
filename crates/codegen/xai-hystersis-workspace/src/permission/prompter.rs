...
use xai_hystersis_session_events::{Event, EventWriter, PermissionDecision};
use xai_hystersis_tools::implementations::hystersis_build::web_fetch::domain_from_url;
...
/// Canonical definition lives in `xai_hystersis_workspace_types` (so both the
...
/// reached `xai_hystersis_workspace::permission::MCP_TOOL_NAME_DELIMITER`.
...
mod tests {
    ...
    async fn request_emits_permission_requested_and_resolved() {
        use xai_hystersis_session_events::EventWriter;
