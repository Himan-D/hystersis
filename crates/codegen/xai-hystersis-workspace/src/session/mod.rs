...
use xai_hystersis_mcp::servers::McpState;
use xai_hystersis_tools::notification::AcknowledgedToolNotification;
use xai_hystersis_tools::notification::types::ToolNotificationHandle;
use xai_hystersis_tools::registry::types::{FinalizedToolset, ToolConfig, ToolServerConfig};
...
impl WorkspaceSession {
    ...
    pub(crate) async fn set_cwd_for_virtualization(&self, cwd: PathBuf) -> Result<(), String> {
        ...
        res.insert(xai_hystersis_tools::types::resources::Cwd(cwd));
        Ok(())
    }
    ...
    pub(crate) async fn toolset_terminal_is_session_owned(&self) -> bool {
        ...
        match res.get::<xai_hystersis_tools::types::resources::Terminal>() {
...
pub struct WorkspaceShared {
    ...
    pub(crate) events: tokio::sync::broadcast::Sender<xai_hystersis_workspace_types::WorkspaceEvent>,
    pub(crate) respect_gitignore: bool,
    pub(crate) memory_config: Option<MemoryConfig>,
    pub(crate) hook_registry: Arc<parking_lot::RwLock<xai_hystersis_hooks::discovery::HookRegistry>>,
    pub(crate) hook_load_errors: Vec<xai_hystersis_hooks::error::HookError>,
    ...
    pub(crate) activity_notify_handle:
        arc_swap::ArcSwap<Option<xai_hystersis_tools::notification::types::ToolNotificationHandle>>,
    ...
    pub(crate) lsp: Option<std::sync::Arc<dyn xai_hystersis_tools::implementations::lsp::LspBackend>>,
    ...
    /// [`EventWriter::noop()`](xai_hystersis_session_events::EventWriter::noop) and
    ...
    pub(crate) session_event_writers:
        Arc<dashmap::DashMap<String, xai_hystersis_session_events::EventWriter>>,
...
impl WorkspaceShared {
    ...
    /// [`EventWriter::noop()`](xai_hystersis_session_events::EventWriter::noop)
    ...
    pub(crate) fn session_event_writer(
        &self,
        session_id: &str,
    ) -> xai_hystersis_session_events::EventWriter {
    ...
    pub(crate) fn session_event_writer_cached(
        &self,
        session_id: &str,
    ) -> Option<xai_hystersis_session_events::EventWriter> {
    ...
    pub fn subscribe_events(
        &self,
    ) -> tokio::sync::broadcast::Receiver<xai_hystersis_workspace_types::WorkspaceEvent> {
...
pub(crate) fn get_or_open_session_writer(
    enabled: bool,
    writers: &dashmap::DashMap<String, xai_hystersis_session_events::EventWriter>,
    workspace_home: &Path,
    session_id: &str,
) -> xai_hystersis_session_events::EventWriter {
    ...
    let create = xai_hystersis_config::create_dir_all_owner_only(&dir);
    xai_hystersis_config::set_dir_owner_only(&sessions_root);
    if let Err(e) = create {
        tracing::warn!(
...
mod tests {
    ...
    use dashmap::DashMap;
    use xai_hystersis_session_events::{Event, EventWriter};
