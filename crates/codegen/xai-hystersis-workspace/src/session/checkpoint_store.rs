...
//!
//! ```text
//! <cwd>/.hystersis/rewind-checkpoints/
...
/// Directory (under `<cwd>/.hystersis`) holding every session's checkpoint store.
...
pub(crate) struct CheckpointStore {
    /// Per-session store directory: `<cwd>/.hystersis/rewind-checkpoints/<session_id>`.
    dir: PathBuf,
