...
pub(crate) fn rewind_hunks_enabled() -> bool {
    xai_hystersis_config::env_bool("HYSTERSIS_WORKSPACE_REWIND_HUNKS").unwrap_or(false)
}
...
pub(crate) fn rewind_durable_enabled() -> bool {
    xai_hystersis_config::env_bool("HYSTERSIS_WORKSPACE_REWIND_DURABLE").unwrap_or(false)
}
