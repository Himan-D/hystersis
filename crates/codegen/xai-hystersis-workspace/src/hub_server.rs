...
use xai_hystersis_tools::computer::types::KillOutcome;
use xai_hystersis_tools::computer::types::TaskKind;
use xai_hystersis_tools::implementations::hystersis_build::scheduler::interval::interval_to_human;
use xai_hystersis_tools::implementations::hystersis_build::scheduler::types::{
    SchedulerCommand, SchedulerHandle,
};
use xai_hystersis_tools::registry::types::FinalizedToolset;
use xai_hystersis_tools::types::resources::Terminal;
use xai_hystersis_workspace_types::rpc::workspace::{
...
) -> Vec<xai_hystersis_workspace_types::rpc::workspace::BackgroundTaskSummaryWire> {
    use xai_hystersis_tools::computer::types::TaskKind;
    use xai_hystersis_tools::types::resources::Terminal;
    use xai_hystersis_tools::types::tool::ToolKind;
    use xai_hystersis_workspace_types::rpc::workspace::BackgroundTaskSummaryWire;
    let terminal = {
...
async fn list_session_todos(
    toolset: &xai_hystersis_tools::registry::types::FinalizedToolset,
) -> Vec<xai_hystersis_workspace_types::rpc::workspace::TodoSummaryWire> {
    use xai_hystersis_tools::implementations::hystersis_build::todo::{TodoState, TodoStatus};
    use xai_hystersis_tools::types::resources::State;
    use xai_hystersis_workspace_types::rpc::workspace::TodoSummaryWire;
    let res = toolset.resources.lock().await;
...
impl WorkspaceRpcHandler {
    ...
    async fn dispatch(
        ...
        use xai_hystersis_workspace_types::rpc::git::{GitBranchInfoReq, GitMetadataReq};
        use xai_hystersis_workspace_types::rpc::presence::PresenceNoteReq;
        use xai_hystersis_workspace_types::rpc::search::FuzzyStatusReq;
        use xai_hystersis_workspace_types::rpc::skills::DiscoverPluginsReq;
        use xai_hystersis_workspace_types::rpc::workspace::{
        ...
        use xai_hystersis_workspace_types::rpc::worktree::WorktreeCreateSyncReq;
        ...
        match method {
            <WorkspaceInfoReq as WorkspaceRpc>::METHOD => {
                ...
                let info = WorkspaceInfo {
                    ...
                    version: Some(xai_hystersis_version::VERSION.to_owned()),
                };
