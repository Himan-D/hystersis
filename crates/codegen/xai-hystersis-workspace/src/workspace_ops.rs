...
use xai_hystersis_tools::types::output::ToolRunResult;
use xai_hystersis_workspace_client::{WorkspaceClient, is_transport_fatal};
pub use xai_hystersis_workspace_types::rpc::agents_md::DiscoverAgentsMdReq;
pub use xai_hystersis_workspace_types::rpc::code_nav::{
...
pub use xai_hystersis_workspace_types::rpc::export_github::ExportGithubReq;
pub use xai_hystersis_workspace_types::rpc::fs::{
...
pub use xai_hystersis_workspace_types::rpc::git::{
...
pub use xai_hystersis_workspace_types::rpc::hooks::{
    HookEventNameWire, HookRegistryReq, HookRegistryWire, HookSpecWire,
};
pub use xai_hystersis_workspace_types::rpc::hunks::{
...
pub use xai_hystersis_workspace_types::rpc::repos::{
    ProvisionedRepo, RepoManifest, ReposListReq, ReposListResponse,
};
pub use xai_hystersis_workspace_types::rpc::search::{FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq};
pub use xai_hystersis_workspace_types::rpc::session::{BeginPromptReq, EndPromptReq, RewindToReq};
pub use xai_hystersis_workspace_types::rpc::skills::DiscoverSkillsReq;
pub use xai_hystersis_workspace_types::rpc::workspace::WorkspaceInfoReq;
pub use xai_hystersis_workspace_types::rpc::worktree::{
...
pub use xai_hystersis_workspace_types::rpc::{RpcActivityClass, WorkspaceRpc};
...
fn hub_transfer_client() -> WorkspaceResult<reqwest::Client> {
    xai_hystersis_extra_ca::build_reqwest_client(|builder| {
...
fn repos_manifest_search_dirs(start: &std::path::Path) -> Vec<std::path::PathBuf> {
    let rel = xai_hystersis_workspace_types::rpc::repos::REPOS_MANIFEST_RELATIVE_PATH;
    #[allow(deprecated)]
    ...
    if let Some(user_home) = xai_hystersis_config::user_hystersis_home() {
...
async fn load_repos_manifest(root: &std::path::Path) -> WorkspaceResult<RepoManifest> {
    let path = root.join(xai_hystersis_workspace_types::rpc::repos::REPOS_MANIFEST_RELATIVE_PATH);
    match tokio::fs::read(&path).await {
...
fn hook_registry_to_wire(
    registry: &xai_hystersis_hooks::discovery::HookRegistry,
...
fn wire_to_hook_registry(
...
) -> WorkspaceResult<xai_hystersis_hooks::discovery::HookRegistry> {
    ...
    let mut registry: xai_hystersis_hooks::discovery::HookRegistry =
        serde_json::from_value(value).map_err(|e| WorkspaceError::HubError(e.to_string()))?;
...
///   session's [`FinalizedToolset`](xai_hystersis_tools::registry::types::FinalizedToolset).
...
impl WorkspaceOps {
    ...
    pub fn server_version(&self) -> Option<String> {
        match self {
            Self::Local { .. } => Some(xai_hystersis_version::VERSION.to_owned()),
    ...
    pub async fn hook_registry(&self) -> WorkspaceResult<xai_hystersis_hooks::discovery::HookRegistry> {
    ...
    ///   [`FinalizedToolset`](xai_hystersis_tools::registry::types::FinalizedToolset)
...
mod tests {
    ...
    async fn repos_list_reads_real_manifest_empty_one_and_many() {
        ...
        assert_eq!(
            empty.version,
            xai_hystersis_workspace_types::rpc::repos::REPOS_MANIFEST_VERSION
        );
        ...
        std::fs::write(
            tmp.path()
                .join(xai_hystersis_workspace_types::rpc::repos::REPOS_MANIFEST_RELATIVE_PATH),
    ...
    async fn repos_list_walks_up_from_rewritten_cwd() {
        ...
        std::fs::write(
            sandbox_ws.join(xai_hystersis_workspace_types::rpc::repos::REPOS_MANIFEST_RELATIVE_PATH),
            one.to_json_bytes().unwrap(),
        )
        .unwrap();
    ...
    async fn end_local_session_drops_bound_toolset() {
        ...
        let toolset = std::sync::Arc::new(
            xai_hystersis_tools::registry::types::FinalizedToolset::empty_for_test(),
        );
    ...
    fn hook_registry_wire_round_trip_both_directions() {
        let spec = xai_hystersis_hooks::config::HookSpec {
            ...
            event: xai_hystersis_hooks::event::HookEventName::PreToolUse,
        ...
        let mut registry = xai_hystersis_hooks::discovery::HookRegistry::default();
    ...
    fn hook_event_name_wire_covers_all_upstream_variants() {
        use xai_hystersis_hooks::event::HookEventName as E;
    ...
    fn hook_spec_wire_covers_all_upstream_fields() {
        use xai_hystersis_hooks::config::HookSpec;
        ...
        let spec = HookSpec {
            ...
            source_dir: std::path::PathBuf::from("/home/u/.hystersis/hooks"),
            extra_env: std::collections::HashMap::from([("FOO".to_string(), "bar".to_string())]),
            layer: xai_hystersis_hooks::config::HookProvenance::Managed,
        };
        assert_eq!(
