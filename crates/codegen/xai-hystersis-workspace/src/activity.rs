...
use xai_hystersis_session_events::{Event, EventWriter, ToolCompletedSource, ToolOutcome};
...
pub(crate) const PRESENCE_ACTIVITY_WINDOW_MS: u64 =
    xai_hystersis_workspace_types::rpc::presence::PRESENCE_ACTIVITY_WINDOW_MS;
