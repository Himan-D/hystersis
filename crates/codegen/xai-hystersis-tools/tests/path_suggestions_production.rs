...
//! Run:
//! ```bash
//! cargo test -p xai-hystersis-tools --test path_suggestions_production
//! ```

use std::path::PathBuf;
use tempfile::TempDir;
use xai_hystersis_tools::util::path_suggestions::{format_not_found_error, path_not_found_hint};
...
fn similar_names(hint: &xai_hystersis_tools::util::path_suggestions::PathNotFoundHint) -> Vec<String> {
    hint.similar
        .iter()
...
#[tokio::test]
async fn pattern2_hystersis_sessions_internal_path() {
