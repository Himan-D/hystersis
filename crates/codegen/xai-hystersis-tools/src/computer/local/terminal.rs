...
impl LocalTerminalActor {
    ...
    async fn spawn_static_command(
        ...
        #[cfg(target_os = "linux")]
        if xai_hystersis_sandbox::should_restrict_child_network() {
            unsafe {
                cmd.pre_exec(|| xai_hystersis_sandbox::child_net::install_child_network_filter());
            }
        }
...
fn spawn_shell_command(
    ...
    let mut build_cmd = |with_breakaway: bool| {
        ...
        let inv = xai_hystersis_config::shell::shell_command_argv(command);
