...
pub mod hystersis_build;
pub mod hystersis_build_concise;
pub mod hystersis_build_hashline;
pub mod lsp;
pub mod memory;
pub mod opencode;
pub mod read_file;
...
pub mod use_tool;
pub mod web_search;
pub use hystersis_build::bash::{BashError, BashToolInput};
pub use hystersis_build::{
