...
pub const USER_AGENT_STRING: &str = "Mozilla/5.0 (compatible; hystersis-agent/1.0; +https://hystersis.com)";
...
pub struct WebFetchParams {
    ...
    /// allow_local = true` or `HYSTERSIS_WEB_FETCH_ALLOW_LOCAL=1`.
    #[serde(default)]
    pub allow_local: Option<bool>,
}

register_resource!("hystersis_build", "WebFetch", WebFetchParams);
