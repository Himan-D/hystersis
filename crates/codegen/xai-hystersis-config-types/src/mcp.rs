//! MCP server configuration value types, extracted from xai-hystersis-shell
...
use xai_hystersis_mcp::oauth_config::McpOAuthConfig;
...
/// and surfaced through `hystersis inspect`.
...
impl RelaySyncConfig {
    ...
    pub fn is_enabled(&self) -> bool {
        if let Ok(env_val) = std::env::var("HYSTERSIS_RELAY_SYNC_ENABLED") {
