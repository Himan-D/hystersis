...
use xai_hystersis_config::env_bool;
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        ...
        env: "HYSTERSIS_ASK_USER_QUESTION",
        default_enabled: true,
    ...
    FeatureSpec {
        ...
        env: "HYSTERSIS_FEEDBACK_ENABLED",
        default_enabled: true,
    ...
    FeatureSpec {
        ...
        env: "HYSTERSIS_FEEDBACK_TRACE_CARD",
        default_enabled: false,
    ...
    FeatureSpec {
        ...
        env: "HYSTERSIS_COMPACTION_VERBATIM_INPUT",
        default_enabled: true,
    ...
    FeatureSpec {
        ...
        env: "HYSTERSIS_TWO_PASS_COMPACTION",
        default_enabled: true,
    ...
    FeatureSpec {
        ...
        env: "HYSTERSIS_SUBAGENT_WORKTREE_SNAPSHOT",
        default_enabled: false,
