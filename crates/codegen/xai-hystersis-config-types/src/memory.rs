//! Memory-system configuration value types, extracted from xai-hystersis-shell
...
///
/// When enabled, watches `~/.hystersis/memory/` for `.md` file changes (create,
...
///
/// On session init, directories under `~/.hystersis/memory/` are scanned:
...
impl MemoryConfig {
    ...
    pub fn resolve_settings(
        ...
        Self {
            enabled: crate::BoolFlag::env("HYSTERSIS_MEMORY")
