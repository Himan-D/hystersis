...
use xai_hystersis_announcements::RemoteAnnouncement;
...
pub struct RemoteSettings {
    ...
    /// When `Some(true)`, enable hystersis's default OAuth2 (xAI auth.hystersis.com).
    ...
    /// `xai_hystersis_telemetry::external::apply_remote_policy`.
    #[serde(default)]
