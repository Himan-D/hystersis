...
impl From<ConversationRequest> for ChatCompletionRequest {
    fn from(req: ConversationRequest) -> Self {
        ...
        ChatCompletionRequest {
            ...
            x_hystersis_conv_id: req.x_hystersis_conv_id,
            x_hystersis_req_id: req.x_hystersis_req_id,
            x_hystersis_session_id: req.x_hystersis_session_id,
            x_hystersis_turn_idx: req.x_hystersis_turn_idx,
            x_hystersis_agent_id: req.x_hystersis_agent_id,
            x_hystersis_deployment_id: req.x_hystersis_deployment_id,
            x_hystersis_user_id: req.x_hystersis_user_id,
            trace: None,
        }
    }
}
