...
// Re-export ToolDefinition and FunctionTool from xai-hystersis-tools.
...
pub use xai_hystersis_tools::types::definition::{FunctionTool, ToolDefinition};
...
mod tests {
    ...
    fn parse_reasoning_efforts_meta_absent_is_none() {
        ...
        assert!(
            parse_reasoning_efforts_meta(Some(json!({ "agentType": "hystersis" }).as_object().unwrap()))
                .is_none()
        );
    }
