//! HystersisDay theme — neutral gray base (light) with deepened accent colors.
//!
//! Light counterpart to HystersisNight. Backgrounds and text use a neutral
//! grayscale ramp (no blue/warm tint). Accent colors are the same hue
//! family as HystersisNight but deepened for contrast on light backgrounds.
...
impl Theme {
    pub const fn hystersisday() -> Self {
        Self {
            bg_base: BG_STORM,
