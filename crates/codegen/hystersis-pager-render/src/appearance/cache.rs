...
//!
//! Disk writes live in `hystersis_shell::util::config::set_<field>()`.
...
use hystersis_shared::ui_config::UiConfig;
...
fn load_bool_from_effective_config(key: &str, default: bool) -> bool {
    let root = match hystersis_config::load_effective_config_disk_only() {
        Ok(r) => r,
