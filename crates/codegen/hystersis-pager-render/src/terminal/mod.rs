...
impl TerminalContext {
    ...
    pub fn telemetry_snapshot(&self) -> hystersis_telemetry::events::TerminalTelemetry {
        ...
        hystersis_telemetry::events::TerminalTelemetry {
            ...
            clipboard_native_tool: hystersis_shared::clipboard::native_tool_name().to_owned(),
            clipboard_data_control: crate::clipboard::wayland_data_control_label().to_owned(),
        }
    }

    /// Extract terminal info for feedback submissions.
    pub fn feedback_info(&self) -> hystersis_shared::session::FeedbackTerminalInfo {
        use hystersis_shared::session::FeedbackTerminalInfo;
        ...
        FeedbackTerminalInfo {
            ...
            clipboard_native_tool: Some(hystersis_shared::clipboard::native_tool_name().to_owned()),
