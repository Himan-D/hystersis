//! Hystersis Speech-to-Text language codes.
//!
//! Source of truth for the `language` query/form parameter on
//! `https://api.hystersis.com/v1/stt` and `wss://api.hystersis.com/v1/stt`.
//!
//! Official catalog (25 languages):
//! <https://docs.hystersis.com/developers/model-capabilities/audio/speech-to-text#supported-languages>
//!
...
/// Official Hystersis STT languages (docs.hystersis.com), sorted by English name.
///
...
mod tests {
    ...
    fn catalog_matches_public_docs_exactly() {
        ...
        assert_eq!(
            ours, docs,
            "STT_LANGUAGES drifted from docs.hystersis.com supported languages"
        );
    }
