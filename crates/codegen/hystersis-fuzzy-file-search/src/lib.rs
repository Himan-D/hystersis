...
mod thread_exhaustion_tests {
    ...
    const CHILD_ENV: &str = "HYSTERSIS_FUZZY_THREAD_EXHAUSTION_CHILD";
    const CHILD_ENV_LEGACY: &str = "XAI_FUZZY_THREAD_EXHAUSTION_CHILD";
    const CHILD_ENV_LEGACY2: &str = "XAI_HYSTERSIS_FUZZY_THREAD_EXHAUSTION_CHILD";
