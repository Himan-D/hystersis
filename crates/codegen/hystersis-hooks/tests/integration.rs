...
use hystersis_hooks::discovery::load_hooks;
use hystersis_hooks::dispatcher;
use hystersis_hooks::event::*;
use hystersis_hooks::result::HookDecision;
use hystersis_hooks::runner::RunContext;
...
async fn non_blocking_dispatch() {
    ...
    assert!(matches!(
        &results[0],
        hystersis_hooks::result::HookRunResult::Success { .. }
    ));
}
    ...
    let cases = vec![
        ...
        Case {
            ...
            payload: HookPayload::StopFailure {
                error: hystersis_hooks::event::StopFailureKind::RateLimit,
        ...
        Case {
            ...
            payload: HookPayload::StopCancelled {
                reason: hystersis_hooks::event::StopCancelledReason::UserInterrupt,
                cancelled_by: hystersis_hooks::event::CancelledBy::User,
