...
use hystersis_config_types::DisplayRefreshSettings;

use hystersis_status_line::StatusLineConfig;
...
impl Default for UiConfig {
    fn default() -> Self {
        Self {
            ...
            theme: None,
            fork_secondary_model: hystersis_models::default_model().to_string(),
            yolo: false,
            ui_theme: None,
            compact_mode: false,
            simple_mode: None,
