...
//! shell re-issues the `hystersis.com/exit_plan_mode` reverse-request — a real live ACP
...
/// `xai_hystersis_shell::session::plan_mode::PlanModeSnapshot`; we only touch the one
