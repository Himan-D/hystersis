...
//!
//! ```bash
//! cargo test -p xai-hystersis-pager-pty-harness --test prompt_stash -- --ignored --nocapture
//! ```

use std::time::Duration;

use anyhow::{Context, Result};
use xai_hystersis_pager_pty_harness::{ContentController, PtyHarness, pager_binary};
