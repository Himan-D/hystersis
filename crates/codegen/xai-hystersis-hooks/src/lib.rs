//! # xai-hystersis-hooks
//!
//! Runtime hook system for Hystersis — file-based discovery, command execution,
//! and policy enforcement.
//!
//! ## Overview
//!
//! This crate provides a minimal hooks system for Hystersis. Hooks are discovered
//! from dedicated directories (`~/.hystersis/hooks/` and `<git-worktree-root>/.hystersis/hooks/`),
...
//!     Some(Path::new("/home/user/.hystersis/hooks")),
//!     Some(Path::new("/project/.hystersis/hooks")),
//! );
//!
//! for err in &errors {
