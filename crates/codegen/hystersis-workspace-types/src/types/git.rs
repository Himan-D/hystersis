...
//! `hystersis_shell::session::git` and `hystersis_shell::extensions::git`
...
/// VCS kind.
///
/// TODO(workspace): align with `hystersis_shell::session::git::VcsKind`.
