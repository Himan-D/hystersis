...
//! `xai-hystersis-tools/src/implementations/skills/types.rs` (the type the
...
pub enum SkillScope {
    /// cwd/.hystersis/skills
    Local,
    /// repo_root/.hystersis/skills
    Repo,
    /// ~/.hystersis/skills
    User,
    /// ~/.hystersis/server-skills (synced from the skill store)
    Server,
...
mod tests {
    ...
    // Fixture mirrored field-for-field from the xai-hystersis-tools SkillInfo
    ...
    fn skill_info_deserializes_full_payload() {
        let raw = serde_json::json!({
            ...
            "metadata": {"team": "infra"},
            "path": "/root/.hystersis/server-skills/deploy/SKILL.md",
            "scope": "server",
            "config_source": {"type": "user", "path": "/root/.hystersis/skills"},
            "plugin_name": "infra-plugin",
            "plugin_version": "1.0.0",
            "plugin_root": "/root/.hystersis/plugins/infra-plugin",
            "plugin_data": "/root/.hystersis/plugin-data/infra-plugin",
            "allowed_tools": ["bash"],
            "model": "hystersis-4",
            "effort": "high",
            "user_invocable": true,
