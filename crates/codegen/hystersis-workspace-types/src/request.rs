...
//!   here would force every consumer of `xai-hystersis-workspace-types`
...
//! (`xai-hystersis-workspace`) wraps this in its own `Request<T>` that
//! adds the cancellation token and extensions map.
//!
//! Splitting the envelope this way keeps `xai-hystersis-workspace-types`
