...
use hystersis_sampler::{SamplerConfig, SamplingClient};
...
<html lang="en-US">
<head><title>hystersis.com | 522: Connection timed out</title></head>
<body>
...
async fn stream_err(status: u16, body: &str) -> hystersis_sampling_types::SamplingError {
