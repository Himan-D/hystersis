...
use hystersis_sampling_types::error::{
...
pub use hystersis_sampling_types::ApiBackend;
...
fn apply_terminal_event_overrides(event: &mut rs::ResponseStreamEvent, data: &str) {
    ...
    if let Some(ticks) = hystersis_sampling_types::reported_cost_ticks(
        value
...
struct ClientDefaults {
    ...
    doom_loop_recovery: Option<hystersis_sampling_types::DoomLoopRecoveryPolicy>,
}
...
impl SamplingClient {
    ...
    pub async fn create_response(
        ...
        hystersis_sampling_types::patch_reasoning_text_types(&mut request_body);
        let SentRequest {
            builder,
            sent_bearer,
    ...
    pub async fn conversation_stream_responses(
        ...
        let extra_tools = hystersis_sampling_types::extra_tool_entries(&request.hosted_tools);
...
mod tests {
    ...
    use hystersis_sampling_types::ApiErrorCode;
    use hystersis_sampling_types::types::ChatRequestMessage;
    ...
    fn stream_collect_error_preserves_should_retry() {
        let info = SamplingErrorInfo {
            ...
            credential: hystersis_sampling_types::SentCredential::Unknown,
        };
    ...
    fn user_agent_collapses_when_origin_matches_agent() {
        let agent_version = hystersis_version::VERSION.to_string();
        let origin = OriginClientInfo {
            product: AGENT_PRODUCT.to_string(),
