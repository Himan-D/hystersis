...
//! Hystersis to persist important information across sessions. Memory files are
//! stored under `~/.hystersis/memory/` with workspace-scoped subdirectories
...
//! ## Feature Flag
//!
//! Memory is enabled through `HYSTERSIS_MEMORY`, `[memory] enabled`, or remote settings.
...
pub(crate) const MEMORY_LOG_TARGET: &str = "hystersis_memory";
