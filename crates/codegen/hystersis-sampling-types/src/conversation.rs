...
impl hystersis_compaction::CompactionItem for ConversationItem {
    fn role(&self) -> hystersis_compaction::CompactionRole {
        use hystersis_compaction::CompactionRole;
    ...
    fn attachment_refs(&self) -> Vec<hystersis_compaction::CompactionFileRef> {
...
impl hystersis_compaction::CompactionItemFactory for ConversationItem {
...
mod compaction_item_bridge_tests {
    use super::*;
    use hystersis_compaction::{CompactionItem, CompactionItemFactory, CompactionRole};
