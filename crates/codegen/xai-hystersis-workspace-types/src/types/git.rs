...
//! `xai_hystersis_shell::session::git` and `xai_hystersis_shell::extensions::git`
...
/// VCS kind.
///
/// TODO(workspace): align with `xai_hystersis_shell::session::git::VcsKind`.
...
/// `xai_hystersis_shell::session::git`.
#[derive(Debug, Clone, Default, PartialEq, Eq, Serialize, Deserialize)]
