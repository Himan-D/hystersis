...
/// Claude.md / `.hystersis/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.hystersis` and compat dirs.
...
/// Mirrors the serde shape of `xai-hystersis-agent`'s `AgentConfigFile`.
