//! `AcpTerminalAdapter`: implements `xai-hystersis-tools::TerminalBackend` over ACP
...
use hystersis_acp_lib::{AcpAgentGatewaySender as GatewaySender, acp_channel_failure};
use hystersis_tools::computer::types::{
...
/// Wraps xai-hystersis-shell's ACP gateway to satisfy xai-hystersis-tools' TerminalBackend.
