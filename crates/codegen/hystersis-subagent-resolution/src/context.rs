...
mod tests {
    use super::*;
    use hystersis_sampling_types::conversation::{ConversationItem, ToolCall, ToolResultItem};
    ...
    fn reasoning_item(text: &str) -> ConversationItem {
        ConversationItem::Reasoning(hystersis_sampling_types::synthesized_reasoning_item(text))
    }
