...
impl PtyHarness {
    ...
    /// Spawn from a canonical [`hystersis_test_support::TestSandbox`] baseline
    ...
    pub fn new_in_sandbox(
        ...
        cols: u16,
        args: &[&str],
        sandbox: &hystersis_test_support::TestSandbox,
        env: &[(&str, &str)],
        cwd: Option<&Path>,
    ) -> Result<Self> {
    ...
    /// # use hystersis_pager_pty_harness::{PtyHarness, ContentController, pager_binary};
