...
///
/// A private copy of `xai_hystersis_workspace::util::is_lock_contended`, which stays
...
/// (`HYSTERSIS_WORKSPACE_TERMINATION_GRACE_MS`, default 45s): a takeover only
...
mod tests {
    ...
    fn process_name_matches_own_argv0() {
        ...
        // differently (e.g. Cargo uses `xai_hystersis_workspace_daemon-<hash>`), so a
