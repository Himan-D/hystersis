...
use hystersis_sqlite_journal::{BUSY_RETRY_BUDGET, JournalMode};
...
impl WorktreeDb {
    ...
    ///
    /// Discovers hystersis home via `hystersis_home::resolve_hystersis_home` (`$HYSTERSIS_HOME`,
...
pub fn resolve_hystersis_home() -> Result<PathBuf> {
    hystersis_home::resolve_hystersis_home()
