...
//!    `xai-mixpanel`, `xai-hystersis-tools`, ...) also pinned to 0.12. Bumping every
...
//!    (`xai_hystersis_mcp::rmcp::*`).
//!
//! 2. **Owns MCP-specific integration code**:
//!    - [`credentials`] -- on-disk `$HYSTERSIS_HOME/mcp_credentials.json` store and
