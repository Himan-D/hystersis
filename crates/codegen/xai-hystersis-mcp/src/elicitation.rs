...
pub fn elicit_result_from_wire(
    response: &xai_hystersis_tools::mcp_elicitation::McpElicitExtResponse,
) -> ElicitResult {
...
///
/// [`McpElicitExtRequest`]: xai_hystersis_tools::mcp_elicitation::McpElicitExtRequest
#[derive(Debug, Clone)]
pub struct WireElicitFields {
    pub message: String,
    pub mode: xai_hystersis_tools::mcp_elicitation::McpElicitModeFields,
}

pub fn wire_mode_and_fields(params: &ElicitRequestParams) -> Option<WireElicitFields> {
    use xai_hystersis_tools::mcp_elicitation::{
...
mod tests {
    ...
    fn wire_mapping_form_and_url() {
        use xai_hystersis_tools::mcp_elicitation::McpElicitModeFields;
        let schema = ElicitationSchema::builder()
        ...
        assert_eq!(url, "https://hystersis.com");
    ...
    fn oversized_message_is_declined() {
        use xai_hystersis_tools::mcp_elicitation::MAX_ELICIT_MESSAGE_CHARS;
        let schema = ElicitationSchema::builder()
            .required_property("x", PrimitiveSchemaDefinition::String(StringSchema::new()))
            .build()
            .unwrap();
