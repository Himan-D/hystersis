...
//!
//! Run with: cargo test -p xai-hystersis-mcp --test repro_sse_flood -- --nocapture
...
use xai_hystersis_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use xai_hystersis_mcp::rmcp::ServiceExt;
use xai_hystersis_mcp::rmcp::transport::StreamableHttpClientTransport;
use xai_hystersis_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
