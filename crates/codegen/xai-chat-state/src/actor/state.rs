...
pub fn estimate_tool_definition_tokens(td: &xai_hystersis_sampling_types::ToolDefinition) -> u64 {
...
pub fn estimate_tool_definitions_tokens(tds: &[xai_hystersis_sampling_types::ToolDefinition]) -> u64 {
...
pub fn estimate_item_tokens(item: &ConversationItem) -> u64 {
    ...
    match item {
        ...
        ConversationItem::Reasoning(r) => {
            ...
            let text_bytes = xai_hystersis_sampling_types::reasoning_item_text(r).len();
...
/// hystersis's [`ItemTokenCounter`](xai_hystersis_compaction::ItemTokenCounter)
...
impl xai_hystersis_compaction::ItemTokenCounter<ConversationItem> for EstimatedItemTokenCounter {
...
mod tests {
    ...
    fn estimated_item_token_counter_matches_estimate_item_tokens() {
        use xai_hystersis_compaction::ItemTokenCounter;
    ...
    fn estimate_tool_definition_tokens_counts_name_desc_params() {
        ...
        let td = xai_hystersis_sampling_types::ToolDefinition::function(
            "search",
            Some("find a file"),
            serde_json::json!({}),
        );
    ...
    fn estimate_tool_specs_tokens_counts_only_provided_specs() {
        let kept = xai_hystersis_sampling_types::ToolDefinition::function(
            "search",
            Some("find a file"),
            serde_json::json!({"type": "object"}),
        );
        let dropped = xai_hystersis_sampling_types::ToolDefinition::function(
            "web_search",
            Some("search the web"),
            serde_json::json!({"type": "object"}),
        );
    ...
    fn estimate_tool_definitions_tokens_sums_across_slice() {
        let a = xai_hystersis_sampling_types::ToolDefinition::function(
            "a",
            None::<&str>,
            serde_json::json!({}),
        );
        let b = xai_hystersis_sampling_types::ToolDefinition::function(
            "b",
            None::<&str>,
            serde_json::json!({}),
        );
