...
impl WorkspaceIdentity {
    ...
    /// `HystersisAuth.team_id`, and for a Team principal `principal_id` *is* the
    /// team id.
...
/// [`AuthIdentity`](hystersis_computer_hub_sdk::AuthIdentity). The two types carry the
...
impl From<hystersis_computer_hub_sdk::AuthIdentity> for WorkspaceIdentity {
    fn from(id: hystersis_computer_hub_sdk::AuthIdentity) -> Self {
...
pub struct WorkspaceEnvironment {
    ...
    /// Version of the `xai-hystersis-workspace` crate that produced the record.
    ...
    /// Sandbox profile name (`$HYSTERSIS_SANDBOX_PROFILE`), e.g. `"devbox"`.
...
impl WorkspaceEnvironment {
    ...
    pub(crate) fn capture(
        ...
        Self::assemble(
            ...
            server_id,
            sandbox_id,
            std::env::var("HYSTERSIS_SANDBOX_PROFILE").ok(),
