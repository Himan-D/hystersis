...
use hystersis_file_utils::gcs::StorageConfig;
use hystersis_file_utils::queue::{EnqueueOutcome, TraceExportSource, UploadQueue};
use hystersis_file_utils::storage_client::Auth401AttributionCallback;
use hystersis_file_utils::{TraceExportConfig, UploadMethod};
use hystersis_auth::{AuthCredentialProvider, CredentialSnapshot};
...
static UPLOAD_QUEUE_PENDING_BYTES: LazyLock<IntGauge> = LazyLock::new(|| {
    register_int_gauge!(
        "hystersis_workspace_upload_queue_pending_bytes",
...
static UPLOAD_QUEUE_PENDING: LazyLock<IntGauge> = LazyLock::new(|| {
    register_int_gauge!(
        "hystersis_workspace_upload_queue_pending",
...
static UPLOAD_OUTCOME_TOTAL: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec!(
        "hystersis_workspace_upload_outcome_total",
...
static UPLOAD_FAILED_TOTAL: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec!(
        "hystersis_workspace_upload_failed_total",
...
static UPLOAD_SKIPPED_TOTAL: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec!(
        "hystersis_workspace_upload_skipped_total",
...
impl hystersis_auth::visibility::HttpAuth for HubAuthCredentialProvider {
...
mod tests {
    use super::*;
    use hystersis_computer_hub_sdk::auth::AuthCredential;
    ...
    async fn tool_state_enqueues_at_session_turn_gcs_path() {
        use hystersis_file_utils::queue::{
