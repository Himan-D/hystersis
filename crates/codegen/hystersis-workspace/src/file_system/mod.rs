...
// its wire types live in `hystersis_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use hystersis_workspace_types::rpc::fs::FsReadEncoding;
...
pub use hystersis_fuzzy_file_search::{
...
pub use hystersis_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
