//! AcpFsAdapter: implements `xai-hystersis-tools::AsyncFileSystem` using ACP gateway calls.
//!
//! This adapter enables file tool execution over ACP (remote filesystem).
//! It translates xai-hystersis-tools' `AsyncFileSystem` trait into ACP protocol calls:
...
use hystersis_tools::computer::types::{AsyncFileSystem, ComputerError};

/// Wraps xai-hystersis-shell's ACP gateway to satisfy xai-hystersis-tools' AsyncFileSystem.
///
