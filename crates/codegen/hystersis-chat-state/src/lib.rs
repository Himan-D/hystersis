...
//!
//! This crate extracts conversation state management from `xai-hystersis-shell`'s
...
// Re-exported so `hystersis_chat_state::CompactionDetail` stays a working path for
// existing callers.
pub use hystersis_compaction_transcript::CompactionDetail;
