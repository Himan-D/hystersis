...
//!
//! ```text
//! cargo bench -p xai-hystersis-shell --bench skills_watcher_startup
//! # optional scale:
//! HYSTERSIS_SKILLS_WATCHER_BENCH_DIRS=12000 cargo bench -p xai-hystersis-shell --bench skills_watcher_startup
//! ```
//!
...
fn build_fixture(worktree_dirs: usize) -> Fixture {
    ...
    let hystersis_home = root.path().join("hystersis-home");
