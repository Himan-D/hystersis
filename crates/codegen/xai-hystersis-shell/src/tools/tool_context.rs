...
use xai_hystersis_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use xai_hystersis_workspace::session::file_state::FileStateHandle;
...
pub(crate) fn subagent_foreground_wait(
    state: Arc<BlockingWaitState>,
) -> xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentForegroundWait {
    xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentForegroundWait::new(
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn xai_hystersis_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<xai_hystersis_tools::implementations::hystersis_build::monitor::types::MonitorEventBuffer>,
    ...
    pub task_wake_suppressed:
        Option<xai_hystersis_tools::reminders::task_completion::TaskWakeSuppressed>,
