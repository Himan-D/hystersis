//! Retry utilities — re-exported from `xai-hystersis-tools`.
//!
//! The canonical implementation now lives in `xai_hystersis_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use xai_hystersis_tools::retry::BackoffConfig as RetryConfig;
pub use xai_hystersis_tools::retry::{BackoffConfig, execute_with_backoff};
