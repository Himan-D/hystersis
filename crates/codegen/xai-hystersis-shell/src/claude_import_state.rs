...
//
// State is persisted to `~/.hystersis/claude_import_state.json`.
...
use xai_hystersis_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.hystersis/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::hystersis_home::hystersis_home().join("claude_import_state.json")
}
