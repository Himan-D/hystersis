...
use std::sync::Arc;
use xai_hystersis_agent::prompt::skills::SkillsConfig;
use xai_hystersis_sampler::{AuthScheme, SamplerConfig};
...
use xai_hystersis_tools::types::compat::{
...
impl Default for EndpointsConfig {
    fn default() -> Self {
        Self {
            ...
            xai_api_base_url: std::env::var("HYSTERSIS_XAI_API_BASE_URL")
...
pub use xai_hystersis_config_types::{
...
pub use xai_hystersis_config::env_bool;
...
fn resolve_compat_cell(
    ...
    resolve_compat_cell_with_env(xai_hystersis_config::env_bool(env), cfg, remote, default)
}
...
pub(crate) fn compat_config_cell(
    ...
    cell: xai_hystersis_tools::types::compat::CompatCell,
...
pub(crate) use xai_hystersis_telemetry::config::env_telemetry_mode;
pub use xai_hystersis_telemetry::config::{TelemetryConfig, TelemetryMode};
...
impl PluginsConfig {
    ...
    pub(crate) fn merge_claude_enabled_plugins(&mut self, _cwd: Option<&std::path::Path>) {
        ...
        for path in &paths {
            let (claude_enabled, claude_disabled) =
                xai_hystersis_agent::plugins::marketplace::load_enabled_disabled_plugins(path);
    ...
    pub(crate) fn to_discovery_config(
        &self,
    ) -> xai_hystersis_agent::plugins::discovery::DiscoveryConfig {
        xai_hystersis_agent::plugins::discovery::DiscoveryConfig {
...
pub struct Config {
    ...
    #[serde(default, skip_serializing)]
    pub announcements: Vec<xai_hystersis_announcements::RemoteAnnouncement>,
    ...
    /// `[marketplace]` — also read by `xai_hystersis_plugin_marketplace::load_sources()`.
    #[serde(default, skip_serializing)]
    ...
    #[serde(skip)]
    pub cli_agents: Vec<xai_hystersis_agent::config::AgentDefinition>,
    #[serde(skip)]
    ...
    pub subagents_limit_behavior:
        xai_hystersis_tools::implementations::hystersis_build::task::admission::LimitBehavior,
    #[serde(skip)]
    pub workflow_max_concurrent_agents: usize,
    #[serde(skip)]
    pub media_gen_batch_limits: xai_hystersis_tools::media_gen_limits::MediaGenBatchLimits,
    ...
    #[serde(skip)]
    pub subagent_roles:
        std::collections::HashMap<String, xai_hystersis_subagent_resolution::config::SubagentRole>,
    /// Trust-independent personas from inline, user, and bundled sources.
    #[serde(skip)]
    pub subagent_personas:
        std::collections::HashMap<String, xai_hystersis_subagent_resolution::config::SubagentPersona>,
    ...
    pub zdr_video_output_s3:
        Option<xai_hystersis_tools::implementations::hystersis_build::video_gen::ZdrVideoOutputS3Config>,
...
pub struct CliAgentOverrides {
    ...
    pub permission_rules: Vec<xai_hystersis_workspace::permission::types::PermissionRule>,
    pub max_turns: Option<u32>,
    pub permission_mode: Option<xai_hystersis_agent::config::PermissionMode>,
}
impl CliAgentOverrides {
    ...
    pub(crate) fn apply_to_definition(&self, def: &mut xai_hystersis_agent::config::AgentDefinition) {
    ...
    pub(crate) fn apply_to_subagent_definition(
        &self,
        def: &mut xai_hystersis_agent::config::AgentDefinition,
    ) {
...
pub use xai_hystersis_agent::config::AgentDefinition;
pub use xai_hystersis_agent::config::Effort;
pub use xai_hystersis_agent::config::PermissionMode;
pub use xai_hystersis_shared::ui_config::{ContextualHints, UiConfig};
...
pub struct AgentSelectionConfig {
    ...
    /// Looked up via `xai_hystersis_agent::discovery::by_name_in_cwd()`.
...
impl Default for Config {
    fn default() -> Self {
        ...
        let mut cfg = Self {
            ...
            client_version: Some(xai_hystersis_version::VERSION.to_string()),
            ...
            subagents_max_concurrent:
                xai_hystersis_tools::implementations::hystersis_build::task::admission::DEFAULT_MAX_CONCURRENT,
            ...
            media_gen_batch_limits: xai_hystersis_tools::media_gen_limits::MediaGenBatchLimits::default(
            ),
...
impl Config {
    ...
    pub fn resolve_runtime_fields(&mut self, ctx: &RuntimeResolutionContext<'_>) {
        ...
        self.media_gen_batch_limits = xai_hystersis_tools::media_gen_limits::MediaGenBatchLimits {
    ...
    pub(crate) fn resolve_doom_loop_recovery(
        &self,
    ) -> Option<xai_hystersis_sampling_types::DoomLoopRecoveryPolicy> {
        use xai_hystersis_sampling_types::DoomLoopRecoveryPolicy as Policy;
        let remote = self
            .remote_settings
            .as_ref()
    ...
    pub(crate) fn resolve_image_gen(&self) -> Resolved<bool> {
        use xai_hystersis_tools::implementations::hystersis_build::IMAGE_GEN_TOOL_NAME;
    ...
    pub(crate) fn resolve_image_edit(&self) -> Resolved<bool> {
        use xai_hystersis_tools::implementations::hystersis_build::IMAGE_EDIT_TOOL_NAME;
    ...
    pub(crate) fn resolve_video_gen(&self) -> Resolved<bool> {
        use xai_hystersis_tools::implementations::hystersis_build::{
...
pub(crate) fn external_otel_master_switch_resolved() -> bool {
    external_otel_master_switch_from(
        xai_hystersis_config::load_merged_requirements().as_ref(),
...
pub fn resolve_external_otel_config(
    client: xai_hystersis_telemetry::external::config::ExternalClientInfo,
) -> Option<xai_hystersis_telemetry::external::ExternalOtelConfig> {
...
pub(crate) fn resolve_external_otel_config_with(
    ...
    let file_cfg: Option<xai_hystersis_telemetry::external::ExternalOtelFileConfig> = effective_config
        .and_then(|cfg| cfg.get("telemetry"))
        .map(|t| xai_hystersis_telemetry::external::ExternalOtelFileConfig {
    ...
    let getenv_pinned = |name: &str| -> Option<String> {
        let pin = match name {
            xai_hystersis_telemetry::external::config::ENV_MASTER_SWITCH => req_enabled,
    ...
    let mut resolved = xai_hystersis_telemetry::external::ExternalOtelConfig::resolve_with(
        getenv_pinned,
        file_cfg.as_ref(),
    )?;
...
pub(crate) fn apply_external_otel_remote_policy(
    ...
    let policy = xai_hystersis_telemetry::external::ExternalOtelRemotePolicy {
    ...
    if policy.force_disable || policy.lock_content_gates {
        xai_hystersis_telemetry::external::apply_remote_policy(policy);
    }
}
...
pub fn apply_remote_settings_side_effects(settings: Option<&crate::util::config::RemoteSettings>) {
    if let Some(s) = settings {
        ...
        xai_hystersis_config::signed_policy::apply_remote_managed_config_signature_verification(
...
fn managed_settings_env_flag(key: &str) -> Option<bool> {
    let path = xai_hystersis_config::claude_managed_settings_path()?;
    let content = std::fs::read_to_string(&path).ok()?;
    let json: serde_json::Value = serde_json::from_str(&content).ok()?;
    xai_hystersis_workspace::permission::resolution::json_env_flag(json.get("env"), key)
}
...
pub struct AutoModeConfig {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub prompt_type: Option<xai_hystersis_workspace::permission::ClassifierPromptType>,
...
pub(crate) fn enforce_disable_api_key_auth(
        ...
        && crate::util::is_xai_api_url(&creds.base_url)
    {
        ...
        xai_hystersis_telemetry::unified_log::debug(
...
pub use xai_hystersis_telemetry::config::deployment_id_from_key;
