    ...
    W: tokio::io::AsyncWrite + Unpin + Send + 'static,
{
    ...
    let workspace_user_dir = xai_hystersis_agent::prompt::workspace_user::optional_workspace_user_dir();
...
pub async fn run_stdio_agent(
    ...
    xai_hystersis_telemetry::unified_log::set_version(xai_hystersis_version::VERSION);
...
pub async fn run_leader(
    ...
    let control_state = LeaderServerControlState::new(LeaderServerMetadata {
        ...
        leader_binary_version: xai_hystersis_version::VERSION.to_string(),
    })
    ...
    local_set
        .run_until(async move {
            ...
            let initial_auth_key_hash = xai_hystersis_config::user_hystersis_home()
...
mod tests {
    ...
    fn embedded_otel_gate_keeps_a_session_user_fail_closed() {
        ...
        use xai_hystersis_telemetry::external::{
