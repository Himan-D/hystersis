...
pub(crate) use xai_hystersis_tools::implementations::hystersis_build::task::coordinator::{
    self, ChildCompletion, ChildControl, ChildRunOutput, LocalBoxFuture, StartedChild,
    SubagentProgress,
};
use xai_hystersis_tools::implementations::hystersis_build::task::types::{SubagentRequest, SubagentResult};
...
impl coordinator::ChildRunner for ShellChildRunner {
    ...
    type ValidateFuture = coordinator::LocalBoxFuture<
        xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentValidateTypeOutcome,
    >;
    type DescribeFuture = coordinator::LocalBoxFuture<
        xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentDescribeOutcome,
    >;
        ...
        Box::pin(async move {
            ...
            let Some(mut ctx) = this.try_build_subagent_spawn_context(&parent_sid) else {
                ...
                return coordinator::ChildRunOutput {
                    result: xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentResult {
                        success: false,
                        error: Some(
        ...
        Box::pin(async move {
            ...
            match this.try_build_subagent_spawn_context(&parent_session_id) {
                ...
                None => {
                    ...
                    xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentDescribeOutcome::Unavailable
                }
            }
        })
    }
...
fn log_limit_notice(notice: coordinator::SubagentLimitNotice) {
    ...
    xai_hystersis_telemetry::session_ctx::log_event(SubagentLimitHit::session_concurrent(
...
pub(crate) fn spawn_subagent_coordinator(
    ...
    >,
    limits: xai_hystersis_tools::implementations::hystersis_build::task::admission::SubagentLimits,
) {
    ...
    let config = coordinator::CoordinatorConfig {
        foreground_budget:
            xai_hystersis_tools::implementations::hystersis_build::task::backend::env_duration_or(
...
pub(crate) struct InjectParams<'a> {
    ...
    pub task_completion_reservations:
        &'a Option<xai_hystersis_tools::reminders::task_completion::TaskCompletionReservations>,
...
pub(crate) fn inject_subagent_completed_prompt(params: InjectParams) {
    ...
    let summary =
        xai_hystersis_tools::implementations::hystersis_build::task::completion_summary(request, result);
    let message = xai_hystersis_tools::reminders::task_completion::format_subagent_completion(
        &summary,
        Some(task_output_tool_name),
    );
    let wrapped = xai_hystersis_tools::reminders::wrap_reminder(&message);
