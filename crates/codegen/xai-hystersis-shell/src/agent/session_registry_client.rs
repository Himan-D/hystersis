...
impl SessionRegistryClient {
    ...
    /// [`xai_hystersis_auth::StampedBearerSuffix`] for why never a re-resolution).
    fn record_401_attribution(&self, op: &str, stamp: Option<&xai_hystersis_auth::StampedBearerSuffix>) {
