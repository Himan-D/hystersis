...
use xai_hystersis_tools::implementations::hystersis_build::task::backend::SubagentBackend;
...
impl MvpAgent {
        ...
        self.auth_manager
            ...
            .or_else(|| {
                if self.is_session_based_auth() {
                    ...
                    if auth.is_some() {
                        xai_hystersis_telemetry::unified_log::info(
    ...
    pub(super) fn ensure_telemetry_client(&self) {
        ...
        if !mode.is_disabled() {
            ...
            xai_hystersis_telemetry::client::init_if_needed(
                cfg.telemetry.clone(),
                mode,
                user_id,
                team_id,
                ...
                xai_hystersis_version::VERSION.to_owned(),
                subscription_tier,
    ...
    pub(crate) fn plugin_registry_handle(
        &self,
    ) -> &xai_hystersis_agent::plugins::SharedPluginRegistryHandle {
    ...
    fn arm_local_workspace_watcher(
        ...
        let auth_path = xai_hystersis_workspace::hub_auth::default_auth_path().ok();
    ...
    fn ensure_local_workspace_ops(
        &self,
    ) -> Result<xai_hystersis_workspace::WorkspaceOps, acp::Error> {
        ...
        let workspace_identity = self
            ...
            .map(|a| match a.team_id.filter(|t| !t.is_empty()) {
                Some(team) => {
                    xai_hystersis_workspace::WorkspaceIdentity::team(a.user_id, team)
                }
                None => {
                    xai_hystersis_workspace::WorkspaceIdentity::new(
                        a.user_id,
                        a.principal_type,
                        a.principal_id,
                    )
            ...
            .unwrap_or_default();
        let ops = match xai_hystersis_workspace::handle::WorkspaceHandle::new_minimal(
            cwd.to_path_buf(),
            workspace_identity,
            project_lsp_trusted,
        ) {
            Ok(handle) => xai_hystersis_workspace::WorkspaceOps::local(handle),
            Err(e) => {
                tracing::error!(
                    error = %e,
    ...
    pub(super) async fn authenticate_after_cached_token_unavailable(
        ...
        let Some(method_id) = self.cached_token_fallthrough_method_id() else {
            ...
            xai_hystersis_telemetry::unified_log::warn(
    ...
    pub(super) async fn refresh_remote_settings(&self, auth: &crate::auth::HystersisAuth) {
        ...
        xai_hystersis_telemetry::client::init(
            telemetry_config,
            telemetry_mode,
            hystersis_user_id,
            hystersis_team_id,
    ...
    pub(super) fn apply_polled_announcements(
        ...
        pre_fetch: Option<Vec<xai_hystersis_announcements::RemoteAnnouncement>>,
    ) {
        let mut cfg = self.cfg.borrow_mut();
    ...
    pub(super) fn prepare_image_gen_config(
        &self,
    ) -> xai_hystersis_tools::implementations::hystersis_build::image_gen::ImageGenConfig {
        ...
        let version = cfg
            .client_version
            .clone()
            .unwrap_or_else(|| xai_hystersis_version::VERSION.to_string());
        let alpha_test_key = cfg.endpoints.alpha_test_key.clone();
    ...
    pub(super) fn prepare_app_builder_deployer_config(
        &self,
    ) -> xai_hystersis_tools::implementations::hystersis_build::app_builder::AppBuilderDeployerConfig {
        use xai_hystersis_tools::implementations::hystersis_build::app_builder::AppBuilderDeployerConfig;
    ...
    pub(super) fn prepare_video_gen_config(
        &self,
    ) -> xai_hystersis_tools::implementations::hystersis_build::video_gen::VideoGenConfig {
    ...
    pub(super) fn prepare_web_fetch_config(
        &self,
    ) -> xai_hystersis_tools::implementations::hystersis_build::web_fetch::WebFetchConfig {
        use xai_hystersis_tools::implementations::hystersis_build::web_fetch::WebFetchConfig;
        let cfg = self.cfg.borrow();
    ...
    pub fn with_models(
        ...
        let instance = Self {
            ...
            plugin_registry_handle: xai_hystersis_agent::plugins::SharedPluginRegistryHandle::new(
                None,
            ...
            monitor_event_buffer: xai_hystersis_tools::implementations::hystersis_build::monitor::types::MonitorEventBuffer::default(),
    ...
    pub(crate) async fn kill_background_task(
        ...
        session_id: &str,
        task_id: &str,
        source: xai_hystersis_tools::types::KillSource,
    ) -> Result<xai_hystersis_tools::types::KillOutcome, String> {
        let sid = acp::SessionId::new(session_id);
        if let Some(handle) = self.get_session_handle(&sid) {
    ...
    pub(crate) async fn cancel_subagent(
        &self,
        subagent_id: &str,
    ) -> xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentCancelOutcome {
        xai_hystersis_tools::implementations::hystersis_build::task::backend::ChannelBackend::new(
    ...
    pub(crate) async fn list_running_subagents(
        ...
        xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentInspection,
    > {
        let backend = xai_hystersis_tools::implementations::hystersis_build::task::backend::ChannelBackend::new(
            self.subagent_event_tx.clone(),
        );
    ...
    pub(crate) async fn query_subagent(
        ...
        xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentSnapshot,
    > {
        xai_hystersis_tools::implementations::hystersis_build::task::backend::ChannelBackend::new(
                self.subagent_event_tx.clone(),
            )
    ...
    pub async fn list_tasks(
        &self,
        session_id: &str,
    ) -> Option<Vec<xai_hystersis_tools::types::TaskSnapshot>> {
        let sid = acp::SessionId::new(session_id);
        if let Some(handle) = self.get_session_handle(&sid) {
    ...
    pub(crate) async fn execute_hooks_action(
            ...
            && let Some(cwd) = self.get_session_cwd(session_id)
        {
            self.interactive_trust_prompted
                .borrow_mut()
                .remove(&xai_hystersis_workspace::trust::workspace_key(&cwd));
        }
        let handle = self.get_session_handle(session_id)?;
    ...
    pub(crate) fn plugin_registry_snapshot(
        &self,
    ) -> Option<std::sync::Arc<xai_hystersis_agent::plugins::PluginRegistry>> {
    ...
    pub(super) async fn upload_harness_trace_turns(
        ...
        model: &str,
        turns: Vec<Vec<xai_hystersis_sampling_types::conversation::ConversationItem>>,
    ) {
    ...
    pub(super) async fn build_harness_trace_uploads(
        ...
        for (offset, items) in turns.into_iter().enumerate() {
            ...
            let metadata = PromptMetadata::new(PromptMetadataParams {
                ...
                shell_version: Some(xai_hystersis_version::VERSION.to_string()),
    ...
    pub(crate) async fn get_trace_context(
        ...
        let upload_method = match upload_method {
            Some(method) => method,
            None => {
                xai_hystersis_telemetry::session_ctx::log_session_event(crate::agent::session_metrics::TraceUploadSkipped {
    ...
    /// [`xai_hystersis_agent::config::is_strict_harness_agent_type`].
    ///
    ...
    pub fn resolve_agent_definition(
        ...
        acp_agent_profile: Option<xai_hystersis_agent::AgentDefinition>,
        model_agent_type: Option<&str>,
    ) -> xai_hystersis_agent::AgentDefinition {
        use xai_hystersis_agent::AgentDefinition;
        ...
        let model_requires_strict_harness = model_agent_type
            .is_some_and(xai_hystersis_agent::config::is_strict_harness_agent_type);
        if !hystersis_agent_env_set && !config_agent_explicitly_set
            && model_requires_strict_harness && let Some(required) = model_agent_type
            && let Some(def) = xai_hystersis_agent::discovery::by_name_in_cwd(required, cwd)
        {
            tracing::info!(
                agent_name = %def.name,
        ...
        if let Some(ref name) = agent_config.name {
            ...
            if let Some(def) = xai_hystersis_agent::discovery::by_name_in_cwd(name, cwd) {
                return def;
            }
            tracing::warn!(
                agent_name = %name,
        ...
        let resolved = match agent_name.as_deref() {
            ...
            Some(name) => {
                xai_hystersis_agent::discovery::by_name_in_cwd(name, cwd)
            ...
            && resolved.name != required
        {
            ...
            if let Some(def) = xai_hystersis_agent::discovery::by_name_in_cwd(required, cwd) {
                return def;
            }
            tracing::warn!(
                model_agent_type = %required,
    ...
    pub(super) fn resolve_status_line_capability(
        ...
        meta.and_then(|m| m.get(xai_hystersis_status_line::CLIENT_STATUS_LINE_META))
            .or_else(|| {
                init
                    .client_capabilities
                    .meta
                    .as_ref()
                    .and_then(|m| m.get(xai_hystersis_status_line::STATUS_LINE_CAPABILITY))
            })
    ...
    pub(super) async fn spawn_and_register_session(
        ...
        let envrc = envrc
            .unwrap_or_else(|| xai_hystersis_workspace::envrc::spawn_envrc_load(
        ...
        let fs: Arc<dyn xai_hystersis_workspace::file_system::AsyncFileSystem> = if use_acp_fs {
        ...
        let mut session_env = xai_hystersis_workspace::permission::claude_settings::load_claude_env_with_project(
            cwd.as_path(),
            project_env_trusted,
        );
        ...
        let pinned_model: Option<(acp::ModelId, ModelEntry)> = match &agent_definition
            .model
        {
            xai_hystersis_agent::config::ModelOverride::Override(id) => {
            ...
            xai_hystersis_agent::config::ModelOverride::Inherit => None,
        };
        ...
        if lsp_tools_enabled && tool_ctx.lsp.is_none() {
            ...
            let (
                ...
                .unzip();
            let sourced = xai_hystersis_tools::implementations::lsp::config::load_servers_with_plugins_sourced(
            ...
            if servers.is_empty() {
                let user_path = xai_hystersis_tools::util::hystersis_home::hystersis_home()
                    .join("lsp.json");
                ...
                use xai_hystersis_tools::implementations::lsp::{
                ...
                let mgr = std::sync::Arc::new(
                    tokio::sync::Mutex::new(
                        LspManager::new(
                                ...
                                true,
                                xai_hystersis_tools::notification::ToolNotificationHandle::noop(),
                            )
        ...
        let (mut handle, permission_events_rx, agent_system_prompt, session_thread) = {
            ...
            let attribution_callback: Option<
                xai_hystersis_sampler::SharedAttributionCallback,
            > = Some(
            ...
            let agent_hook_registry_override = agent_definition
                ...
                .and_then(|hooks_config| {
                    ...
                    let (specs, errors) = xai_hystersis_hooks::config::parse_hooks_from_value_with_dir(
                        &hooks_val,
                        &format!(
                        "{}{}",
                        xai_hystersis_hooks::config::AGENT_HOOK_PREFIX,
                    ...
                    let git_root = xai_hystersis_workspace::session::git::find_git_root_from_path(
                            cwd,
                        )
                        .ok();
            ...
            spawn_session_on_thread(
                    ...
                    subagent_toggle,
                    Vec::new(),
                    xai_hystersis_agent::prompt::context::PromptAudience::Primary,
                    None,
                    None,
                    disable_web_search,
