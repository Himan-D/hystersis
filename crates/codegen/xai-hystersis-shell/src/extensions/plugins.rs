...
pub(crate) fn loaded_plugin_to_info(plugin: &xai_hystersis_agent::plugins::LoadedPlugin) -> PluginInfo {
    use xai_hystersis_agent::plugins::discovery::PluginScope as AgentScope;
...
fn origin_to_dto(origin: &xai_hystersis_agent::plugins::PluginOrigin) -> PluginOrigin {
    use xai_hystersis_agent::plugins::PluginOrigin as AgentOrigin;
    match origin {
...
mod tests {
    use super::*;
    use xai_hystersis_agent::plugins::PluginOrigin as AgentOrigin;
    use xai_hystersis_agent::plugins::discovery::{PluginId, PluginScope as AgentScope};

    fn make_loaded_plugin(origin: AgentOrigin) -> xai_hystersis_agent::plugins::LoadedPlugin {
        let root = std::path::PathBuf::from("/tmp/test-plugin");
        xai_hystersis_agent::plugins::LoadedPlugin {
