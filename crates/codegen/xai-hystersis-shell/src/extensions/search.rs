...
use xai_hystersis_workspace::file_system::ContentSearchRequest as ContentSearchRequestParams;
use xai_hystersis_workspace::workspace_ops::{FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq};
...
pub async fn handle(agent: &MvpAgent, args: &acp::ExtRequest) -> ExtResult {
    match args.method.as_ref() {
        "hystersis.com/search/fuzzy/open" => {
        ...
        "hystersis.com/search/fuzzy/close" => {
        ...
        "hystersis.com/search/content" => {
            ...
            // `hystersis.com/search/content/status` batches through the client sink.
