...
pub async fn handle(agent: &MvpAgent, args: &acp::ExtRequest) -> ExtResult {
    match args.method.as_ref() {
        ...
        "hystersis.com/terminal/wait_for_exit" => {
            let req: TerminalIdRequest = parse(args)?;
        ...
        "hystersis.com/terminal/release" => {
            let req: TerminalIdRequest = parse(args)?;
        ...
        "hystersis.com/terminal/pty/create" => {
        ...
        "hystersis.com/terminal/pty/load" => {
        ...
        "hystersis.com/terminal/pty/resize" => {
