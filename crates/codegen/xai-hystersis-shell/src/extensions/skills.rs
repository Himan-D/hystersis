...
use xai_hystersis_agent::prompt::skills::{
...
fn discover_auto_sources(cwd: &str, skills: &[SkillInfo]) -> Vec<(String, usize)> {
    ...
    for subdir in &subdirs {
        try_add_source(hystersis_home.join(subdir), None);
    }
...
pub async fn handle(
    ...
    match args.method.as_ref() {
        "hystersis.com/skills/add" => {
            ...
            .await
            {
                xai_hystersis_telemetry::session_ctx::log_event(
                    xai_hystersis_telemetry::events::SkillAdded {
                        added_count: 0,
                        total_skills: 0,
                        success: false,
                    },
            ...
            xai_hystersis_telemetry::session_ctx::log_event(xai_hystersis_telemetry::events::SkillAdded {
        ...
        "hystersis.com/skills/remove" => {
            ...
            {
                xai_hystersis_telemetry::session_ctx::log_event(
                    xai_hystersis_telemetry::events::SkillRemoved { success: false },
                );
            ...
            xai_hystersis_telemetry::session_ctx::log_event(xai_hystersis_telemetry::events::SkillRemoved {
                success: true,
            });
