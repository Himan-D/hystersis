//! `hystersis.com/memory/flush`, `hystersis.com/memory/rewrite`, and `hystersis.com/compact_conversation`
//! extension handlers.
//!
...
pub async fn handle(agent: &MvpAgent, args: &acp::ExtRequest) -> ExtResult {
    match args.method.as_ref() {
        m if m.starts_with("hystersis.com/compact_conversation") => handle_compact(agent, args).await,
        "hystersis.com/memory/flush" => handle_flush(agent, args).await,
        "hystersis.com/memory/rewrite" => handle_rewrite(agent, args).await,
