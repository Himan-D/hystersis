...
pub async fn handle(
    ...
    match args.method.as_ref() {
        ...
        "hystersis.com/git/worktree/create_from_worktree" => {
            ...
            let result = ops
                .dispatch(
                    &xai_hystersis_workspace::workspace_ops::PrepareWorktreeFromWorktreeReq {
                        inner: req.clone(),
                    },
                    None,
                )
        ...
        "hystersis.com/git/worktree/create_from_worktree_sync" => {
            ...
            let resolved_root = ops
                .dispatch(
                    &xai_hystersis_workspace::workspace_ops::GitResolveRootReq {
            ...
            if let Some(git_root) = resolved_root {
                let vcs_kind = ops
                    .dispatch(
                        &xai_hystersis_workspace::workspace_ops::DetectVcsKindReq {
                            path: git_root.clone(),
                        },
                        None,
                    )
                    .await
                    .unwrap_or(xai_hystersis_workspace::session::git::VcsKind::Git);
                if vcs_kind.is_jj() {
            ...
            let result = ops
                .dispatch(
                    &xai_hystersis_workspace::workspace_ops::CreateWorktreeFromWorktreeSyncReq {
                        inner: req.into_wire(),
                    },
                    None,
                )
        ...
        "hystersis.com/git/worktree/resume_session" => {
            ...
            let agent_id = xai_hystersis_telemetry::id::agent_id();
        ...
        "hystersis.com/git/worktree/list" => {
            let req: xai_hystersis_workspace::workspace_ops::WorktreeListReq =
        ...
        "hystersis.com/git/worktree/show" => {
            ...
            let op = xai_hystersis_workspace::workspace_ops::WorktreeShowReq {
        ...
        "hystersis.com/git/worktree/gc" => {
            ...
            let op = xai_hystersis_workspace::workspace_ops::WorktreeGcReq {
                dry_run: req.dry_run,
                max_age_secs,
                force: req.force,
            };
        ...
        "hystersis.com/git/worktree/db/stats" => {
            let result = ops
                .dispatch(
                    &xai_hystersis_workspace::workspace_ops::WorktreeDbStatsReq {},
                    None,
                )
                .await
                .map_err(|e| acp::Error::internal_error().data(e.to_string()))?;
        ...
        "hystersis.com/git/worktree/db/rebuild" => {
            let result = ops
                .dispatch(
                    &xai_hystersis_workspace::workspace_ops::WorktreeDbRebuildReq {},
                    None,
                )
                .await
                .map_err(|e| acp::Error::internal_error().data(e.to_string()))?;
        ...
        "hystersis.com/git/worktree/db/path" => {
            let result = ops
                .dispatch(
                    &xai_hystersis_workspace::workspace_ops::WorktreeDbPathReq {},
                    None,
                )
                .await
                .map_err(|e| acp::Error::internal_error().data(e.to_string()))?;
        ...
        "hystersis.com/git/worktree/detach" => {
            ...
            let result = ops
                .dispatch(
                    &xai_hystersis_workspace::workspace_ops::WorktreeDetachReq {
                        id_or_path: req.id_or_path,
        ...
        "hystersis.com/git/worktree/salvage" => {
            ...
            let result = ops
                .dispatch(
                    &xai_hystersis_workspace::workspace_ops::WorktreeSalvageReq {
                        id_or_path: req.id_or_path,
                        out: req.out,
                    },
                    None,
        ...
        "hystersis.com/git/worktree/clean-artifacts" => {
            ...
            let result = ops
                .dispatch(
                    &xai_hystersis_workspace::workspace_ops::WorktreeCleanArtifactsReq {
                        id_or_path: req.id_or_path,
                    },
                    None,
                )
