...
impl AuthManager {
    ...
    async fn exchange_refresh_token(
        ...
        let outcome = {
            ...
            let _awake = if self.is_dark_wake() {
                ...
                xai_system_power::hold_awake("hystersis: OIDC token refresh")
            } else {
                None
            };
    ...
    pub(super) async fn revalidate_lock_or_reacquire(
        ...
        xai_hystersis_telemetry::session_ctx::log_event(
            xai_hystersis_telemetry::events::AuthLockReplacedOutFromUnder {
