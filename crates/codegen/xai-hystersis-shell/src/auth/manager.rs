...
use xai_hystersis_auth::bearer_suffix;
...
use xai_hystersis_telemetry::events::ManualAuthSurface;
...
impl AuthManager {
    ...
    pub(crate) async fn update(self: &Arc<Self>, auth: HystersisAuth) -> std::io::Result<HystersisAuth> {
        ...
        match &write_result {
            Ok(()) => xai_hystersis_telemetry::unified_log::info(
            ...
            Err(e) => xai_hystersis_telemetry::unified_log::error(
    ...
    pub(crate) async fn try_devbox_recovery(
        ...
        xai_hystersis_telemetry::unified_log::info("auth: devbox recovery starting", None, None);
    ...
    #[cfg(test)]
    pub(crate) fn manual_auth_last_emit(&self) -> Option<xai_hystersis_telemetry::events::ManualAuth> {
...
impl xai_hystersis_tools::types::ApiKeyProvider for SharedAuthKeyProvider {
...
) -> xai_hystersis_tools::types::SharedApiKeyProvider {
