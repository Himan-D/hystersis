...
impl TokenType {
    ...
    pub(crate) fn from_auth(auth: Option<&HystersisAuth>) -> Self {
        match auth {
            None => Self::None,
    ...
    pub(crate) fn telemetry_kind(self) -> xai_hystersis_telemetry::events::AuthTokenKind {
        use xai_hystersis_telemetry::events::AuthTokenKind as K;
        match self {
