...
//! `xai_hystersis_sampling_types` plus hystersis-shell-specific additions.

use std::collections::HashSet;

pub use xai_hystersis_sampling_types::conversation::*;
...
/// through its blanket impl. Lives in hystersis-shell because it references
...
/// `count_complete_turns` in `xai-hystersis-subagent-resolution/src/context.rs`.
