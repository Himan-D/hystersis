...
pub(crate) const ENV_REMEMBER_TOOL_APPROVALS: &str = "HYSTERSIS_REMEMBER_TOOL_APPROVALS";
...
/// shown. Precedence: requirements > env (`HYSTERSIS_REMEMBER_TOOL_APPROVALS`) >
...
mod remember_tool_approvals_gate_tests {
    ...
    // `HYSTERSIS_REMEMBER_TOOL_APPROVALS` is process-global; serialize and force it
