...
pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "HYSTERSIS_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "HYSTERSIS_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`HYSTERSIS_MIN_DRAW_MS` / `HYSTERSIS_SCROLL_CADENCE_MS`).
