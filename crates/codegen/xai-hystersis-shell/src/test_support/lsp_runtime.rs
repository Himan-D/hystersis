...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        fs: Arc::new(xai_hystersis_workspace::file_system::LocalFs::new(
            PathBuf::from("/tmp"),
        )),
        ...
        parent_skills: None,
        parent_skills_config: xai_hystersis_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: xai_hystersis_tools::types::compat::CompatConfig::default(),
        task_completion_reservations: None,
        synthetic_trace_tx: None,
        task_output_tool_name: xai_hystersis_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
