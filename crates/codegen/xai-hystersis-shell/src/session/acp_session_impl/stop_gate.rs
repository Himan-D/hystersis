...
use xai_hystersis_hooks::{dispatcher, result};
...
/// `description` instead.
fn stop_entry_from_task(task: &xai_hystersis_tools::types::TaskSnapshot) -> StopBackgroundTask {
    let command_text =
...
fn stop_entry_from_subagent(
    summary: &xai_hystersis_tools::implementations::hystersis_build::task::types::ActiveSubagentSummary,
) -> StopBackgroundTask {
    StopBackgroundTask {
...
fn stop_cron_from_scheduled(
    task: &xai_hystersis_tools::implementations::hystersis_build::scheduler::types::ScheduledTask,
) -> StopSessionCron {
    StopSessionCron {
        id: task.id.clone(),
        schedule:
            xai_hystersis_tools::implementations::hystersis_build::scheduler::interval::interval_to_human(
                task.interval_secs,
            ),
...
impl SessionActor {
    ...
    pub(crate) async fn list_active_subagents(
        &self,
    ) -> Vec<xai_hystersis_tools::implementations::hystersis_build::task::types::ActiveSubagentSummary> {
    ...
    pub(super) async fn run_stop_gate(
        ...
        // `fire_hook`: client hooks get the awaited `hystersis.com/hooks/run` request
...
mod stop_gate_snapshot_tests {
    ...
    fn task_snapshot(
        kind: xai_hystersis_tools::computer::types::TaskKind,
    ...
    fn subagent_summary_maps_to_stop_entry() {
        let summary =
            xai_hystersis_tools::implementations::hystersis_build::task::types::ActiveSubagentSummary {
    ...
    fn scheduled_task_maps_to_stop_cron() {
        let task =
            xai_hystersis_tools::implementations::hystersis_build::scheduler::types::ScheduledTask::new(
                300,
