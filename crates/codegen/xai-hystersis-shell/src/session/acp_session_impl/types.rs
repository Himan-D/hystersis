...
pub(crate) enum SamplerFailureRecovery {
    ...
    RefreshAuthAndResubmit {
        credential: xai_hystersis_sampling_types::SentCredential,
...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<xai_hystersis_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(xai_hystersis_tools::implementations::hystersis_build::update_goal::UpdateGoalInput),
    Channel(xai_hystersis_tools::implementations::hystersis_build::update_goal::UpdateGoalEnvelope),
}
