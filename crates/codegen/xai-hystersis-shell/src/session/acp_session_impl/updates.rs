...
mod inbound_summary_persist_scrub_tests {
    ...
    use crate::session::persistence::MAX_TITLE_SCALARS;
    /// Drive inbound `_hystersis.com/session/update` through `handle_xai_session_notification`
...
impl SessionActor {
        ...
        match &notification.update {
            XaiSessionUpdate::SubagentSpawned {
                ...
                let envelope = self.fire_hook(
                    xai_hystersis_hooks::event::HookEventName::SubagentStart,
                    None,
                    xai_hystersis_hooks::event::HookPayload::SubagentStart {
                ...
                if let Some(registry) = hook_registry_snapshot {
                    ...
                    let _ = xai_hystersis_hooks::dispatcher::dispatch_non_blocking(
                        &registry,
                        xai_hystersis_hooks::event::HookEventName::SubagentStart,
                        &envelope,
                        &ctx,
    ...
    pub(super) async fn dispatch_notification_hook(
        ...
        let envelope = self.fire_hook(
            ...
            None,
            xai_hystersis_hooks::event::HookPayload::Notification {
