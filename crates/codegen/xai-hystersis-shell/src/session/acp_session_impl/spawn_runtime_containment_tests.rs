...
const CHILD_ENV: &str = "XAI_HYSTERSIS_SHELL_RUNTIME_CONTAINMENT_CHILD";
const BLOCKING_POOL_CHILD_ENV: &str = "XAI_HYSTERSIS_SHELL_BLOCKING_POOL_CONTAINMENT_CHILD";
