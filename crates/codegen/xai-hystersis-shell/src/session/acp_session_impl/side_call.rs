...
impl From<&xai_hystersis_sampling_types::TokenUsage> for PromptCacheUsage {
    fn from(usage: &xai_hystersis_sampling_types::TokenUsage) -> Self {
...
pub(crate) fn log_prompt_cache_usage(
    ...
    response: &xai_hystersis_sampling_types::ConversationResponse,
) {
...
pub(crate) struct AuxCall {
    ...
    pub(crate) hosted_tools: Vec<xai_hystersis_sampling_types::HostedTool>,
    pub(crate) model: String,
    /// Must match the main turn's, or the prompt differs before the conversation history even starts.
    pub(crate) reasoning_effort: Option<xai_hystersis_sampling_types::ReasoningEffort>,
...
pub(crate) struct SideCallSetup {
    pub(crate) client: xai_hystersis_sampler::SamplingClient,
