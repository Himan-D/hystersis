...
use xai_hystersis_mcp::elicitation::{
    ElicitationInbox, ElicitationJob, cancel_result, elicit_result_from_wire,
};
use xai_hystersis_mcp::wire::MCP_ELICIT;
use xai_hystersis_tools::mcp_elicitation::{McpElicitExtRequest, McpElicitExtResponse};
...
mod tests {
    use super::*;
    use xai_hystersis_mcp::elicitation::wire_mode_and_fields;
    use xai_hystersis_mcp::rmcp::model::{
