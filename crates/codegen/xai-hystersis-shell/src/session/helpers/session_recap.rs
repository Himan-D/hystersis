...
mod tests {
    ...
    fn main_turn_count_counts_real_users_only() {
        use std::sync::Arc;
        use xai_hystersis_sampling_types::{ContentPart, SyntheticReason, ToolCall, UserItem};
    ...
    fn mk_tool_call(id: &str, args: &str) -> xai_hystersis_sampling_types::ToolCall {
        use std::sync::Arc;
        xai_hystersis_sampling_types::ToolCall {
            id: Arc::from(id),
            name: "read_file".into(),
