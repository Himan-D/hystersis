...
//! shell-specific types (`xai_hystersis_tools::MemoryBackend`, memory context).
//!
...
//! [`xai_hystersis_compaction::reminder`] so hystersis-chat and hystersis stay in lockstep.
...
use xai_hystersis_compaction::reminder::{
...
pub fn to_system_reminder_sync(
    ...
    skills: &[xai_hystersis_tools::implementations::skills::types::SkillInfo],
...
pub async fn to_system_reminder(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[xai_hystersis_tools::implementations::skills::types::SkillInfo],
    memory_backend: Option<&dyn xai_hystersis_tools::types::memory_backend::MemoryBackend>,
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
    workflow_listing: Option<&str>,
) -> Option<String> {
...
fn to_system_reminder_inner(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[xai_hystersis_tools::implementations::skills::types::SkillInfo],
    memory_results: &[xai_hystersis_tools::types::memory_backend::MemorySearchResult],
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
    workflow_listing: Option<&str>,
) -> Option<String> {
    ...
    if let Some(listing) =
        xai_hystersis_tools::types::skill_discovery_tracker::format_compaction_skill_listing(skills)
    {
    ...
    if !ctx.connected_mcp_servers.is_empty() {
        use xai_hystersis_tools::implementations::search_tool::format_compaction_server_line;
...
- linear (12 tools)
    ...
    fn system_reminder_places_workflows_below_skills() {
        ...
        let skills = [xai_hystersis_tools::implementations::skills::types::SkillInfo {
            name: "commit".into(),
