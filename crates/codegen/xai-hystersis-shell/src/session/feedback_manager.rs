...
pub(crate) fn new_submission(
    ...
    s.shell_version = Some(xai_hystersis_version::VERSION.to_string());
    s
}
...
pub(crate) async fn submit_feedback_workflow(
    ...
    if telemetry_enabled {
        ...
        xai_hystersis_telemetry::session_ctx::log_event(xai_hystersis_telemetry::events::UserFeedback {
...
mod tests {
    ...
    fn test_shutdown_budgets_fit_under_session_flush_grace() {
        ...
        let _unset = xai_hystersis_test_support::env::EnvGuard::unset("HYSTERSIS_SESSION_EXIT_DRAIN_SECS");
        assert!(
    ...
    fn test_nonempty_drain_budget_env_raises_cap() {
        {
            let _guard =
                xai_hystersis_test_support::env::EnvGuard::set("HYSTERSIS_SESSION_EXIT_DRAIN_SECS", "7");
            assert_eq!(
                nonempty_drain_budget(Duration::from_secs(30)),
        ...
        {
            let _guard =
                xai_hystersis_test_support::env::EnvGuard::set("HYSTERSIS_SESSION_EXIT_DRAIN_SECS", "99");
            assert_eq!(
                nonempty_drain_budget(Duration::from_secs(30)),
...
mod author_identity_tests {
    ...
    async fn env_var_identity_reaches_the_wire_end_to_end() {
        let _email =
            xai_hystersis_test_support::env::EnvGuard::set("HYSTERSIS_TEST_WORK_EMAIL", "ada@corp.example");
        let _name =
            xai_hystersis_test_support::env::EnvGuard::set("HYSTERSIS_TEST_WORK_NAME", "Ada Lovelace");
...
"#,
    ...
    async fn workflow_merges_user_metadata_into_submission() {
        let _guard = xai_hystersis_test_support::env::EnvGuard::set(
