...
impl WorkflowManager {
    ...
    pub(crate) fn launch(
        ...
        let active = xai_hystersis_telemetry::activity::WORKFLOW_RUNS_ACTIVE.enter();
        debug_assert!(
            xai_hystersis_telemetry::activity::WORKFLOW_RUNS_ACTIVE.get() >= 1,
            ...
            if !epoch_matches {
                ...
                log_run_ended(
                    RunEndMetadata {
                        ...
                        status: xai_hystersis_telemetry::events::WorkflowRunEndStatus::Superseded,
                        duration_ms: elapsed,
                        agents_used,
                        agent_budget,
                    },
            ...
            if state.is_none() {
                ...
                log_run_ended(
                    RunEndMetadata {
                        run_id: &watcher_run_id,
                        parent_session_id: &watcher_session_id,
                        status: xai_hystersis_telemetry::events::WorkflowRunEndStatus::Interrupted,
                        duration_ms: 0,
                        agents_used: 0,
                        agent_budget: None,
                    },
    ...
    fn cancel_children_for_run(&self, run_id: &str) -> bool {
        ...
        self.subagent_event_tx
            .send(
                xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentEvent::Cancel(
                    xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentCancelRequest {
                        parent_session_id: Some(self.session_id.clone()),
                        target: xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentCancelTarget::WorkflowRunId(
                            run_id.to_owned(),
                        ),
                        respond_to,
                    },
...
fn log_run_started(
    ...
    use xai_hystersis_telemetry::events::{WorkflowRunStarted, WorkflowSourceKind};
    xai_hystersis_telemetry::session_ctx::log_event(WorkflowRunStarted {
...
struct RunEndMetadata<'a> {
    ...
    status: xai_hystersis_telemetry::events::WorkflowRunEndStatus,
    duration_ms: u64,
    agents_used: u64,
...
fn log_run_ended(episode: RunEndMetadata<'_>, stats: &super::host_service::WorkflowAgentStats) {
    xai_hystersis_telemetry::session_ctx::log_event(xai_hystersis_telemetry::events::WorkflowRunEnded {
...
) -> xai_hystersis_telemetry::events::WorkflowRunEndStatus {
    use crate::session::workflow::tracker::WorkflowRunStatus as S;
    use xai_hystersis_telemetry::events::WorkflowRunEndStatus as E;
    match status {
        S::Active => E::Active,
...
mod tests {
    ...
    type CancelLog = Arc<
        parking_lot::Mutex<
            Vec<xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentCancelTarget>,
        >,
    >;
    ...
    ) -> xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentSpawnRequest {
        use xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentEvent;
    ...
    fn complete_spawn(
        req: xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentSpawnRequest,
    ) {
        use xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentResult;
        let id = req.id.clone();
    ...
    async fn workflow_spawns_await_to_completion() {
        ...
        assert_eq!(
            ...
            xai_hystersis_tools::implementations::hystersis_build::task::types::ModelOverrideProvenance::Tool,
