...
pub(crate) struct WorkflowHostParams {
    ...
    pub effort: Option<xai_hystersis_sampling_types::ReasoningEffort>,
        ...
        match self.agent_slots.try_acquire() {
            ...
            Err(tokio::sync::TryAcquireError::NoPermits) => {
                ...
                xai_hystersis_telemetry::session_ctx::log_event(
                    xai_hystersis_telemetry::events::SubagentLimitHit::workflow_run_concurrent(
...
mod tests {
    ...
    async fn a_run_keeps_at_most_max_concurrent_agents_live() {
        ...
        let succeed = |spawn: xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentSpawnRequest| {
            spawn
                .respond_with(|request| {
                    xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentResult {
                        success: true,
