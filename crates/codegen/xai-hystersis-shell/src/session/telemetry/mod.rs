...
use xai_hystersis_telemetry::events::SessionHarness;
...
pub(crate) fn skill_source_label(skill_path: &str, cwd: &str) -> &'static str {
    ...
    let user = crate::util::hystersis_home::hystersis_home()
        .parent()
...
pub(crate) fn format_hook_name(spec: &xai_hystersis_hooks::config::HookSpec) -> String {
...
fn format_hook_source(spec: &xai_hystersis_hooks::config::HookSpec) -> &'static str {
    use xai_hystersis_hooks::config::HookOrigin as O;
    match xai_hystersis_hooks::config::hook_origin(spec) {
...
impl HookRegInfo {
    pub(crate) fn from_spec(spec: &xai_hystersis_hooks::config::HookSpec) -> Self {
        Self {
...
pub(crate) struct SessionHarnessMetrics {
    ...
    pub permission_mode: xai_hystersis_telemetry::enums::PermissionMode,
    pub mcp_server_names: Vec<String>,
    pub lsp_server_names: Vec<String>,
    pub memory_enabled: bool,
    pub memory_retrieval_mode: xai_hystersis_telemetry::events::MemoryRetrievalMode,
    ...
    pub compat: xai_hystersis_tools::types::compat::CompatConfig,
...
impl SessionHarnessMetrics {
    pub(crate) async fn into_event(self, hooks: Vec<HookRegInfo>) -> SessionHarness {
        ...
        let agents_md_dir_names = xai_hystersis_agent::prompt::agents_md::read_agents_config_with_paths(
            &self.cwd,
            self.compat,
        )
        .await
        ...
        SessionHarness {
            ...
            is_git_repo: xai_hystersis_telemetry::context::collect_git_context(&self.cwd).is_git_repo,
...
mod is_same_skill_file_tests {
    ...
    fn matches_identical_paths() {
        assert!(is_same_skill_file(
            Path::new("/home/u/.hystersis/skills/review/SKILL.md"),
            Path::new("/home/u/.hystersis/skills/review/SKILL.md")
        ));
    }
    ...
    fn rejects_a_different_skill() {
        assert!(!is_same_skill_file(
            Path::new("/home/u/.hystersis/skills/review/SKILL.md"),
            Path::new("/home/u/.hystersis/skills/design/SKILL.md")
        ));
    }
