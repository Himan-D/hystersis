use xai_hystersis_telemetry::enums::PermissionMode;
...
mod permission_analytics_tests {
    ...
    use xai_hystersis_workspace::permission::{ClassifierSecurityFinding, reasons};
    ...
    fn prompt_outcome_covers_manager_vocabulary() {
        use xai_hystersis_workspace::permission::PromptOutcomeKind;
    ...
    fn prompt_outcome_detail_matches_manager_vocabulary() {
        use std::collections::BTreeSet;
        use xai_hystersis_telemetry::events::PermissionPromptOutcomeDetail;
        use xai_hystersis_workspace::permission::PromptOutcomeKind;
    ...
    fn classifier_source_enum_matches_manager_vocabulary() {
        use std::collections::BTreeSet;
        use xai_hystersis_workspace::permission::ClassifierSourceKind;
    ...
    fn classifier_verdict_enum_matches_manager_vocabulary() {
        use std::collections::BTreeSet;
        use xai_hystersis_workspace::permission::ClassifierVerdict;
