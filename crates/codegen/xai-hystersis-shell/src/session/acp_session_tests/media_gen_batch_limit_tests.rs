...
use xai_hystersis_tools::implementations::hystersis_build::image_gen::ImageGenTool;
use xai_hystersis_tools::media_gen_limits::DEFAULT_MAX_PARALLEL_IMAGE_GEN;
    ...
    local
        .run_until(async {
            ...
            *actor.agent.borrow_mut() = test_agent_with_tools(vec![
            ...
            let calls: Vec<xai_hystersis_sampling_types::ToolCall> = (0..over)
                .map(|i| xai_hystersis_sampling_types::ToolCall {
            ...
            let spam: Vec<xai_hystersis_sampling_types::ToolCall> = (0..DEFAULT_MAX_PARALLEL_IMAGE_GEN
                * 2)
                .map(|i| xai_hystersis_sampling_types::ToolCall {
            ...
            let under: Vec<xai_hystersis_sampling_types::ToolCall> = (0..DEFAULT_MAX_PARALLEL_IMAGE_GEN)
                .map(|i| xai_hystersis_sampling_types::ToolCall {
