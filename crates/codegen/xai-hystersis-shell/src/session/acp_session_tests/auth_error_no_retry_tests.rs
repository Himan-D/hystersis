...
/// attribution.
fn auth_error() -> xai_hystersis_sampler::SamplingErrorInfo {
    xai_hystersis_sampler::SamplingErrorInfo {
        kind: xai_hystersis_sampler::SamplingErrorKind::Auth,
...
fn model_not_found_error() -> xai_hystersis_sampler::SamplingErrorInfo {
    xai_hystersis_sampler::SamplingErrorInfo {
            kind: xai_hystersis_sampler::SamplingErrorKind::Api,
...
fn unauthorized_401_error() -> xai_hystersis_sampler::SamplingErrorInfo {
    xai_hystersis_sampler::SamplingErrorInfo {
            kind: xai_hystersis_sampler::SamplingErrorKind::Api,
            message: "Unauthorized (401) from https://cli-chat-proxy.hystersis.com/v1/responses: {\"error\":\"Invalid or expired credentials (auth_kind=bearer, x_xai_token_auth=xai-grok-cli, upstream=Unauthenticated, reason=no auth context)\"}".into(),
            status_code: Some(401),
            is_retryable: false,
            retry_after_secs: None,
            should_retry: None,
...
async fn set_session_model_invalidates_byok_memo_for_same_model_id() {
    ...
    local
        .run_until(async {
            ...
            let cfg = xai_hystersis_sampler::SamplerConfig {
...
async fn sampler_non_auth_kind_401_on_provider_model_still_recovers() {
    ...
    local
        .run_until(async {
            ...
            error.kind = xai_hystersis_sampler::SamplingErrorKind::Api;
