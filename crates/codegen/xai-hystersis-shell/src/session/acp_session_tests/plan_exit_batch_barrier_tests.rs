...
use xai_hystersis_tools::implementations::hystersis_build::exit_plan_mode::ExitPlanModeExtRequest;
...
async fn seeded_active_plan_actor_with_edit_tools() -> (
    ...
    *actor.agent.borrow_mut() = test_agent_with_tools(vec![
    ...
    actor
        ...
        .borrow()
        .tool_bridge()
        .update_resource(xai_hystersis_tools::types::resources::PlanFilePath(
            plan_path.clone(),
        ))
        .await;
...
async fn mixed_permission_cancel_skips_exit_reverse_request() {
    ...
    local
        .run_until(async {
            ...
            use xai_hystersis_tools::implementations::hystersis_build::exit_plan_mode::ExitPlanModeTool;
            use xai_hystersis_tools::registry::types::ToolConfig;
            use xai_hystersis_workspace::permission::{ClientType, spawn_permission_manager};
