...
use xai_hystersis_workspace::permission::{AccessKind, ClientType, spawn_permission_manager};
...
async fn set_auto_mode_path_wires_live_side_query_via_session_actor() {
    ...
    local
        .run_until(async {
            ...
            assert!(
                matches!(d, xai_hystersis_workspace::permission::Decision::Allow),
            ...
            let d2 = session
                ...
                .await;
            assert!(
                !matches!(d2, xai_hystersis_workspace::permission::Decision::Allow),
    ...
    local
        .run_until(async {
            ...
            actor.permissions.set_classifier_transcript(vec![
                xai_hystersis_workspace::permission::ClassifierTurn::UserText("please run tests".into()),
            ]);
...
fn build_classifier_turns_captures_tool_use_excludes_text_and_results() {
    use xai_hystersis_workspace::permission::ClassifierTurn;
    let conv = vec![
        ...
        super::ConversationItem::assistant_tool_calls(vec![
            xai_hystersis_sampling_types::conversation::ToolCall {
...
fn build_classifier_turns_projects_full_filtered_resident_prefix() {
    use xai_hystersis_sampling_types::synthesized_reasoning_item;
    use xai_hystersis_workspace::permission::ClassifierTurn;
...
fn build_classifier_turns_filters_non_user_carriers() {
    ...
    let conv = vec![
        ...
        tool_image,
        user_image,
        super::ConversationItem::User(xai_hystersis_sampling_types::UserItem {
