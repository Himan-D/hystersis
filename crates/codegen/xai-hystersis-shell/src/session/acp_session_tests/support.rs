...
#[cfg(test)]
pub(crate) async fn test_agent_default() -> xai_hystersis_agent::Agent {
    test_agent_with_tools(vec![]).await
}
#[cfg(test)]
pub(crate) async fn test_agent_backend_search(
    hosted_tools: Vec<xai_hystersis_sampling_types::HostedTool>,
) -> xai_hystersis_agent::Agent {
    let base = test_agent_default().await;
    xai_hystersis_agent::Agent::new(
        base.definition().clone(),
        xai_hystersis_agent::PromptContext::default(),
        String::new(),
        base.tool_bridge().clone(),
        xai_hystersis_agent::ReminderPolicy::default(),
        xai_hystersis_agent::CompactionPolicy::default(),
        hosted_tools,
        true,
    )
}
...
#[cfg(test)]
pub(crate) async fn test_agent_with_goal_tool() -> xai_hystersis_agent::Agent {
    use xai_hystersis_tools::implementations::hystersis_build::update_goal::UpdateGoalTool;
...
#[cfg(test)]
pub(crate) async fn test_hystersis_build_agent_with_todo() -> xai_hystersis_agent::Agent {
    use xai_hystersis_tools::implementations::hystersis_build::todo::TodoWriteTool;
    use xai_hystersis_tools::registry::types::ToolConfig;
...
#[cfg(test)]
pub(crate) async fn test_agent_with_plan_tools() -> xai_hystersis_agent::Agent {
    use xai_hystersis_tools::implementations::hystersis_build::enter_plan_mode::EnterPlanModeTool;
    use xai_hystersis_tools::implementations::hystersis_build::exit_plan_mode::ExitPlanModeTool;
    use xai_hystersis_tools::registry::types::ToolConfig;
...
pub(crate) async fn test_agent_with_tools(
    tools: Vec<xai_hystersis_tools::registry::types::ToolConfig>,
) -> xai_hystersis_agent::Agent {
    test_agent_from_config(
        xai_hystersis_tools::registry::types::ToolServerConfig {
            tools,
            behavior_preset: None,
        },
        xai_hystersis_agent::AgentDefinition::default_hystersis_build(),
        std::sync::Arc::new(xai_hystersis_tools::computer::local::LocalTerminalBackend::new()),
    )
    .await
}
#[cfg(test)]
pub(crate) async fn test_agent_with_user_message_template(
    ...
    let mut definition = xai_hystersis_agent::AgentDefinition::default_hystersis_build();
...
async fn test_agent_from_config(
    ...
    definition: xai_hystersis_agent::AgentDefinition,
    backend: std::sync::Arc<dyn xai_hystersis_tools::computer::types::TerminalBackend>,
) -> xai_hystersis_agent::Agent {
    use xai_hystersis_tools::computer::local::LocalFs;
    use xai_hystersis_tools::computer::types::AsyncFileSystem;
...
pub(crate) async fn create_test_actor_with_terminal(
    ...
    let cwd = xai_hystersis_paths::AbsPathBuf::new(std::path::PathBuf::from("/tmp")).unwrap();
    let fs = Arc::new(xai_hystersis_workspace::file_system::MockFs::new(
        cwd.to_path_buf(),
    ));
    ...
    tool_context.task_completion_reservations =
        Some(xai_hystersis_tools::reminders::task_completion::TaskCompletionReservations::default());
    tool_context.task_wake_suppressed =
        Some(xai_hystersis_tools::reminders::task_completion::TaskWakeSuppressed::default());
    ...
    let chat_state_handle = xai_chat_state::ChatStateActor::spawn(
        vec![],
        xai_hystersis_sampling_types::SamplingConfig {
    ...
    let actor = SessionActor {
        ...
        permissions: xai_hystersis_workspace::permission::PermissionHandle::allow_all(),
        tool_context,
        ...
        vcs_kind: xai_hystersis_workspace::session::git::VcsKind::Git,
        ...
        sampler_handle: xai_hystersis_sampler::SamplerHandle::noop(),
        sampling_gate: None,
