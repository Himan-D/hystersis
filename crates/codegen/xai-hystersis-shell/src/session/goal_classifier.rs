...
use xai_hystersis_tools::implementations::hystersis_build::task::backend::{ChannelBackend, SubagentBackend};
...
pub(crate) fn build_subagent_trace_items(
    ...
    prompt: &str,
    output: &str,
) -> Vec<xai_hystersis_sampling_types::conversation::ConversationItem> {
    use xai_hystersis_sampling_types::conversation::{ConversationItem, ToolCall};
...
pub(crate) struct ChannelSpawner {
    ...
    pub(crate) foreground_wait:
        Option<xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentForegroundWait>,
