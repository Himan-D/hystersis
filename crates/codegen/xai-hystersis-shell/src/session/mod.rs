...
pub(crate) fn is_cursor_user_template(
    _template: &xai_hystersis_agent::prompt::user_message::UserMessageTemplate,
) -> bool {
    false
}
...
pub(crate) fn is_cursor_system_template(
    _template: &xai_hystersis_agent::prompt::context::TemplateOverride,
) -> bool {
    false
}
...
pub use xai_hystersis_shared::session::info;
pub mod managed_mcp;
...
pub mod persistence;
pub use xai_hystersis_shared::placeholder_images;
pub mod plan_mode;
