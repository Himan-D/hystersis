...
pub enum SideQuestionError {
    ...
    Sampling(#[from] xai_hystersis_sampling_types::SamplingError),
...
pub fn meta_category_str(
    category: xai_hystersis_session_events::types::CancellationCategory,
) -> &'static str {
...
pub enum SessionCommand {
    ...
    GetToolOverrides {
        respond_to: oneshot::Sender<Option<xai_hystersis_sampling_types::ToolOverrides>>,
    },
    ...
    SetToolOverrides {
        overrides: xai_hystersis_sampling_types::ToolOverrides,
    },
    Prompt {
        prompt_id: String,
        ...
        tool_overrides_update: Option<xai_hystersis_sampling_types::ToolOverridesUpdate>,
    ...
    SetSessionModel {
        sampling_config: xai_hystersis_sampler::SamplerConfig,
        use_concise: bool,
    ...
    ReloadPlugins {
        registry: Option<std::sync::Arc<xai_hystersis_agent::plugins::PluginRegistry>>,
    },
    ...
    SnapshotToolDefinitions {
        respond_to: oneshot::Sender<Vec<xai_hystersis_sampling_types::ToolSpec>>,
    },
    ...
    KillBackgroundTask {
        ...
        respond_to: oneshot::Sender<Result<xai_hystersis_tools::types::KillOutcome, String>>,
    },
    DeleteScheduledTask {
        task_id: String,
    ...
    ListTasks {
        respond_to: oneshot::Sender<Option<Vec<xai_hystersis_tools::types::TaskSnapshot>>>,
    },
    ...
    PluginsList {
        respond_to:
            oneshot::Sender<Option<std::sync::Arc<xai_hystersis_agent::plugins::PluginRegistry>>>,
    },
    ...
    TakeHarnessTraceTurns {
        respond_to:
            oneshot::Sender<Vec<Vec<xai_hystersis_sampling_types::conversation::ConversationItem>>>,
    },
