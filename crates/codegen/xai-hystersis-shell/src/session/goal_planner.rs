...
///
/// [`SubagentRuntimeOverrides::harness_agent_type`]: xai_hystersis_tools::implementations::hystersis_build::task::types::SubagentRuntimeOverrides::harness_agent_type
...
mod tests {
    ...
    async fn fail_open_retry_emits_spawn_failed_event() {
        ...
        let writer = xai_hystersis_session_events::EventWriter::open(dir.path());
        let ov = RoleSpawnOverride {
            model: Some("m".into()),
            agent_type: Some("t".into()),
        };
