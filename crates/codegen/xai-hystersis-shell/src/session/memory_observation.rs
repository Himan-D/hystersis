...
use xai_hystersis_telemetry::memory_telemetry::{
...
pub(crate) fn log_memory_injection(
    ...
    xai_hystersis_telemetry::session_ctx::log_event(MemoryInjection {
        session_id,
        outcome,
...
impl MemoryObservationSink for TelemetryMemoryObservationSink {
    fn observe_search(&self, observation: MemorySearchObservation) {
        xai_hystersis_telemetry::session_ctx::log_event(MemorySearch {
            ...
            outcome: match observation.outcome {
                xai_hystersis_memory::MemorySearchOutcome::Results => TelemetryOutcome::Results,
                xai_hystersis_memory::MemorySearchOutcome::Empty => TelemetryOutcome::Empty,
                xai_hystersis_memory::MemorySearchOutcome::Error => TelemetryOutcome::Error,
            },
    ...
    fn observe_watcher_sync(&self, observation: MemoryWatcherSyncObservation) {
        xai_hystersis_telemetry::session_ctx::log_event(MemoryWatcherSync {
            session_id: self.session_id.clone(),
