//! Shared helpers for xai-hystersis-shell integration tests.

use xai_hystersis_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub mod leader {
    ...
    use xai_hystersis_test_support::leader::{LeaderFixture, LeaderStdioClient};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `xai_hystersis_sampler::SamplingClient`, which takes a
