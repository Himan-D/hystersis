//! Criterion benchmarks for the xai-hystersis-pager rendering pipeline.
//!
...
use xai_hystersis_pager::scrollback::render::render_scrolled_entries_with_scratch;
use xai_hystersis_pager::scrollback::wrappers::EntryRenderer;
use xai_hystersis_pager::scrollback::{
