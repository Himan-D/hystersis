...
//!
//! ```text
//! cargo bench -p xai-hystersis-pager --bench edit_highlight
//! cargo bench -p xai-hystersis-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use xai_hystersis_pager::scrollback::blocks::tool::{
...
use xai_hystersis_pager::syntax::{Syntect, get_syntect};
use xai_hystersis_pager::theme::Theme;
use xai_hystersis_pager_diff::{DiffHunk, DiffLine};
