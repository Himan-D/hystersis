...
use xai_hystersis_pager_pty_harness::PtyHarness;
pub(crate) use xai_hystersis_pager_pty_harness::{SGR_SCROLL_DOWN, SGR_SCROLL_UP};
...
/// (`xai-hystersis-pager-pty-harness/src/scroll_matrix/runner.rs`) ports this
...
/// `xai-hystersis-pager-pty-harness/src/scroll_matrix/session.rs` is a port of
...
/// (e.g. `HYSTERSIS_SCROLL_SPEED`) appended to the controller's env.
