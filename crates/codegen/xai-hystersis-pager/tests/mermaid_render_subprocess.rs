...
use xai_hystersis_pager::app::mermaid_worker::render_via_subprocess;
use xai_hystersis_pager::scrollback::blocks::mermaid_content::MermaidRenderQuality;
...
fn tight_timeout_kills_child_and_returns_err() {
    ...
    // `xai_hystersis_mermaid::subprocess` `reap_terminates_the_process` unit test;
