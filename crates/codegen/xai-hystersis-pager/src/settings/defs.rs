...
use xai_hystersis_shell::util::config::DISPLAY_REFRESH_DEFAULT_AUTO_CADENCE_ENABLED;
...
//
// Concrete codes must match `xai_hystersis_voice::STT_LANGUAGES` (official Hystersis STT
    ...
    vec![
        ...
        SettingMeta {
            ...
            kind: SettingKind::Bool {
                ...
                default: xai_hystersis_shell::util::config::DEFAULT_REMEMBER_TOOL_APPROVALS,
            },
            restart_required: true,
            hidden_in_minimal: false,
        },
        ...
        // Catalog = official STT languages (see xai_hystersis_voice::STT_LANGUAGES).
        SettingMeta {
