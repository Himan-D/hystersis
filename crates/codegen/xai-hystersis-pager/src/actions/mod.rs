...
/// Emit [`xai_hystersis_telemetry::events::ShortcutUsed`] for an allowlisted binding.
///
...
pub fn log_shortcut_used(key: &KeyEvent, action_id: ActionId, context: &str) {
    ...
    xai_hystersis_telemetry::session_ctx::log_event(xai_hystersis_telemetry::events::ShortcutUsed {
