...
pub(crate) fn reply_headless_ext_method(args: AcpArgsBox<acp::ExtRequest>) {
    use xai_hystersis_tools::implementations::hystersis_build::ask_user_question::AskUserQuestionExtResponse;
    ...
    let response = match method {
        ...
        "hystersis.com/mcp/elicit" => {
            use xai_hystersis_tools::mcp_elicitation::McpElicitExtResponse;
...
fn decode_session_notification(method: &str, params: &str) -> ExtEvent {
    ...
    enum XaiUpdate {
        ...
        ResponseCompleted {
            ...
            #[serde(default)]
            usage: Option<xai_hystersis_shell::extensions::notification::ResponseUsage>,
            #[serde(default)]
            signature: Option<String>,
            #[serde(default)]
