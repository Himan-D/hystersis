...
struct WelcomeLayoutInput<'a> {
    ...
    prompt_compact: bool,
    announcement: Option<&'a xai_hystersis_announcements::RemoteAnnouncement>,
...
pub(super) fn render_version_badge(
    ...
    let channel = xai_hystersis_update::channel_label();
    match &mode {
        VersionBadgeMode::Full { .. } => {
            ...
            spans.push(Span::styled(
                format!("{}{}", xai_hystersis_version::VERSION, channel),
                Style::default().fg(theme.gray),
            ));
        }
...
pub struct WelcomeRenderParams<'a> {
    ...
    pub announcement: Option<&'a xai_hystersis_announcements::RemoteAnnouncement>,
    ...
    pub foreign_resume_hint: Option<&'a xai_hystersis_foreign_sessions::RecentForeignSession>,
    pub is_api_key_auth: bool,
    pub session_picker_content_results:
        Option<&'a [xai_hystersis_shell::extensions::session_search::SearchSessionHit]>,
    ...
    pub gate: Option<&'a xai_hystersis_shell::auth::GateInfo>,
...
fn render_announcement_section(
    ...
    buf: &mut Buffer,
    theme: &Theme,
    announcement: &xai_hystersis_announcements::RemoteAnnouncement,
    min_width_hint: u16,
    content_height: u16,
    expanded: bool,
    mouse_pos: Option<(u16, u16)>,
...
mod tests {
    ...
    fn foreign_resume_tip_names_each_tool_and_age() {
        use xai_hystersis_foreign_sessions::ForeignSessionTool;
        ...
        for (tool, label) in [
            ...
            let hint = xai_hystersis_foreign_sessions::RecentForeignSession {
                tool,
    ...
    fn long_ann() -> xai_hystersis_announcements::RemoteAnnouncement {
...
the usual channels. "
    ...
    fn announcement_equal_for_short_message() {
        let area = Rect::new(0, 0, 120, 60);
        let a = xai_hystersis_announcements::RemoteAnnouncement {
            title: Some("FYI".into()),
