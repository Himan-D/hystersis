...
//!   Absent remote falls through to on. `HYSTERSIS_VOICE_MODE` overrides for local
//!   dev (env > remote > default on). Free/X Basic still get HystersisPro upsell
...
pub use xai_hystersis_voice::maybe_run_capture_subprocess;
