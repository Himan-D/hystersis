...
use xai_hystersis_shell::sampling::types::ReasoningEffort;
use xai_hystersis_shell::session::unified_list::SessionKind;
...
pub enum SwitchModelError {
    ...
    /// `acp::Error.data`.
    IncompatibleAgent {
        error: xai_hystersis_shell::agent::config::ModelSwitchIncompatibleAgentError,
...
pub enum Action {
    ...
    OpenExtensionsModal {
        ...
        trigger: xai_hystersis_telemetry::events::ExtensionsModalTrigger,
    },
    ...
    UpsertMcpServer {
        name: String,
        config: Box<xai_hystersis_shell::util::config::McpServerConfig>,
    },
    ...
    AnnouncementsOpenCta(xai_hystersis_telemetry::events::AnnouncementCtaSurface),
...
pub enum Effect {
    ...
    ScanForeignSessions {
        cwd: std::path::PathBuf,
        compat: xai_hystersis_foreign_sessions::EnabledForeignSessionSources,
    ...
    FetchSessionList {
        ...
        headless_policy: xai_hystersis_shell::session::unified_list::HeadlessPolicy,
    },
    ...
    KillBgTask {
        session_id: acp::SessionId,
        task_id: String,
        source: xai_hystersis_shell::extensions::task::TaskKillSource,
    },
    ...
    SendFeedback {
        ...
        images: Vec<xai_hystersis_shell::session::FeedbackImage>,
    },
...
pub enum TaskResult {
    ...
    WorktreeForked {
        ...
        restore_degree: Option<xai_hystersis_workspace::session::git::RestoreDegree>,
    ...
    SessionListLoaded {
        ...
        scope: xai_hystersis_shell::session::unified_list::ListScope,
    ...
    ForeignResumeHintDetected {
        canonical_cwd: std::path::PathBuf,
        launch_token: u64,
        hint: Option<xai_hystersis_foreign_sessions::RecentForeignSession>,
    },
    ...
    BgTaskKilled {
        session_id: String,
        task_id: String,
        outcome: Option<xai_hystersis_tools::types::KillOutcome>,
    },
    ...
    ChangelogFetched {
        ...
        entries: Vec<xai_hystersis_shell::util::changelog::ChangelogEntry>,
    },
    ...
    SkillsListLoaded {
        agent_id: AgentId,
        result: Result<Vec<xai_hystersis_tools::implementations::skills::types::SkillInfo>, String>,
    },
    WorkflowsListLoaded {
        agent_id: AgentId,
        session_id: acp::SessionId,
    ...
    SessionInfoComplete {
        agent_id: AgentId,
        session_id: acp::SessionId,
        info: Box<xai_hystersis_shell::session::SessionInfoResponse>,
    ...
    SessionUsageComplete {
        agent_id: AgentId,
        session_id: acp::SessionId,
        usage: Box<xai_hystersis_shell::extensions::notification::PromptUsage>,
        nonce: u64,
    },
    ...
    DeepSearchResults {
        ...
        generation: u64,
        results: Vec<xai_hystersis_shell::extensions::session_search::SearchSessionHit>,
        seq: u64,
    },
    ...
    GateRefreshed {
        settings: Option<xai_hystersis_shell::util::config::RemoteSettings>,
    },
