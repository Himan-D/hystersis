...
//! inside [`xai_hystersis_mermaid::render_checked`] is a no-op there: a panic in the
...
//!    via [`xai_hystersis_mermaid::run_with_timeout`], which **kills and reaps** the
...
//!    ([`xai_hystersis_mermaid::RenderLimits`]) and the raster megapixel/height caps
...
fn render_source_to_png(
    ...
    target_width_px: u32,
    quality: MermaidRenderQuality,
) -> Result<RenderedDiagram, xai_hystersis_mermaid::MermaidError> {
