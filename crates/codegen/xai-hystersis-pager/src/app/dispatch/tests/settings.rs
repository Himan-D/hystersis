...
fn plugin_cta_catalog_reload_empty_candidates_resets_matched_phase() {
    ...
    let id = AgentId(0);
    {
        ...
        cta.source_url_or_path = Some(xai_hystersis_plugin_marketplace::OFFICIAL_SOURCE_GIT_URL.into());
    ...
    let response = xai_hooks_plugins_types::MarketplaceListResponse {
        sources: vec![xai_hooks_plugins_types::MarketplaceScanResult {
            source_name: xai_hystersis_plugin_marketplace::OFFICIAL_SOURCE_NAME.into(),
            source_kind: "git".into(),
            source_url_or_path: xai_hystersis_plugin_marketplace::OFFICIAL_SOURCE_GIT_URL.into(),
