...
pub(in crate::app::dispatch) fn dispatch_pick_session(
    ...
    if xai_hystersis_shell::session::resolve_local_session(&session_id, &local_cwd).is_some() {
...
/// with the picker query pushed down as `hystersis.com/session/list` `query`.
