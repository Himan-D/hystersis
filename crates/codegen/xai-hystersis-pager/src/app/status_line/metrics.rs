...
use xai_hystersis_status_line::{ResolvedStatusLine, StatusLineConfig, StatusLineItem, StatusLineType};
...
impl StatusLineMetrics {
    ...
    pub(crate) fn report_config(&self, cfg: &StatusLineConfig) {
        ...
        xai_hystersis_telemetry::session_ctx::log_event(
            xai_hystersis_telemetry::events::StatusLineConfigured {
                kind,
    ...
    fn health_event(&self) -> Option<xai_hystersis_telemetry::events::StatusLineHealth> {
        ...
        Some(xai_hystersis_telemetry::events::StatusLineHealth {
            kind,
