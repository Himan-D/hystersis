...
impl AgentView {
    ...
    pub(crate) fn log_prompt_suggestion_shown_if_visible(&mut self) {
        ...
        xai_hystersis_telemetry::session_ctx::log_event(xai_hystersis_telemetry::events::PromptSuggestion {
            action: xai_hystersis_telemetry::events::PromptSuggestionAction::Shown,
            chars,
            words,
        });
    }
    ...
    pub(in crate::app) fn connect_matched_plugin(&mut self) {
        ...
        xai_hystersis_telemetry::session_ctx::log_event(
            xai_hystersis_telemetry::events::PluginCtaConnectClicked {
...
mod prompt_suggestion_gate_tests {
    ...
    fn an_open_question_card_closes_the_suggestion_gate() {
        ...
        use xai_hystersis_tools::implementations::hystersis_build::ask_user_question::Question;
...
mod plugin_cta_notify_tests {
    ...
    fn notify_skips_debounce_when_no_candidates() {
        ...
        agent.plugin_cta.source_url_or_path =
            Some(xai_hystersis_plugin_marketplace::OFFICIAL_SOURCE_GIT_URL.into());
