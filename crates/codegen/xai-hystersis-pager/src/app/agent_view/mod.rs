...
pub struct BannerSlotParams<'a> {
    ...
    pub(crate) announcements: &'a [xai_hystersis_announcements::RemoteAnnouncement],
...
pub(crate) struct DeferredSubagentFinish {
    pub notification: xai_hystersis_shell::extensions::notification::SessionNotification,
...
pub struct AgentView {
    ...
    pub context_state: Option<xai_hystersis_shell::session::ContextInfo>,
    pub status_context: Option<xai_hystersis_status_line::StatusLineContext>,
    ...
    pub(crate) pending_elicitation: Option<(
        xai_hystersis_tools::mcp_elicitation::McpElicitExtRequest,
    ...
    pub(crate) deferred_session_mode: Option<xai_hystersis_tools::types::SessionMode>,
    ...
    match kind {
        ...
        LocalQuestionKind::CreditLimitUpsell { choices } => {
            ...
            let choice = choices
                .get(*idx)
                .copied()
                .unwrap_or(xai_hystersis_telemetry::events::CreditLimitChoice::PayAsYouGo);
            xai_hystersis_telemetry::session_ctx::log_event(
                xai_hystersis_telemetry::events::CreditLimitUpsellClicked {
        ...
        LocalQuestionKind::FreeUsageUpsell { source } => {
            ...
            xai_hystersis_telemetry::session_ctx::log_event(
                xai_hystersis_telemetry::events::HystersisProUpsellClicked {
                    source,
                    auth_method: None,
                },
            );
...
fn remember_mode_enabled() -> bool {
    let path = xai_hystersis_tools::util::hystersis_home::hystersis_home().join("config.toml");
...
fn question_visible_h(
    ...
    prompt_height: u16,
    question: &xai_hystersis_tools::implementations::hystersis_build::ask_user_question::Question,
    content_w: usize,
    preview: Option<&str>,
    fullscreen: bool,
    desc_cap: u16,
