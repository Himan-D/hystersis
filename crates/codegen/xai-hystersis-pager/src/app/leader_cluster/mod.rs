...
use xai_hystersis_test_support::MockInferenceServer;
...
fn effective_hystersis_home() -> PathBuf {
    xai_hystersis_config::hystersis_home()
}
...
impl PagerLeaderCluster {
    ...
    async fn spawn_leader_generation(&mut self) {
        ...
        let control_state = LeaderServerControlState::new(LeaderServerMetadata {
            ...
            // MUST be the client-side comparison source (xai_hystersis_version), not
        ...
        generation_tasks.extend(xai_hystersis_shell::leader::in_process::spawn_agent(
            acp_rx,
            response_tx,
        ));
