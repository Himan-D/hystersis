...
//!
//! ```text
//! cargo run -p xai-hystersis-pager --bin todo-pane-playground
//! ```
//!
...
use xai_hystersis_pager::views::todo_pane::TodoPane;
use xai_hystersis_shell::tools::{TodoItem, TodoPriority, TodoStatus};
