...
Want Hystersis working on a feature while you (or another Hystersis session) work on
...
- **From the shell:**
  ...
  ```bash
  hystersis --worktree=my-feature "refactor the auth module"
  ```
...
- Run two or three Hystersis sessions on the same repo simultaneously.
