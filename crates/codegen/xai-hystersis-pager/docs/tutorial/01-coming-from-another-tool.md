...
Fear not — your settings, rules, and skills come with you. Hystersis
...
writes the items you selected into your `.hystersis` config. Re-run it anytime.
...
Run **`hystersis inspect`** in a repo to see every rules file, skill, and MCP
server Hystersis picked up, tagged with where it came from. Each compat source
