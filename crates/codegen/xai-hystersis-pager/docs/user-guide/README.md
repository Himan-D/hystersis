# Hystersis User Guide

Learn how to install, configure, and extend Hystersis, the terminal-based AI coding assistant from SpaceXAI.
...
Customize and extend Hystersis.
...
Automate, script, and integrate Hystersis with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `hystersis -p`, output formats, CI/CD integration, and piping |
...
| 27 | [hystersis clone](27-hystersis-clone.md) | Depth-1 Grove clone, `--full-history`, and safe deepen/switch commands |
