...
Terminal UI (TUI) for Hystersis. Provides the interactive full-screen interface
...
- [Hook Examples](../xai-hystersis-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`xai-hystersis-hooks`)](../xai-hystersis-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`xai-hystersis-plugin-marketplace`)](../xai-hystersis-plugin-marketplace/) — marketplace source loading, scanning, and install
