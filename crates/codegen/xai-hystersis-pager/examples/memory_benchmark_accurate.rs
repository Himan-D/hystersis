...
fn main() {
    ...
    let string_info = create_string_info(1, "general-purpose", "hystersis-3", "researcher");
    let arc_info = create_arc_info(1, "general-purpose", "hystersis-3", "researcher");
    ...
    let shared_models = ["hystersis-3", "hystersis-3-mini"];
