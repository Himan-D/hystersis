...
/// `xai_hystersis_shell::auth::credential_provider::build_otel_credential_provider`.
...
fn build_export_headers(
    ...
    snapshot: &xai_hystersis_auth::CredentialSnapshot,
...
mod tests {
    ...
    use std::sync::Mutex;
    use xai_hystersis_auth::{AuthCredentialProvider, CredentialSnapshot, HttpAuth};
