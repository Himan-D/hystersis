...
use xai_hystersis_shell::env::HystersisBuildEnvironment;
...
impl UpdateConfig {
    pub fn from_environment(env: &HystersisBuildEnvironment) -> Self {
        Self {
            ...
            auth_scope: xai_hystersis_shell::auth::HystersisComConfig::default().auth_scope(),
            deployment_key: None,
            alpha_test_key: None,
...
async fn fetch_gcs_channel_pointer(channel: &str, base_url: &str) -> Result<String> {
    ...
    let client = xai_hystersis_extra_ca::build_reqwest_client(|builder| {
...
pub use xai_hystersis_version::installed as get_installed_hystersis_version;
...
pub fn installed_on_disk_version() -> Option<String> {
    #[cfg(unix)]
    {
        let app = xai_hystersis_shell::util::hystersis_home::hystersis_application();
...
pub fn channel_name() -> Option<&'static str> {
    ...
    *NAME.get_or_init(|| {
        ...
        derive_channel(xai_hystersis_version::VERSION, &stable)
    })
}
...
pub fn channel_label() -> &'static str {
    ...
    LABEL.get_or_init(|| {
        ...
        match derive_channel(xai_hystersis_version::VERSION, &stable) {
            Some("alpha") => " [alpha]",
            Some(_) => " [stable]",
            None => "",
        }
